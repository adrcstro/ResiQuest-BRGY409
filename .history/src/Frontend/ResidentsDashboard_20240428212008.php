...
// Output the edit modal dialog
echo '<div id="edit-modal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="update-form">';
            // Depending on the service type, include input fields for updating request details
            switch($serviceType) {
                case "Certificate of Residency":
                case "Certificate of Indigency":
                    // Example input fields for Certificate of Residency and Certificate of Indigency
                    echo '<input type="text" id="first-name" name="first-name" placeholder="First Name">';
                    echo '<input type="text" id="middle-name" name="middle-name" placeholder="Middle Name">';
                    echo '<input type="text" id="last-name" name="last-name" placeholder="Last Name">';
                    // Add more input fields as needed
                    break;
                case "Business Clearance":
                    // Example input fields for Business Clearance
                    echo '<input type="text" id="business-act" name="business-act" placeholder="Business Activity">';
                    echo '<input type="text" id="business-loc" name="business-loc" placeholder="Business Location">';
                    // Add more input fields as needed
                    break;
                case "Barangay Identification":
                    // Example input fields for Barangay Identification
                    echo '<input type="text" id="date-of-birth" name="date-of-birth" placeholder="Date of Birth">';
                    echo '<input type="text" id="place-of-birth" name="place-of-birth" placeholder="Place of Birth">';
                    // Add more input fields as needed
                    break;
                default:
...
echo '  </form>
        ...
        <div class="modal-footer">
            <button id="submit-update" class="btn btn-primary">Submit</button>
        </div>
    </div>
</div>';

// Output JavaScript code for modal functionality
echo '<script>
    // Get the modal
    ...
    editButtons.forEach(button => {
        button.addEventListener("click", function() {
            ...
            // Example: document.getElementById("first-name").value = "ExistingFirstName";
        });
    });
    ...
    // When the user clicks the submit button, send the updated data to the server
    ...
    submitButton.addEventListener("click", function() {
        ...
        // Example: fetch("../Backend/Update.php", { method: "POST", body: formData })
