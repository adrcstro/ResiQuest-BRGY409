...
<dialog id="EditResidentprofile" class="modal p-3">
  ...
  <label for="PRofile" class="absolute bottom-0 right-0  bg-gray-200 text-black rounded-lg hover:bg-gray-400 focus:outline-none focus:bg-gray-400 cursor-pointer" title="Edit Profile">
