...
?>
                 <button class="relative bg-gray-300 hover:bg-gray-600 focus:outline-none focus:bg-gray-600 text-white font-bold py-2 px-4 rounded" onclick="ViewSchedule.showModal()">
