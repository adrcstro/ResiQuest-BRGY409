  ...
  button.addEventListener("click", function () {
     ...
     // Display default text in modal content
           ...
           <div class="flex-1 flex flex-col justify-between">
               <div class="flex flex-col items-center justify-center w-full h-full">
                   ...
                   <div class="flex flex-col items-center justify-center w-full h-full p-2 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                       <img src="../Backend/uploads/" alt="News Image" class="w-full h-full object-cover border-2 border-gray-400 rounded-md p-2">
                   </div>
               </div>
           </div>
           <!-- Right side input -->
           <div class="flex-1 flex flex-col justify-between">
               ...
               <textarea name="NewsContent" rows="6" class="rounded-lg border-gray-200 w-full h-64 pt-2 text-gray-900 border-1 bg-white input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500 resize-none" placeholder="Enter News Content....." readonly>"' . $row["NewsContent"] . '"</textarea>
           </div>
           </div>
           </div>
