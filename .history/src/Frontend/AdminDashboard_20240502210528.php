    ...
    if (file) {
      ...
      reader.readAsDataURL(file);
                ...
                <div class="sm:flex-1">
                    ...
                    <input value="<?php echo $row["AdminID"]?>" disabled required="" type="text" name="AdminsID" id="AdminsID" autocomplete="street-address" placeholder="Registered ID"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
                </div>
...
$(function() {
    $('#saveadmininfo').click(function(e) {
        ...
        var valid = $('#updateadminform')[0].checkValidity();

        if (valid) {
            var formData = new FormData($('#updateadminform')[0]);
