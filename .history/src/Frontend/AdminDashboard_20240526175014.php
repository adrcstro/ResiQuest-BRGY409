...
document.addEventListener("DOMContentLoaded", function () {
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
    ...
    $(document).ready(function () {
        ...
        // Handle click events on the "Schedule Released" links
        $(document).on('click', '.Schedule-resident-pickup', function (e) {
            e.preventDefault();

            // Extract data attributes
            const requestId = $(this).data('request-id');
            const serviceType = $(this).data('request-servietype');
            const fname = $(this).data('request-fname');
            const mname = $(this).data('request-mname');
            const lname = $(this).data('request-lname');

            // Populate modal content (if needed)
            // For example, you can update the form fields in the modal here

            // Open the modal dialog
            const dialog = document.getElementById('Schedulerequest');
            dialog.showModal();
        });

        // Handle click events on the modal close button
