...
?>
                 ...
                 <button class="relative bg-green-300 hover:bg-green-600 focus:outline-none focus:bg-red-600 text-white font-bold py-2 px-4 round" rounded onclick="ViewSchedule.showModal()">
