...
<dialog id="ViewComplain" class="modal p-3">
  ...
  <ol class="inline-flex items-end space-x-10 md:space-x-2 rtl:space-x-reverse">
    <li class="inline-flex items-center ">
      <a href="complaints.php?status=Pending" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
        <!-- SVG icon -->
        Pending Complaint
      </a>
    </li>
    <li>
      <div class="flex items-center">
        <!-- SVG icon -->
        <a href="complaints.php?status=On-Process" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">On Process Complaint</a>
      </div>
    </li>
    <li>
      <div class="flex items-center">
        <!-- SVG icon -->
        <a href="complaints.php?status=On-Schedule" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">View Schedule for Settlement</a>
      </div>
    </li>
    <li>
      <div class="flex items-center">
        <!-- SVG icon -->
        <a href="complaints.php?status=Settled" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Complaint History</a>
      </div>
    </li>
  </ol>
</nav>
