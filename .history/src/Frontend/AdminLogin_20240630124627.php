                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            ...
                            <div class="flex justify-between w-full py-4">
                                ...
                                <a href="AdminForgot.php" class="text-md text-blue-600 ml-3 tracking-tighter">Forgot Password</a>
                              </div>


                        <button  type="submit" name="submit"
                            class="mt-8 tracking-wide font-semibold bg-blue-700 text-white-500 w-full py-4 rounded-lg hover:bg-blue-500 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
