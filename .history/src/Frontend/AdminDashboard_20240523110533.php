...
document.getElementById('btnSubmitnews').addEventListener('click', function() {
    var dialog = document.getElementById('showpublicNews');
    dialog.close();
});
     ...
     // Display default text in modal content
           ...
           <div class="flex-1 flex flex-col justify-between">
               <div class="flex flex-col items-center justify-center w-full h-full">
                   ...
                   <img id="profilePicture" src="${Image ? "../Backend/uploads/" + Image : "/Images/blank.png"}" class="w-full h-full object-cover border-2 border-gray-400 rounded-md p-2">


  <div class="relative">
      <input  type="file" id="NewsEditImage" name="NewsEditImage" class="hidden" accept=".jpg, .png .jpeg .pdf, .doc, .docx">
      <img id="profilePicture" src="${Image  ? "../Backend/uploads/" + Image  : "/Images/blank.png"}" class="w-32 h-32 bg-gray-300 rounded-full mb-2 border-4" alt="Profile Picture">
      <label for="NewsEditImage" class="absolute bottom-0 right-0 p-2 bg-gray-100 text-black rounded-full hover:bg-gray-400 focus:outline-none focus:bg-gray-400 cursor-pointer border-4 " title="Edit Profile">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-6 h-6">
        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
      </svg>
    </label>
           ...
           <div class="flex-1 flex flex-col justify-between">
               <div>
                   <span class="block text-sm font-semibold leading-6 text-gray-900">News Title</span>
                   <input value="${Title}" type="text" name="NewsTitle" placeholder="Enter News Title" class="input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500 input-white w-full bg-white text-slate-900" readonly />
               </div>
               <div class="mt-3 flex flex-col sm:flex-row gap-x-6">
                   <div class="sm:flex-1">
                       <label for="NewsDate" class="block text-sm font-semibold leading-6 text-gray-900">News Date</label>
                   ...
                   <div class="sm:flex-1">
                       <label for="NewsTime" class="block text-sm font-semibold leading-6 text-gray-900">News Time</label>
                       <div>
                           <input value="${Time}" required type="time" name="NewsTime" id="NewsTime" autocomplete="Zip-Code" placeholder="Enter City Zip Code Ex. 1008" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 flex-1 readonly">
                       </div>
                   </div>
               </div>
               <div>
               <span class="block text-sm font-semibold leading-6 text-gray-900">News Content</span>
               <textarea name="NewsContent" rows="6" class="rounded-lg border-gray-200 w-full h-64 pt-2 text-gray-900 border-1 bg-white input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500 resize-none" placeholder="Enter News Content....." readonly>${Content}</textarea>
           </div>
           </div>
           </div>
