...
<script>
  ...
  if (file) {
    ...
    reader.readAsDataURL(file);
        ...
        <progress id="progressBar" class="progress progress-success w-50" value="0" max="100"></progress>
    </div>
    <script>
        // Fetch progress value from PHP file and update progress bar
        fetch('../Backend/progress.php')
