...
<div id="complaints-container">
    ...
    <div class="bg-blue-100 p-3 rounded-md mt-2">
        ...
        <h3 class="text-lg font-semibold mb-2">Submission of Government ID</h3>
        ...
        <ul class="list-disc ml-6 mb-4">
            ...
            <li>Upon Submitting Government ID's please make sure that it is Clear Front and Back</li>
            <li>Failed to follow these will results not Verifying your account!</li>
        </ul>
    </div>
