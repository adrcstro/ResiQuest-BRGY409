...
<div>
    ...
    <li onclick="my_modal_3.showModal()"><a>Your Profile</a></li>
  ...
  <script>
    ...
    if (file) {
      ...
      reader.readAsDataURL(file);
                                     ...
                                     <h3 class="text-xl font-bold"><?php echo $row["BrgyPosition"]?></h1>
                                 </div>
...
if(!empty($_SESSION["AdminID"])){
  ...
  $columns = [
      'Fname' => 13, 'MName' => 13, 'Lname' => 12, 'BrgyPosition' => 13, 'Gender' => 13, 'Email' => 12, 'Password' => 12, 'AdminProfile' => 12
  ];
  ...
  echo '<div class="mt-4">
  <div>
    <h2 class="text-sm text-gray-400 text-center">Profile</h2>
  </div>
...
?>
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-3">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input value="<?php echo $row["Fname"]?>"  required="" type="text" name="EditFirstName" id="EditFirstName" autocomplete="given-name" placeholder="First Name"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input value="<?php echo $row["MName"]?>" required="" type="text" name="EditMiddleName" id="EditMiddleName" autocomplete="additional-name" placeholder="Middle Name"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
                    </div>
                    <div class="flex flex-col">
                        <label for="EditLastName" class="block text-sm font-medium text-gray-700">Last Name</label>
                        <input value="<?php echo $row["Lname"]?>" required="" type="text" name="EditLastName" id="EditLastName" autocomplete="family-name" placeholder="Last Name"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
                    </div>
                </div>
                ...
                <div class="sm:flex-1">
                    <label for="EditAddress" class="block text-sm font-medium text-gray-700">Administrator ID</label>
                    <input value="<?php echo $row["AdminID"]?>" required="" type="text" name="EditAddress" id="EditAddress" autocomplete="street-address" placeholder="Registered ID"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
                </div>
    ...
    <label for="Gender" class="block text-sm font-semibold leading-6 text-gray-900">Gender</label>
        ...
        <select required id="Gender" name="Gender" autocomplete="family-name"
    ...
    <?php endif; ?>
            ...
            <option value="Female">Female</option>
                ...
                <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                <div class="sm:flex-1">
                    <label for="EditAddress" class="block text-sm font-medium text-gray-700">Email</label>
                    <input value="<?php echo $row["Email"]?>" required="" type="text" name="EditAddress" id="EditAddress" autocomplete="street-address" placeholder="Email Address"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
                </div>
<div class="sm:flex-1">
                    <label for="AdminPAss" class="block text-sm font-medium text-gray-700">Password</label>
                    <input value="<?php echo $row["Password"]?>" required="" type="password" name="AdminPAss" id="AdminPAss" autocomplete="street-address" placeholder="Email Address"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
                </div>
                </div>
            </div>
                ...
                <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                   ...
                   <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                      <div class="mb-4 flex items-center justify-between">
                         <div>
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Document Request</h3>
