...
Complete Request
       ...
       <ul tabindex="0"  class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
          ...
          <li class"reject-request-btn" data-request-id="' . $row["RequestID"] . '"  data-request-Fname="' . $row["FirstName"] . '"  data-request-Mname="' . $row["Middlename"] . '" data-request-Lname="' . $row["Lastname"] . '"><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
//reject request
                  ...
                  echo '<dialog id="rejectresidentrequestdialog" class="modal p-3 ">
                  <div class="modal-box w-70 max-w-3xl rounded-lg">
                  ...
                  <button" id="rejectresidentbutton" class="inline-flex justify-center  rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-500 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm"> 
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2">
<path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />
</svg>
                    Mark as Process
                ...
                echo '<script>
                document.addEventListener("DOMContentLoaded", function () {
                  const modal = document.getElementById("rejectresidentrequestdialog");
                  const modalContent = document.getElementById("rejectresi-request-info");
                  const openModalButtons = document.querySelectorAll(".reject-request-btn");
                  ...
                  openModalButtons.forEach(function (button) {
                    button.addEventListener("click", function () {
                      ...
                      const reqfname = button.getAttribute("data-request-Fname");
                      const reqmname = button.getAttribute("data-request-Mname");
                      const reqlname = button.getAttribute("data-request-Lname");
                  ...
                  <h1 class="text-xl font-bold">${reqfname}, ${reqmname} ${reqlname}</h1>
                  <h1 class="text-sm font-bold">Request-ID: ${reqID}</h1>
                      
                      <div class="hidden items-center justify-center mt-3">
                          <input Value="Rejected" type="text" name="rejectedstat" id="rejectedstat" autocomplete="given-name" placeholder=""
                              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
                      </div>
                      
                      <div class="hidden  items-center justify-center mt-3">
                      <input  value="${reqID}"   type="text" name="rejectedID" id="rejectedID" autocomplete="given-name" placeholder=""
                          class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
                  </div>
                  </div>
                ...
                document.getElementById("rejectresidentbutton").addEventListener("click", function() {
                    var dialog = document.getElementById("rejectresidentrequest");
                    dialog.close();
                });
            </script>';
