...
echo 'document.addEventListener("DOMContentLoaded", function () {
  ...
  openModalButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      ...
      if (!ID || !fname || !mname || !lname || !Nname || !Placeorbirth || !dateofrbirth || !age || !civilstatu || !gender || !purok || !voterstat || !email || !occupation || !contactnum || !address || !zipcode || !citizenship) {
        Swal.fire({
          icon: "error",
          title: "Oops...",
      ...
      <div class="relative">
      <input value="${profile}" type="file" id="admineditresiPRofile" name="admineditresiPRofile" class="flex" accept=".jpg, .png .jpeg .pdf, .doc, .docx">
      ...
      <input value="${ID}"  required="" type="text" name="adminedituserid" id="adminedituserid" autocomplete="given-name" placeholder="First Name"
          class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
  </div>
      ...
      <select required name="AdminEditresicivilstat" id="AdminEditresicivilstat" autocomplete="additional-name" 
          class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
          <option value="">${civilstatu}</option>
  ...
  <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
      <div class="sm:flex-1">
          ...
          <input value="${email}"  required="" type="email" name="Admineditresiemail" id="Admineditresiemail" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
      <div class="sm:flex-1">
          <label for="Admineditresioccupation" class="block text-sm font-medium text-gray-700">Occupation</label>
          <input value="${occupation}"  required="" type="text" name="Admineditresioccupation" id="Admineditresioccupation" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
  </div>
  ...
  <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
      <div class="sm:flex-1">
          ...
          <input value="${contactnum}"  required="" type="number" name="Admineditresicontact" id="Admineditresicontact" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
      <div class="sm:flex-1">
          <label for="Admineditresiaddress" class="block text-sm font-medium text-gray-700">Address</label>
          <input value="${address}"  required="" type="text" name="Admineditresiaddress" id="Admineditresiaddress" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
  </div>
  ...
  <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
      <div class="sm:flex-1">
          ...
          <input value="${zipcode}"  required="" type="number" name="Admineditresizipcode" id="Admineditresizipcode" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
      <div class="sm:flex-1">
          <label for="Admineditresicitizenship" class="block text-sm font-medium text-gray-700">Citizenship</label>
          <input value="${citizenship}"  required="" type="text" name="Admineditresicitizenship" id="Admineditresicitizenship" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
  </div>
