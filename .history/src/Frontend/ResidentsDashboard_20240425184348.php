  ...
  <main>
    ...
    <tbody class="bg-white">
        ...
        if(!empty($_SESSION["ID"])){
            ...
            // Query to fetch request data for the user with matching ID
            $query = "SELECT rd.RequestID, rd.ServiceType, rd.DateRequested, rd.PickupDate, rd.Status 
            ...
            if($result) {
                // Fetch data and display or process it
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td class='p-4 whitespace-nowrap text-sm font-semibold text-gray-900'> Action Button </td>"; // Replace 'Action Button' with appropriate action
                    echo "</tr>";
                }
            } else {
            ...
            header("Location: Login.php"); // Redirect to login page if session ID is empty
        }
        ?>
    </tbody>
</table>
