...
document.addEventListener("DOMContentLoaded", function () {
  ...
  openModalButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      ...
      // Dynamically set the form action based on ServiceType
      const form = document.getElementById("printdocsform");
      switch (servietype) {
        case "Certificate of Residency":
        case "Certificate of Indigency":
          form.action = "GenerateResidenIndigen.php";
          break;
        case "Business Clearance":
          form.action = "GenerateBusinessClerancen.php";
          break;
        case "Barangay Identification":
          form.action = "GenerateBrgyForm.php";
          break;
        default:
          // Handle other ServiceTypes if needed
          break;
      }
