                ...
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 xl:gap-4 my-4">
                        ...
                        <div class="flex justify-center mb-4">
                            <div class="flex mt-4 lg:mt-3 space-x-2">
                              ...
                              <!-- Add id attributes to the buttons -->
<button id="pendingBtn" class="bg-red-400 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">
...
<button id="onProcessBtn" class="bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<button id="completeBtn" class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<script>
    ...
    document.getElementById('onProcessBtn').addEventListener('click', function () {
        filterRequests('On-Process');
    });
    ...
    function filterRequests(status) {
        // Show all rows
        var rows = document.querySelectorAll('#PendingRequest table tbody tr');
        ...
        rows.forEach(function (row) {
            if (row.querySelector('td:nth-child(4)').innerText.trim() !== status) {
    ...
    if (mysqli_num_rows($result) > 0) {
        // Output table header
        echo '<div class="overflow-x-auto max-h-screen"><table class="table-auto min-w-full divide-y divide-gray-200 mt-3">
           <thead class="bg-gray-50 ">
               <tr>
                   <th scope="col" class="p-4 border-2 border-inherit text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Request ID</th>
                   <th scope="col" class="p-4 border-2 border-inherit text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Residents Name</th>
