...
<div class="bg-white shadow-2xl rounded-md p-6 mb-3  mt-4">
        <div class="mb-2 lg:mb-0">
            ...
            <span class="flex text-base font-medium text-black justify-center text-center"></span>
        </div>

        <div class="flex flex-col mt-12 md:flex-row space-y-4 md:space-y-0 md:space-x-4">
  <div class="flex flex-col items-center justify-center w-80">
    <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 p-2 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
...
<div class="flex items-center">
 ...
 <h3 class="text-lg font-semibold mb-2">Submmision of Government ID</h3>
              ...
              <ul class="list-disc ml-6 mb-4">
                <li>Only these Government ID's we will accept (Barangay ID, Philhealth ID, National ID, Drivers License, Postal ID) if you dont have these ID's you can submit your PSA/Birth Certificate and make sure it is a scanned Copy</li>
