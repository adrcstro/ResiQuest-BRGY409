...
<div id="ResidentsDashboard" class="relative bg-gray-50 inset-0  h-full overflow-y-auto lg:ml-64 mt-16">
  <main>
...
<div id="complaints-container">
    ...
    <script>
     ...
     <div id="NotVerifiedContent" class="pt-6 px-4">
     <div class="bg-white w-full h-full shadow rounded-lg p-4 sm:p-6 xl:p-8 my-4">
    <!-- SVG Image Container -->
    <div class="flex justify-center">
        <img src="/Images/residencyt.svg" alt="Verification Process Icon" class="w-64 h-64">
    </div>
...
<div class="flex items-center">
 ...
 <h3 class="text-lg font-semibold mb-2">Submmision of Government ID</h3>
    ...
    <ol class="items-center justify-center gap-6 sm:flex sm:flex-wrap mt-4">
        <li class="relative mb-6 sm:mb-0 w-full sm:w-auto">
        ...
        <li class="relative mb-6 sm:mb-0 w-full sm:w-auto">
            <div class="flex items-center justify-center">
                <div class="z-10 flex items-center justify-center w-14 h-14 bg-blue-100 rounded-full ring-0 ring-white dark:bg-blue-900 sm:ring-8 dark:ring-gray-900 shrink-0">
                    <svg class="w-10 h-10 text-blue-800 dark:text-blue-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M10.125 2.25h-4.5c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9M10.125 2.25h.375a9 9 0 0 1 9 9v.375M10.125 2.25A3.375 3.375 0 0 1 13.5 5.625v1.5c0 .621.504 1.125 1.125 1.125h1.5a3.375 3.375 0 0 1 3.375 3.375M9 15l2.25 2.25L15 12"/>
                    </svg>
                </div>
            </div>
