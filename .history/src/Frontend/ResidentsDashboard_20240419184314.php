...
<label for="PRofile" class="absolute bottom-0 right-0 p-2 bg-gray-100 text-black rounded-full hover:bg-gray-300 focus:outline-none focus:bg-gray-300 cursor-pointer border-4 " title="Edit Profile">
