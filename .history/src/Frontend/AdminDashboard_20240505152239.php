...
<div id="showRequestedDocuments" style="display: none;" class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
    ...
    function setActive(buttonId) {
        ...
        document.querySelectorAll('.active').forEach(button => {
            button.classList.remove('active', 'hover:bg-gray-200');
        });

        // Add active class to the clicked button
        const button = document.getElementById(buttonId);
        button.classList.add('active', 'hover:bg-gray-200');
    }
</script>

<button id="pendingBtn" onclick="setActive('pendingBtn')" class="bg-red-400 text-white font-bold py-2 px-4 rounded hover:bg-red-600">
...
<button id="onProcessBtn" onclick="setActive('onProcessBtn')" class="bg-yellow-400 text-white font-bold py-2 px-4 rounded hover:bg-yellow-600">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<button id="completeBtn" onclick="setActive('completeBtn')" class="bg-green-400 text-white font-bold py-2 px-4 rounded hover:bg-green-600">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
