        ...
        button.addEventListener("click", function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    formData.append("admin_id_logs", adminIdLogs);
                    formData.append("admin_username_logs", adminUsernameLogs);
                    formData.append("admin_position_logs", adminPositionLogs);
                    formData.append("admin_action_done", adminActionDone);
                    formData.append("categorization", categorization);
                    formData.append("date_created", dateCreated);

                    // Send the data to the backend
                    fetch("../Backend/DeleteAndLog.php", {
                        method: "POST",
                        body: formData
                    })
                    .then(response => {
                    ...
                    .then(data => {
                        ...
                        Swal.fire(
                            "Deleted!",
                            "Your request has been deleted and logged.",
                            "success"
                        );
                    })
                    .catch(error => {
