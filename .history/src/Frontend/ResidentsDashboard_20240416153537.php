    ...
    <div class="absolute bottom-0 right-2">
        <!-- Additional content here -->
                           ...
                           <div>
                                 ...
                                 <button onclick="viewid.showModal()" class="bg-blue-400 hover:bg-blue-600 text-white text-sn py-2 px-4 rounded mt-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
$(document).ready(function() {
    $("#SubmitInfotoVerify").click(function(e) {
        ...
        formData.append('SelectPassenger', SelectPassenger);
        formData.append('PassengerAge', PassengerAge);
        formData.append('PassengerGender', PassengerGender);
        formData.append('PassengerPhone', PassengerPhone);
        formData.append('PassengerAddress', PassengerAddress);
