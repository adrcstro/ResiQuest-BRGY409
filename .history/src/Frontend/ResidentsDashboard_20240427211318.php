...
while($row = mysqli_fetch_assoc($result)) {
  ...
  if ($row["Status"] !== "Completed") {
      ...
      echo '<td class="whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["ServiceType"] . '</td>';
      echo '<td class="whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["DateRequested"] . '</td>';
      echo '<td class="whitespace-nowrap text-sm font-semibold text-gray-900 ' . $statusBgColor . '">' . $row["Status"] . '</td>';
      echo '<td class="whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["PickUpDate"] . '</td>';
      echo '<td class="whitespace-nowrap text-sm font-semibold text-gray-900">
