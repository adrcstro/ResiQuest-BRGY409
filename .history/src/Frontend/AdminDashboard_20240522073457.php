...
while($row = mysqli_fetch_assoc($result)) {
  ...
  echo "<td class='flex justify-center items-center w-24 h-24 overflow-hidden'>
  <img src='../Backend/uploads/" . $row["NewsImages"] . "' alt='News Image' class='max-w-full max-h-full object-cover'>
</td>";
