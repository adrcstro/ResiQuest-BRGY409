...
<script>function filterRequests(status) {
    fetch(`filter_requests.php?status=${status}`)
...
if(isset($_GET['status'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<div class="mx-auto text-center mt-8" style="width: 50%;">No requests found.</div>';
    }
} else {
