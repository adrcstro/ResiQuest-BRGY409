...
Complete Request
       ...
       <ul tabindex="0"  class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
          ...
          <li class"reject-btn" data-request-id="' . $row["RequestID"] . '"><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
//reject request
                  ...
                  <div class="modal-box w-70 max-w-3xl rounded-lg">
                      ...
                      <form id="rejectresidentreq" action="../Backend/Update.php" method="post" enctype="multipart/form-data">
...
<path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />
                ...
                $(function() {
                    $("#rejectresidentbutton").click(function(e) {
                        ...
                        var valid = $("#rejectresidentreq")[0].checkValidity();
            
                        if (valid) {
                            var formData = new FormData($("#rejectresidentreq")[0]);
