   ...
   <div  id="ResidentsDocumentsRequested"  style="display: none;" class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
      <div class="pt-3 px-4">
         <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  xl:gap-4 my-4">
              ...
              <div class="flex flex-wrap justify-center gap-y-6 gap-x-6 items-start">
              <div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2 h-96 w-72">
        <div class="flex justify-between items-center">
            ...
            <div class="text-left ml-4">
                ...
                <button class="mt-2 rounded-md bg-gradient-to-r from-blue-400 to-indigo-500 text-xl text-white pt-3 pb-4 px-8 inline" onclick="RequestResidency.showModal()">Request</button>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2">
        <div class="flex justify-between items-center">
            ...
            <div class="text-left ml-4">
                ...
                <button class="mt-2 rounded-md bg-gradient-to-r from-blue-400 to-indigo-500 text-xl text-white pt-3 pb-4 px-8 inline" onclick="RequestClearance.showModal()">Request</button>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2">
        <div class="flex justify-between items-center">
            ...
            <div class="text-left ml-4">
                <h2 class="font-semibold text-xl mb-3">Medical Certificate</h2>
                <p class="capitalize text-sm mt-2 mb-2">Consult with a physician for the necessary medical examination</p>
                <button class="mt-2 rounded-md bg-gradient-to-r from-blue-400 to-indigo-500 text-xl text-white pt-3 pb-4 px-8 inline" onclick="RequestMedicalCertificate.showModal()">Request</button>
            </div>
        </div>
    </div>
</div>
