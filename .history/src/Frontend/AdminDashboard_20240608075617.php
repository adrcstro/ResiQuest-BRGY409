...
Add Residents Information
         ...
         <nav class="flex flex-wrap items-center justify-center space-x-3 mb-3 px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-2 sm:space-x-4 md:space-x-6 rtl:space-x-reverse">
        <li class="inline-flex items-center">
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="#" onclick="displayMaleresident()" class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white md:ms-2">Male Resident</a>
            </div>
        </li>
        <li>
            <div class="flex items-center">
                ...
                <a href="#" onclick="displayFemaleresident()" class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white md:ms-2">Female Resident</a>
            </div>
        </li>
        <li>
            <div class="flex items-center">
                ...
                <a href="#" onclick="displaySenioreresident()" class="ms-1 text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white md:ms-2">Senior Resident</a>
            </div>
        </li>
    </ol>
</nav>
