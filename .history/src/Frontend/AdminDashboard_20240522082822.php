...
Add News/Announcement
    ...
    <input  type="file" name="Government-ID" id="Government-ID" accept=".jpg, .png, .jpeg, .pdf, .doc, .docx" class="hidden" onchange="displayImage(this, 'front')" />
                        ...
                        <div class="flex-1">
                            ...
                            <textarea name="NewsContent" rows="6" class="rounded-lg border-gray-200 w-full h-50 pt-2 text-gray-900 border-1 bg-white input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500 resize-none" placeholder="Enter News Content" required></textarea>
                        </div>
                    </div>
