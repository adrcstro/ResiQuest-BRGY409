...
document.getElementById('Addadministrator').addEventListener('click', function() {
  ...
  <div class="flex flex-col">
       ...
       <div class="mb-4 flex flex-col items-center lg:flex-row lg:items-center lg:justify-between">
        ...
        <div class="flex justify-center mt-2 lg:mt-3">
            <button class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded" onclick="ViewSchedule.showModal()">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 inline-block align-middle text-white">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-18 0v-7.5A2.25 2.25 0 0 1 5.25 3h13.5A2.25 2.25 0 0 1 21 5.25v7.5m-18 0A2.25 2.25 0 0 0 3 15.75h13.5A2.25 2.25 0 0 0 18.75 13" />
                </svg>
                View Schedule
            </button>
...
if(mysqli_num_rows($result) > 0) {
   ...
   while($row = mysqli_fetch_assoc($result)) {
       ...
       echo '<td class="p-3 border border-inherit text-center  whitespace-nowrap text-sm font-semibold text-gray-900"></td>';
       echo '</tr>';
   }
