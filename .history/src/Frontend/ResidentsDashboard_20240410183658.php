...
$row = mysqli_fetch_assoc($result);
    ...
    $query = "SELECT password FROM your_table_name WHERE id = $user_id"; // Replace 'your_table_name' with the actual table name in your database
                       ...
                       <div class="col-span-4 sm:col-span-3">
                           ...
                           <div class="bg-white shadow-2xl rounded-lg p-6 mt-3 ">
                             ...
                             <div>
                                 ...
                                 <div class="mt-2.5">
    <input value="<?php echo $original_password ?>" required="" type="text" name="last-name" id="last-name" autocomplete="family-name"
