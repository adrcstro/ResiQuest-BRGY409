...
const closeModalBtn = document.getElementById("edit-close-modal-btn");

// Get the button that saves the request details
const saveRequestDetailsBtn = document.getElementById("editrequestbutton");
...
saveRequestDetailsBtn.addEventListener("click", () => {
  // Close the modal
  closeModal();

  // You can add additional logic here to save the request details
});
</script>';
