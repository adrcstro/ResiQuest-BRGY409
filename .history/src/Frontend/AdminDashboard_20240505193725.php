            ...
            <div class="flex flex-col">
                ...
                <div class="bg-white h-full shadow rounded-lg p-4  sm:p-6 xl:p-8 xl:gap-4 my-4">
                        ...
                        <div class="flex justify-center mb-4">
                            ...
                            <button onclick="showPendingrequest(this)" class="bg-red-400 text-white font-bold py-2 px-4 rounded">
...
<script>
    function showPendingrequest(button) {
        // Add a class to the button to keep the hover effect
        button.classList.add('hover:bg-red-600');
        // Call your function to handle the click event
        // showPendingrequest() or any other function you want
        //showPendingrequest();
    }
</script>
