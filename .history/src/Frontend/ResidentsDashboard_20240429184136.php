            ...
            button.addEventListener("click", function () {
                ...
                fetch("../Backend/fetch_request_details.php?request_id=" + requestId)
                    ...
                    .then(data => {
                        ...
                        // Dynamically create input fields based on ServiceType
                        let inputFields = "";
                        if (serviceType === "Certificate of Residency" || serviceType === "Certificate of Indigency") {
                            inputFields = `

                            <div class="flex justify-center">
                            <input type="text" name="EditFirstName" placeholder="First Name" class="mr-2">
                            <input type="text" name="EditMiddleName" placeholder="Middle Name" class="mr-2">
                            <input type="text" name="EditLastName" placeholder="Last Name">
                        </div>
                        <div class="flex justify-center">
                            <input type="text" name="EditAddress" placeholder="Address" class="mr-2">
                            <input type="text" name="EditPurpose" placeholder="Purpose">
                        </div>
                            ...
                            inputFields = `
                                <input type="text" name="EditFirstName" placeholder="First Name">
                                <input type="text" name="EditMiddleName" placeholder="Middle Name">
                                <input type="text" name="EditLastName" placeholder="Last Name">
                                <input type="text" name="EditAddress" placeholder="Address">
                                <input type="text" name="EditBusinessAct" placeholder="Business Activity">
                                <input type="text" name="EditBusinessLoc" placeholder="Business Location">
                            `;
                            ...
                            inputFields = `
                                ...
                                <input type="text" name="EditLastName" placeholder="Last Name">
                                <input type="text" name="EditAddress" placeholder="Address">
                                <input type="text" name="EditDateOfBirth" placeholder="Date of Birth">
                                <input type="text" name="EditPlaceOfBirth" placeholder="Place of Birth">
                                <input type="text" name="EditContactName" placeholder="Contact Name">
                                <input type="text" name="EditContactAddress" placeholder="Contact Address">
                                <input type="text" name="EditContactNum" placeholder="Contact Number">
                            `;
                        }
