...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->num_rows == 0) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire(
                'Error',
                'Email you typed is not registered',
                'error'
            );
        });
     </script>";
            ...
            <div class="flex flex-col items-center">
                ...
                <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="relative">
                        ...
                        <button 
                        name="submit" type="submit"     class="mt-4 tracking-wide font-semibold bg-blue-700 text-white-500 w-full py-4 rounded-lg hover:bg-blue-500 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
