...
echo '<tr>';
echo '<td class="p-4 whitespace-nowrap text-sm font-normal text-gray-900">'  ["RequestID"] . '</td>';
echo '<td class="p-4 whitespace-nowrap text-sm font-normal text-gray-900">'  ["ServiceType"] . '</td>';
echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">'  ["DateRequested"] . '</td>';
echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">'  ["Status"] . '</td>';
echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">'  ["PickUpDate"] . '</td>';
