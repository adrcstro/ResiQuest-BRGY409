...
<div>
    ...
    <li onclick="my_modal_3.showModal()" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
        id="user-menu-item-0">Your Profile</li>
    <li><a href="AdminLogin.php" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
