...
while($row = mysqli_fetch_assoc($result)) {
  ...
  echo "<td style='display: flex; justify-content: center; align-items: center; width: 100px; height: 100px; overflow: hidden;'>
  <img src='../Backend/uploads/" . $row["NewsImages"] . "' alt='News Image' style='max-width: 100%; max-height: 100%; object-fit: cover;'>
</td>";
