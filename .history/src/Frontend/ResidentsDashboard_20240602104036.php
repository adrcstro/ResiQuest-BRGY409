...
<div id="complaints-container">
    ...
    <script>
     ...
     <div class="relative bg-white w-full h-full shadow rounded-lg p-4 sm:p-6 xl:p-8 my-4">
    <!-- SVG Image Container -->
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div class="bg-blue-100 p-4 rounded-md">
            ...
            <ul class="list-disc ml-6 mb-4">
                ...
                <li>Upon submitting Government IDs please make sure that it is clear front and back.</li>
                <li>Failure to follow these will result in not verifying your account!</li>
            </ul>
        </div>
