...
// Your PHP code to fetch $row

// Define a function to generate the JavaScript code
function generateEditRequestScript($row) {
...
$editRequestScript = generateEditRequestScript($row);

// Output the JavaScript code
echo $editRequestScript;
