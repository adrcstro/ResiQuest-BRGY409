...
<head>
    ...
    <script>
        function showRequestedDocuments() {
            ...
            xhr.open('GET', 'RequestDocument.php', true);
            xhr.onload = function () {
                if (xhr.status === 200) {
                    document.getElementById('showRequestedDocuments').innerHTML = xhr.responseText;
                } else {
                    console.error('Error loading requested documents:', xhr.statusText);
                }
            };
