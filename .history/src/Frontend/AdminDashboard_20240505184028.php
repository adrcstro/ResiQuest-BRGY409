...
<div id="showRequestedDocuments" style="display: none;" class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
        <div class="pt-3 px-4 mb-4">
            <div class="flex flex-col">
                ...
                <div class="bg-white  shadow rounded-lg p-4 pb-12 sm:p-6 xl:p-8 xl:gap-4 my-4">
                        <div class="mb-4 flex flex-col lg:flex-row items-center justify-between">
                            <div class="mb-4 lg:mb-0">
                        ...
                        <div class="flex justify-center mb-4">
                            ...
                            <button onclick="showPendingrequest()" class="bg-red-400 hover:bg-red-600 text-white font-bold py-2 px-4 rounded button-bg-red active" id="pendingButton">
...
<button onclick="showOnprocessrequest()" class="bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded button-bg-yellow" id="onProcessButton">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<button onclick="showCompleterequest()" class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded button-bg-green" id="completeButton">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<style>
    ...
    .button-bg-red.active:hover {
        background-color: #991b1b;
    }

    .button-bg-yellow.active:hover {
