  ...
  button.addEventListener("click", function () {
     ...
     // Display default text in modal content
           ...
           <div class="flex-1 flex flex-col justify-between">
               <div>
                   <span class="block text-sm font-semibold leading-6 text-gray-900">News Title</span>
                   <input value="" type="text" name="NewsTitle" placeholder="Enter News Title" class="input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500 input-white w-full bg-white text-slate-900" readonly />
               </div>
               <div class="mt-3 flex flex-col sm:flex-row gap-x-6">
                   <div class="sm:flex-1">
                       <label for="NewsDate" class="block text-sm font-semibold leading-6 text-gray-900">News Date</label>
               ...
               <textarea name="NewsContent" rows="6" class="rounded-lg border-gray-200 w-full h-64 pt-2 text-gray-900 border-1 bg-white input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500 resize-none" placeholder="Enter News Content....." readonly>""</textarea>
           </div>
           </div>
           </div>
