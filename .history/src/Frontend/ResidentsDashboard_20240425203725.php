...
if (!empty($_SESSION["ID"])) {
    ...
    // Fetch data from requestdocument table where UserID matches
    $query = "SELECT RequestID, FirstName, ServiceType, DateRequested, Status FROM requestdocument WHERE UserID = $userID";
    ...
    if ($result) {
        ...
        // Use $data array to display or process the fetched data
        foreach ($data as $row) {
            echo "RequestID: " . $row['RequestID'] . "<br>";
            echo "FirstName: " . $row['FirstName'] . "<br>";
            echo "ServiceType: " . $row['ServiceType'] . "<br>";
            echo "DateRequested: " . $row['DateRequested'] . "<br>";
