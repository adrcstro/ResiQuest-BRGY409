        ...
        button.addEventListener('click', function() {
            ...
            if (adminData) {
                modalContent.innerHTML = `
                    ...
                    <img src="../Backend/uploads/${adminData.AdminProfile}" alt="Avatar" class="w-20 h-20 rounded-full mx-auto mb-4">
                    <p><strong>Position:</strong> ${adminData.BrgyPosition}</p>
                    <p><strong>Gender:</strong> ${adminData.AdGender}</p>
                    <p><strong>Service Start:</strong> ${adminData.RenderedServiceStart}</p>
                    <p><strong>Service End:</strong> ${adminData.RenderedServiceend}</p>
                `;
                modal.showModal();
            }
        });
