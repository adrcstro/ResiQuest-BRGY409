...
<div class="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                   <div class="bg-blue-400 shadow rounded-lg p-4 sm:p-6 xl:p-8 relative">
                   <div class="flex items-center justify-between">
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: { labels: ['Not Registered', 'Registered', 'Pending Registration','Others'],datasets: [{label: 'Residents Voter Status',data: <?php echo json_encode($counts); ?>,backgroundColor: 'rgba(75, 192, 192, 0.2)',
            borderColor: 'rgba(255, 255, 255, 1)',borderWidth: 1}]},options: {
        scales: {y: {beginAtZero: true,ticks: { color: 'white' },grid: { color: 'rgba(255, 255, 255, 0.5)' }
            },x: {ticks: { color: 'white' },grid: { color: 'rgba(255, 255, 255, 0.5)' }}},plugins: {legend: {labels: { color: 'white' }}}}});
</script>
