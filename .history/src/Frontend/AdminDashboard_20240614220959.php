   ...
   <div id="Allresidenttbl">
    <script>
        function loadTable(page) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    bindModalEvents(); // Bind events after the content is loaded
                },
                error: function() {
        ...
        function bindModalEvents() {
            $(document).on('click', '.open-resident-details-modal-btn', function() {
                var residentId = $(this).data('residents-id');
                // Add logic to open the details modal and load the resident details
                console.log('View Details for resident ID:', residentId);
            });

            $(document).on('click', '.edit-residents-btn', function() {
                var residentId = $(this).data('residents-id');
                // Add logic to open the edit modal and load the resident details for editing
                console.log('Edit resident ID:', residentId);
            });

            $(document).on('click', '.delete-residents-btn', function() {
                var residentId = $(this).data('residents-id');
                // Add logic to open the delete confirmation modal
                console.log('Delete resident ID:', residentId);
            });

            $(document).on('click', '.delete-verify-btn', function() {
                var residentId = $(this).data('residents-id');
                // Add logic to open the verify delete confirmation modal
                console.log('Verify delete for resident ID:', residentId);
            });
        }
