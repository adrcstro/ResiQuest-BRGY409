...
//print request 
                    ...
                    <div class="px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
                    <button" id="printdocument" class="inline-flex justify-center  rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-500 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm"> 
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
                  ...
                  document.addEventListener("DOMContentLoaded", function () {
                    ...
                    <h1 class="text-sm font-bold"><span class="font-semibold">Service-Type:</span> ${servietype}</h1>
                        <div class="hidden  items-center justify-center mt-3">
                        <input  value="${ID}"   type="text" name="printidID" id="printidID" autocomplete="given-name" placeholder=""
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
                    </div>
                    </div>
                </div>
                ...
                document.getElementById("printdocument").addEventListener("click", function() {
                    ...
                    if (newTab) {
                        ...
                        // Append the cloned form to the new tabs document body
                        newTab.document.body.appendChild(clonedForm);
            
                        // Submit the cloned form in the new tab
                        clonedForm.submit();
                    } else {
                        // Display an error message if the new tab couldnt be opened
