...
<div id="Allresidenttbl" data-url="../Backend/AdminTables/residenttable.php">
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.pagination-btn', function() {
            ...
            var url = $('#Allresidenttbl').data('url'); // Retrieve URL from data attribute
            loadTablepagination(url, page);
        });
    });

    function loadTablepagination(url, page) {
        $.ajax({
            url: url,
            type: 'POST',
            data: {page: page},
            ...
            error: function(xhr, status, error) {
                console.log(xhr.responseText); // Log the actual error message for debugging
                alert('Error loading data: ' + error); // Show a more informative alert
            }
        });
    }
</script>
