             ...
             <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                <div class="flex-1 px-3 bg-white divide-y space-y-1">
                   <ul class="space-y-2 pb-2">
                      ...
                      <li>
                         <a href="AdminDashboard.php" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group" onclick="showAdminDashboard()">
                      ...
                      <li>
                         <a href="Residentrecord.php"  class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group " onclick="showresidentsRecord()">
                           <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                      ...
                      <li>
                         <a href="DocumentRequest.php"  class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group" onclick="showRequestedDocuments()">
                           <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <div class="flex flex-col">
            <div class="overflow-x-auto rounded-lg">
             ...
             <div class="flex-shrink-0">
                 ...
                 <button onclick="Admin_addresident.showModal()" class="mt-2 w-full relative text-white border-2 rounded-lg bg-green-400 dark:bg-gray-800 dark:border-gray-700 hover:bg-green-500  font-semibold py-2 px-4">
...
Add Residents Information
            ...
            <dialog id="Admin_addresident" class="modal p-3">
        ...
        <div class="flex flex-col">
            <div class="overflow-x-auto rounded-lg">
                <div class="mb-2 lg:mb-0">
                    ...
                    <span class="flex text-base font-medium text-blue-400 justify-center text-center">Add Residents</span>
                </div>
                <form method="dialog"> <button  class="btn btn-sm btn-circle btn-ghost absolute top-2 right-2">✕</button></form>
<!-- form -------------------------------------------------------------------------------------------->

<form id="addadminresident" action="../Backend/Insert.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                               <div class="mx-auto max-w-3xl mt-6">
                        <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                        <div class="sm:flex-1">
                        <label for="AdminaddresidentfirstName" class="block text-sm font-medium text-gray-700">First Name</label>
                        <input  required="" type="text" name="AdminaddresidentfirstName" id="AdminaddresidentfirstName" autocomplete="family-name" placeholder="First Name"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
                      </div>
<div class="sm:flex-1">
<label for="AdminaddresidentlastName" class="block text-sm font-medium text-gray-700">Last Name</label>
<input  required="" type="text" name="AdminaddresidentlastName" id="AdminaddresidentlastName" autocomplete="family-name" placeholder="Last Name"
 class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
</div>
</div>
      <div class=" mt-3 flex flex-col sm:flex-row gap-x-6"> 
      <div class="sm:flex-1">
  <div class="relative">
    <label for="AdminaddresidentphoneN" class="block text-sm font-medium text-gray-700">Phone Number</label>
    <div class="relative">
      <input
        class="block w-full pl-12 rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2"
        type="number" name="AdminaddresidentphoneN" placeholder="+63" required/>
      <img
        src="/Images/flg.svg"
        alt="lettericon" class="absolute left-3 top-1/2 transform -translate-y-1/2 h-6 w-6 text-gray-400"/>
    </div>
  </div>
</div>
        <div class="sm:flex-1">
        <label for="addAdminResidentGender" class="block text-sm font-semibold leading-6 text-gray-900">Gender</label>
<select required id="addAdminResidentGender" 
class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
 name="addAdminResidentGender" type="text" required>
<option  value="" disabled selected>Gender</option>
<option value="Male">Male</option>
<option value="Female">Female</option>
</select>
...
<div>
        <label for="adminaddresiEmail" class="block text-sm font-medium text-gray-700 mt-2">Email</label>
      <input  required="" type="email" name="adminaddresiEmail" id="adminaddresiEmail" autocomplete="given-name" placeholder="Enter Password"
      class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
   </div>
<div>
        <label for="adminaddConfirmPAssword" class="block text-sm font-medium text-gray-700 mt-2">Confirm Password</label>
      <input  required="" type="password" name="adminaddConfirmPAssword" id="adminaddConfirmPAssword" autocomplete="given-name" placeholder="Enter Password"
      class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
   </div>
<div>
        <label for="adminaddresiPAssword" class="block text-sm font-medium text-gray-700 mt-2">Password</label>
      <input  required="" type="password" name="adminaddresiPAssword" id="adminaddresiPAssword" autocomplete="given-name" placeholder="Enter Password"
      class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
   </div>
   <div class="px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row mt-3">
          <button id="Addadministratorresidentinfo"  type="submit" class="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-500 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm"> 
...
<script>
$(function() {
    $('#Addadministratorresidentinfo').click(function(e) {
        e.preventDefault();
        var valid = $('#addadminresident')[0].checkValidity();
        if (valid) {
            var formData = new FormData($('#addadminresident')[0]);
            $.ajax({
                type: 'POST',
                url: '../Backend/Insert.php',
                data: formData,
...
document.getElementById('Addadministratorresidentinfo').addEventListener('click', function() {
    var dialog = document.getElementById('Addadministratorresidentinfo');
    dialog.close();
});
</script>  
