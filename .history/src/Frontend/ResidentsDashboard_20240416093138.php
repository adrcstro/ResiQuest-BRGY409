...
<div>
    <nav class="bg-white border-b border-gray-200 fixed z-30 w-full">
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-5 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <img src="../Backend/uploads/<?php echo $row["Profile"]; ?>" class="h-8 w-8 rounded-full border-blue-600" alt="Profile Picture">
    <?php else: ?>
        <img src="/Images/blank.png" class="h-8 w-8 rounded-full border-blue-600" alt="Default Profile Picture">
    <?php endif; ?>
             </button>
         </div>
         <div id="user-menu"
