...
<div id="complaints-container">
    ...
    <div class="flex items-center justify-center mb-4">
        <button onclick="EditResidentprofile.showModal()" class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded" onclick="EditResidentprofile.showModal()">
