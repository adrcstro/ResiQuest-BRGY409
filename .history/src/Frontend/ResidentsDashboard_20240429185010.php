            ...
            if (serviceType === "Certificate of Residency" || serviceType === "Certificate of Indigency") {
                ...
                inputFields = `
                    <div class="flex justify-center">
                        <input type="text" name="EditFirstName" placeholder="First Name" class="mr-2">
                        <input type="text" name="EditMiddleName" placeholder="Middle Name" class="mr-2">
                        <input type="text" name="EditLastName" placeholder="Last Name" class="mr-2">
                    </div>
                    <div class="flex justify-center mt-4">
                        <input type="text" name="EditAddress" placeholder="Address" class="mr-2">
                        <input type="text" name="EditBusinessAct" placeholder="Business Activity" class="mr-2">
                ...
                inputFields = `
                    ...
                    <div class="flex justify-center mt-4">
                        <input type="text" name="EditAddress" placeholder="Address" class="mr-2">
                        <input type="text" name="EditDateOfBirth" placeholder="Date of Birth" class="mr-2">
                        <input type="text" name="EditPlaceOfBirth" placeholder="Place of Birth">
                    </div>
                    <div class="flex justify-center mt-4">
                        <input type="text" name="EditContactName" placeholder="Contact Name" class="mr-2">
                        <input type="text" name="EditContactAddress" placeholder="Contact Address" class="mr-2">
