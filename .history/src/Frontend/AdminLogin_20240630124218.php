...
<!-- login -------------------------------------------------------------------------------------------------------------->
    ...
    <ul class="list-disc text-first text-sm text-gray-600">
        <li>Monitoring Resident Details</li>
        <li>Monitoring Resident Status</li>
        <li>Monitoring Resident Count</li>
    ...
    <h2 class="text-md font-semibold text-gray-600">Monitor Comminity Status</h2>
