...
<script>
    function loadTable(page, phpScriptURL) {
        $.ajax({
            url: phpScriptURL,
            type: 'POST',
            data: {page: page},
    ...
    $(document).ready(function() {
        // Modify this line to pass the PHP script URL dynamically
        var phpScriptURL = '../Backend/AdminTables/residenttable.php';
        
        loadTable(1, phpScriptURL); // Initial load
        
        $(document).on('click', '.pagination-btn', function() {
            var page = $(this).data('page');
            loadTable(page, phpScriptURL);
        });
    });
</script>
