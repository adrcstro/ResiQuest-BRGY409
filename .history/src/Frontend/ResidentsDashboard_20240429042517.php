...
echo'<div id="EditRequestModal" class="modal p-3">
<div class="modal-box w-100 max-w-md rounded-md">
    <form id="edit-request-form" class="p-4">
        <input type="hidden" id="requestId" name="requestId">
        <label for="newDetails" class="block mb-2">New Details:</label>
        <textarea id="newDetails" name="newDetails" rows="4" class="w-full border border-gray-300 rounded-md p-2 mb-4"></textarea>
        <div class="flex justify-end">
            <button type="submit" class="btn btn-primary">Update</button>
            <button type="button" class="btn btn-secondary ml-2" onclick="closeEditRequestModal();">Cancel</button>
...
function closeEditRequestModal() {
    document.getElementById('EditRequestModal').close();
}
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const newDetailsInput = document.getElementById("newDetails");

    editRequestButtons.forEach(function (button) {
        button.addEventListener("click", function () {
            const requestId = button.getAttribute("data-request-id");
            requestIdInput.value = requestId; // Set the request ID in the form
    ...
    form.addEventListener("submit", function (event) {
        ...
        const newDetails = newDetailsInput.value;

        // Send request to update details
        fetch("../Backend/UpdateRequest.php", {
            method: "POST",
            body: JSON.stringify({ requestId, newDetails }),
            headers: {
        ...
        .then(data => {
            ...
            Swal.fire(
                "Updated!",
                "Request details have been updated.",
                "success"
            );
        ...
        .catch(error => {
            ...
            Swal.fire(
                "Error!",
                "An error occurred while updating the request details.",
                "error"
            );
        });
    });
