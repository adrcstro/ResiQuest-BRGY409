...
<div class="flex items-center">
 ...
 <h3 class="text-lg font-semibold mb-2">Submmision of Government ID</h3>
              ...
              <ul class="list-disc ml-6 mb-4">
                <li>Only these Government ID's we will accept (Barangay ID, Philhealth ID, National ID, Drivers License, Postal ID) if you dont have these ID's you can submit your PSA and make sure it is a scanned Copy</li>
