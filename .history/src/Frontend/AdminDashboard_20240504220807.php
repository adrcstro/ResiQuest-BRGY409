               ...
               <div class="mb-4 flex flex-col lg:flex-row items-center justify-between">
                  ...
                  <div class="flex-shrink-0">
                      ...
                      <div class="flex justify-end mt-2 lg:mt-3 space-x-2">
                          ...
                          <button tabindex="0" role="button" class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
                         <path stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 0 0 5.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 0 0 9.568 3Z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 6h.008v.008H6V6Z" />
                         </svg>
                          View Residents By
                           <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-lg bg-base-100 rounded-box w-52 text-gray-900">
                     <li><a>Male</a></li>
                    <li><a>Female</a></li>
...
if (empty($row["Profile"])) {
   // If empty, use the path to the default image
   $profileImagePath = "path_to_default_image.jpg";
} else {
   // If not empty, use the path to the uploaded image
   $profileImagePath = "../Backend/uploads/" . $row["Profile"];
}
...
if(mysqli_num_rows($result) > 0) {
   ...
   while($row = mysqli_fetch_assoc($result)) {
      ...
      switch ($row["Status"]) {
       ...
       echo '<tr>';
       echo '<td class="p-3 flex items-center justify-center border border-inherit text-center  whitespace-nowrap text-sm font-semibold text-gray-900"><img src="../Backend/uploads/' . $row["Profile"] . '" alt="Item Image" width="30"></td>';
