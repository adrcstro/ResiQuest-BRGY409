...
// Create a function to show the SweetAlert
function showSweetAlert() {
    swal("Hello!", "This is a simple SweetAlert.", "success");
}

// Add a click event listener to the button
document.getElementById("myButton").addEventListener("click", showSweetAlert);
