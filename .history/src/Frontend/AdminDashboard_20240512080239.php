...
//print request 
                    ...
                    <div class="modal-box w-70 max-w-3xl rounded-lg">
                        ...
                        <form id="printdocsform" action="../Backend/generate_pdf.php" method="post" enctype="multipart/form-data">
                      <div id="printdocument"></div>
                      </form>
                      <div class="mt-4 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
                      <button id="printclose" class="btn btn-sm btn-circle btn-ghost absolute top-2 right-2">
                      ✕
                    </button>
                    <div class="px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
                    <button" document.getElementById("printdocument-btn").setAttribute("data-href", "GenerateResidenIndigen.php");
                    class="inline-flex justify-center  rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-500 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm"> 
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
                  ...
                  document.addEventListener("DOMContentLoaded", function () {
                    ...
                    openModalButtons.forEach(function (button) {
                        button.addEventListener("click", function () {
                            ...
                            // Redirect to the appropriate PHP file based on service type
                            switch(servietype) {
                                case "Certificate of Residency":
                                case "Certificate of Indigency":
                                    document.getElementById("printdocument-btn").setAttribute("data-href', 'GenerateResidenIndigen.php");
                                    break;
                                case "Business Clearance":
                                    document.getElementById("printdocument-btn").setAttribute("data-href", "GenerateBusinessClerancen.php");
                                    break;
                                case "Barangay Identification":
                                    document.getElementById("printdocument-btn").setAttribute("data-href", "GenerateBrgyForm.php");
                                    break;
                                default:
                    ...
                    document.getElementById("printdocument-btn").addEventListener("click", function() {
                        ...
                        if (href) {
                            const form = document.getElementById("printdocsform");
                            form.setAttribute("action", "../Backend/" + href);
                            form.submit();
                        } else {
