...
// Function to reinitialize event listeners for dynamically loaded content
function reinitializeEventListeners() {
    // Add event listener for open-resident-details-modal-btn
    $(document).off('click', '.open-resident-details-modal-btn').on('click', '.open-resident-details-modal-btn', function() {
        // Your code for handling the click event
    });

    // Add event listener for edit-residents-btn
    $(document).off('click', '.edit-residents-btn').on('click', '.edit-residents-btn', function() {
        // Your code for handling the click event
    });

    // Add event listener for delete-residents-btn
    $(document).off('click', '.delete-residents-btn').on('click', '.delete-residents-btn', function() {
        // Your code for handling the click event
    });

    // Add event listener for delete-verify-btn
    $(document).off('click', '.delete-verify-btn').on('click', '.delete-verify-btn', function() {
        // Your code for handling the click event
    });
}
