  ...
  <div class="flex flex-col mt-8">
        ...
        <ol class="inline-flex items-end space-x-10 md:space-x-2 rtl:space-x-reverse">
            <li class="inline-flex items-center ">
                <a href="#" data-status="Pending" class="status-link inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                    Pending Complaint
                </a>
            </li>
            <li>
                <div class="flex items-center">
                    <a href="#" data-status="On-Process" class="status-link ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">On Process Complaint</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    <a href="#" data-status="On-Schedule" class="status-link ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">View Schedule for Settlement</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    <a href="#" data-status="Settled" class="status-link ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Complaint History</a>
                </div>
            </li>
        </ol>
    </nav>
...
<div id="complaints-container" class="mt-8">
