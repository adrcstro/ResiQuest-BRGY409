...
<dialog id="EditResidentprofile" class="modal p-3">
  <div class="modal-box w-full max-w-6xl rounded-none">
    ...
    <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
      ...
      <form id="updateForm" action="../Backend/Update.php" method="post" enctype="multipart/form-data">
                               ...
                               <div class="relative">
                               <div class="relative">
  <!-- Display file information from the database -->
  <?php if(isset($row["Profile"]) && !empty($row["Profile"])): ?>
  ...
  <input type="file" id="PRofile" name="PRofile" accept=".jpg, .png, .jpeg, .pdf, .doc, .docx" onchange="displaySelectedImage(event)">
</div>
