...
if (isset($_POST['revert'])) {
    ...
    echo "Record reverted to original table and deleted from archive.";
    header("Location: Residentrecord.php"); // Redirect back to the display page
    ...
    document.addEventListener('DOMContentLoaded', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = 'archive_table_display.php'; // Redirect back to the display page
            }
        });
    });
    </script>";
