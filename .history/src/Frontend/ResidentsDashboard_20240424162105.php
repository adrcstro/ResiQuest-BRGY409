    ...
    <ul class="list-disc text-sm">
      ...
      <div class="col-span-4 sm:col-span-9">
          <div class="bg-white shadow-2xl rounded-lg p-6">
             ...
             <div>
                        <label for="firstnamebrgyIndigency" class="block text-sm  leading-6 text-gray-900">First Name</label>
                        <div>
                    ...
                    <div>
                        <label for="MnamebrgyIndigency" class="block text-sm leading-6 text-gray-900">Middle Name</label>
                        <div>
                    ...
                    <div>
                        <label for="lastnamebrgyIndigency" class="block text-sm  leading-6 text-gray-900">Last Name</label>
                        <div>
                  ...
                  <div>
                      <label for="last-name" class="mt-2 block text-sm font-semibold leading-6 text-gray-900">Business Location</label>
                      <div class="mt-2.5">
                  ...
                  <div class="flex flex-col sm:flex-row gap-x-6">
                      ...
                      <div class="sm:flex-1">
                          <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900 mt-3">Home Address</label>
                          <div class="mt-2.5">
                      ...
                      <div class="hidden">
                      <label for="ServicetypebrgyIndigency" class="block text-sm font-semibold leading-6 text-gray-900 mt-3">Service Type</label>
                    <div class="mt-2">
