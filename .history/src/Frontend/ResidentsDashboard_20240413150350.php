  ...
  <div class="modal-box w-full max-w-6xl rounded-none">
    ...
    <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
      ...
      <div class="bg-white shadow-2xl rounded-lg p-6 ">
       ...
       <form id="updateForm" action="../Backend/Insert.php" method="post" enctype="multipart/form-data">
                               <div class="flex flex-col items-center">
...
<script>
  $(document).ready(function() {
    $("#SubmitInfotoVerify").click(function(e) {
      ...
      $.ajax({
        url: "../Backend/Insert.php", // Replace with the actual file name for update
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
