...
<div class="modal-box">
  ...
  <form id="editRequestForm" class="space-y-4">
    ...
    <div class="form-control" id="additionalFields" style="display: none;">
      ...
      <input type="text" id="contactName" name="contactName" placeholder="Contact Name" class="input input-bordered">
      <!-- Contact Address -->
      <label class="label">
        <span class="label-text">Contact Address</span>
      </label>
      <input type="text" id="contactAddress" name="contactAddress" placeholder="Contact Address" class="input input-bordered">
      <!-- Contact Number -->
      <label class="label">
        <span class="label-text">Contact Number</span>
      </label>
      <input type="text" id="contactNum" name="contactNum" placeholder="Contact Number" class="input input-bordered">
    </div>
