...
<dialog id="EditResidentprofile" class="modal p-3">
  ...
  <div class="relative">
    <?php if(isset($row["Profile"]) && !empty($row["Profile"])): ?>
        <img id="profilePicture" src="../Backend/uploads/<?php echo $row["Profile"]; ?>" class="w-32 h-32 bg-gray-300 rounded-full  mb-4 border-2 border-blue-300" alt="Profile Picture">
    <?php else: ?>
