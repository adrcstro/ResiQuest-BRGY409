...
<div class="sm:flex-1">
  <label for="categorization" class="block text-sm font-medium text-gray-700">Datecreated</label>
  <input value=""  type="text" name="categorization" id="categorization" autocomplete="street-address" 
      class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
</div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("categorization").value = currentDate;
  });
</script>';
