...
<script>
  ...
  if (file) {
    ...
    <div class="relative">
  <label for="Government-ID" class="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer">
    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
      <path fill-rule="evenodd" d="M17 3a2 2 0 012 2v10a2 2 0 01-2 2H3a2 2 0 01-2-2V5a2 2 0 012-2h14zM5 10a1 1 0 00-1 1v2a1 1 0 001 1h10a1 1 0 000-2H6a1 1 0 00-1-1zm10-3a1 1 0 00-2 0v1a1 1 0 002 0V7z" clip-rule="evenodd" />
    </svg>
  </label>
  <input required="" type="file" name="Government-ID" id="Government-ID" accept=".jpg, .png, .jpeg, .pdf, .doc, .docx" autocomplete="family-name"
         placeholder="Password"
         class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
         multiple style="opacity: 0; position: absolute; inset: 0;">
</div>
