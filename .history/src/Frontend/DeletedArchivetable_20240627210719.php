...
<div class="flex items-center">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />
              ...
              <p>This table will contain all of the deleted resident data.
               Before it is permanently archived, you will have three days
                to examine and confirm the information is accurate. You have this
                 time to make any necessary updates or corrections to guarantee that 
                 all records are true and comprehensive. This table will act as a makeshift
                  storage location for erased data, giving users a chance to retrieve any data
                   that was inadvertently removed. Following the three-day review period,
                    the data will be safely stored and rendered uneditable.</p>
</div>';
} else {
