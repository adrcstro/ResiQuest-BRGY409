...
if ($result->num_rows > 0) {
    ...
    foreach($messages as $senderID => $senderMessages) {
        ...
        echo "<img class='object-cover w-12 h-12 rounded-lg' src='../Backend/uploads/" . $senderProfile . "' alt='Sender Profile' />";
...
<div id="messageModal" class="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex justify-center items-center hidden">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-2xl"> <!-- Adjusted max width class -->
        ...
        <button class="mt-4 p-2 bg-red-500 text-white rounded" onclick="closeModal()">Close</button>
    </div>
</div>
...
function openModal(messages, senderProfile, senderName, senderID) {
    ...
    profileImg.src = '../Backend/uploads/' + senderProfile;
