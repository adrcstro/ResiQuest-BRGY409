            ...
            if (serviceType === "Certificate of Residency" || serviceType === "Certificate of Indigency") {
                inputFields = `
                    <div class="flex flex-col items-center">
                        <input type="text" name="EditFirstName" placeholder="First Name" class="mb-2">
                        <input type="text" name="EditMiddleName" placeholder="Middle Name" class="mb-2">
                        <input type="text" name="EditLastName" placeholder="Last Name">
                    </div>
                    <div class="flex flex-col items-center mt-4">
                        <input type="text" name="EditAddress" placeholder="Address" class="mb-2">
                ...
                inputFields = `
                    <div class="flex flex-col items-center">
                        <input type="text" name="EditFirstName" placeholder="First Name" class="mb-2">
                        <input type="text" name="EditMiddleName" placeholder="Middle Name" class="mb-2">
                        <input type="text" name="EditLastName" placeholder="Last Name" class="mb-2">
                        <input type="text" name="EditAddress" placeholder="Address" class="mb-2">
                        <input type="text" name="EditBusinessAct" placeholder="Business Activity" class="mb-2">
                ...
                inputFields = `
                    <div class="flex flex-col items-center">
                        ...
                        <input type="text" name="EditLastName" placeholder="Last Name" class="mb-2">
                        <input type="text" name="EditAddress" placeholder="Address" class="mb-2">
                        <input type="text" name="EditDateOfBirth" placeholder="Date of Birth" class="mb-2">
                        <input type="text" name="EditPlaceOfBirth" placeholder="Place of Birth" class="mb-2">
                        <input type="text" name="EditContactName" placeholder="Contact Name" class="mb-2">
                        <input type="text" name="EditContactAddress" placeholder="Contact Address" class="mb-2">
