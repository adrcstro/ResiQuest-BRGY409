...
<div id="Completedrequesttable" class="hidden"> 
    ...
    <ol class="inline-flex items-end space-x-4 md:space-x-6 rtl:space-x-reverse">
        <!-- Breadcrumb items with onclick attributes -->
<li>
    <div class="flex items-center">
        ...
        <a href="#" onclick="filterTable('future')" class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">View Future's Schedule</a>
    </div>
</li>
<li>
    <div class="flex items-center">
        ...
        <a href="#" onclick="filterTable('today')" class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 darkdark:hover
">View Today's Schedule</a>
</div>
...
<li>
    <div class="flex items-center">
        ...
        <a href="#" onclick="filterTable('overdue')" class="ms-1 text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">View Over Due</a>
    </div>
</li>
    </ol>
</nav>
...
<script>
    function filterTable(filter) {
        ...
        rows.forEach(function(row) {
            ...
            switch (filter) {
                case 'future':
                    if (!row.classList.contains('future')) {
                        display = "none";
                    }
                    break;
                case 'today':
