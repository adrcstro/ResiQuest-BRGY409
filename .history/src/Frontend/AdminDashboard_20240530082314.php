...
// Query to check if "Barangay Chairman" exists in BrgyPosition
$sql = "SELECT COUNT(*) as count FROM admintbl WHERE BrgyPosition = 'Barangay Chairman'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
$barangayChairmanExists = $row['count'] > 0;
...
<select required id="AdminPosition" name="AdminPosition" autocomplete="family-name"
    ...
    <?php endif; ?>
    <option value="Barangay Chairman" <?php echo $barangayChairmanExists ? 'disabled' : ''; ?>>Barangay Chairman</option>
