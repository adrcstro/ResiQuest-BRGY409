    ...
    <div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-sm mx-auto mt-2 sm:m-2">
        <div class="flex justify-between items-center">
            ...
            <div class="text-left ml-4">
                ...
                <button class="mt-2 rounded-md bg-gradient-to-r from-blue-400 to-indigo-500 text-xl text-white pt-3 pb-4 px-8  flex items-center justify-center" onclick="RequestRecidency.showModal()" >Request</button>
            </div>
        </div>
    </div>
