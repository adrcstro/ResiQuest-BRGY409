...
document.getElementById("rejectresidentbutton").addEventListener("click", function() {
    ...
    dialog.close();
      ...
      <li class="Print-Document-btn" data-request-id="<?php echo $row["RequestID"]; ?>" data-request-servietype="<?php echo $row["ServiceType"]; ?>" onclick="printDocument(<?php echo $row["RequestID"]; ?>)"><a>Print Document</a></li>
      <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
      <script>
