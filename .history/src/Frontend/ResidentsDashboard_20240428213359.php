...
echo'<script>
// JavaScript to handle edit modal functionality
document.addEventListener("DOMContentLoaded", function () {
    ...
    editRequestButtons.forEach(function (button) {
        button.addEventListener("click", function () {
            ...
            fetch("../Backend/fetch_request_details.php?request_id=" + requestId)
                ...
                .then(data => {
                    // Display fetched details in modal
                    modalContent.innerHTML = data; // Assuming you have a modalContent variable defined
                    // Update the modal title or any other necessary changes for editing
                    modal.showModal();
                });
        });
    });
    ...
    editForm.addEventListener("submit", function (event) {
        ...
        fetch("../Backend/update_request.php", {
            method: "POST",
            body: formData
        })
        .then(response => response.text())
        .then(result => {
            // Display result or handle success/error
            console.log(result);
            // You can display a success message or handle the response accordingly
        })
        .catch(error => {
