...
if ($result->num_rows > 0) {
    ...
    foreach($messages as $senderID => $senderMessages) {
        ...
        foreach($senderMessages as $message) {
            echo "<p class='max-w-xs text-sm text-gray-500 truncate'>" . htmlspecialchars($message["msg"]) . "</p>";
            echo "<p class='text-xs text-gray-400'>" . htmlspecialchars($message["Date"]) . " " . htmlspecialchars($message["Time"]) . "</p>";
        }
