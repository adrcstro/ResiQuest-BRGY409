...
echo '<script>
  ...
  echo '<dialog id="editRequestModal" class="modal p-3">
  <div class="modal-box w-100 max-w-4xl rounded-none">
    <div class="mb-2 lg:mb-0">
      <h3 class="text-2xl font-bold text-blue-500 text-center">Edit Request</h3>
    </div>
    <form id="editRequestForm" class="mt-8 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
      <input type="hidden" id="editRequestId" name="requestId">
      <input type="text" id="editServiceType" name="serviceType" placeholder="Service Type" class="input input-bordered w-full">
      <!-- Add other input fields for other request details -->
      <button type="submit" class="btn btn-primary">Update</button>
    </form>
    <div class="mt-4 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
      <button id="close-edit-modal-btn" class="btn btn-sm btn-circle btn-ghost absolute top-2 right-2">✕</button>
    </div>
  </div>
</dialog>';
...
// Inside the event listener for edit-request-btn
document.addEventListener("DOMContentLoaded", function () {
    const modal = document.getElementById("edit-request-modal");
    const modalContent = document.getElementById("edit-request-modal-content");
    const editRequestButtons = document.querySelectorAll(".edit-request-btn");
    const closeModalButton = document.getElementById("edit-request-modal-close");
  ...
  // Update modal fields based on ServiceType
  ...
  if (serviceType === "Certificate of Residency" || serviceType === "Certificate of Indigency") {
    modalContent.innerHTML = `
      ...
      <input type="text" name="middleName" placeholder="Middle Name" class="input input-bordered w-full" required>
      ...
      <input type="text" name="purpose" placeholder="Purpose" class="input input-bordered w-full" required>
    `;
    ...
    modalContent.innerHTML = `
      ...
      <input type="text" name="lastName" placeholder="Last Name" class="input input-bordered w-full" required>
      <input type="text" name="address" placeholder="Address" class="input input-bordered w-full" required>
      <input type="text" name="businessAct" placeholder="Business Activity" class="input input-bordered w-full" required>
      <input type="text" name="businessLoc" placeholder="Business Location" class="input input-bordered w-full" required>
    `;
    ...
    modalContent.innerHTML = `
      ...
      <input type="text" name="lastName" placeholder="Last Name" class="input input-bordered w-full" required>
      <input type="text" name="address" placeholder="Address" class="input input-bordered w-full" required>
      <input type="text" name="dateOfBirth" placeholder="Date of Birth" class="input input-bordered w-full" required>
      <input type="text" name="placeOfBirth" placeholder="Place of Birth" class="input input-bordered w-full" required>
      <input type="text" name="contactName" placeholder="Contact Name" class="input input-bordered w-full" required>
      <input type="text" name="contactAddress" placeholder="Contact Address" class="input input-bordered w-full" required>
      <input type="text" name="contactNum" placeholder="Contact Number" class="input input-bordered w-full" required>
    `;
  } else {
    modalContent.innerHTML = ""; // Clear modal content if ServiceType is not recognized
  }
});
