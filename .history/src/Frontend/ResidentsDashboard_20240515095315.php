...
?>
                 ...
                 <button class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:bg-red-600 " onclick="ViewSchedule.showModal()"  >
