...
<!-- Residents Record -------------------------------------------------------------------------------------------------------------->
    ...
    <div class="pt-3 px-4">
        <div class="flex flex-col">
            ...
            <button onclick="Admin_addresidentarchive.showModal()" class="mt-2 w-full relative text-white border-2 rounded-lg bg-green-400 dark:bg-gray-800 dark:border-gray-700 hover:bg-green-500  font-semibold py-2 px-4">
        ...
        <div class="flex flex-col">
            <div class="overflow-x-auto rounded-lg">
                <div class="mb-2 lg:mb-0">
                    ...
                    <span class="flex text-base font-medium text-blue-400 justify-center text-center">Deleted Residents Archive</span>
                </div>
                <form method="dialog"> <button  class="btn btn-sm btn-circle btn-ghost absolute top-2 right-2">✕</button></form>


                <?php include '../Backend/AdminTables/DeletedArchivetable.php'; ?>
