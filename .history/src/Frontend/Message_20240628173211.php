...
// SQL query to fetch data from the table and order by Time in descending order
...
<div id="messageModal" class="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex justify-center items-center hidden">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-2xl"> <!-- Adjusted max width class -->
        <div id="modalContent" class="flex flex-col-reverse max-h-[80vh] overflow-y-auto"></div> <!-- Added flex-col-reverse and max height class -->
...
function openModal(messages) {
    ...
    // Sort messages by Time in descending order (in case they are not sorted from backend)
    messages.sort((a, b) => new Date(b.Time) - new Date(a.Time));

    // Display messages in reverse order to mimic chat (latest at bottom)
    messages.forEach(message => {
        ...
        modalContent.prepend(messageElem); // Add messages to the top of the container
    });
