...
while($row = mysqli_fetch_assoc($result)) {
  ...
  if ($row["Status"] !== "Completed") {
      echo '<tr>';
      echo '<td class="p-1 border-0 border-inherit text-center  whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["RequestID"] . '</td>';
      echo '<td class="p-1  border-0 border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["ServiceType"] . '</td>';
      echo '<td class="p-1  border-0 border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["DateRequested"] . '</td>';
      ...
      echo '<td class="p-1  border-0 border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["PickUpDate"] . '</td>';
      echo '<td class="p-1   border-0 border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">
