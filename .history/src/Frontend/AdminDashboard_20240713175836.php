...
<div class="bg-blue-500 shadow rounded-lg p-4 sm:p-6 xl:p-8 relative">
    ...
    <h3 class="text-center text-black font-semibold">
        Barangay-409 Document Request & Blotter Report Monitoring Chart
    </h3>
    <button onclick="Request_Archive.showModal()" class="mt-3 relative text-white border-2 rounded-lg border-gray-200 bg-green-400 dark:bg-gray-800 dark:border-gray-700 hover:bg-green-500 font-semibold py-2 px-4">
