...
<!-- Residents Record -------------------------------------------------------------------------------------------------------------->
    ...
    <div class="pt-3 px-4">
        <div class="flex flex-col">
            ...
            <button onclick="Admin_addresidentarchive.showModal()" class="mt-2 w-full relative text-white border-2 rounded-lg bg-red-400 dark:bg-gray-800 dark:border-gray-700 hover:bg-red-500  font-semibold py-2 px-4">
