...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<img class='object-cover w-20 h-20 rounded-lg' src='../Backend/uploads/" . htmlspecialchars($row["SenderProfile"]) . "' alt='News Image' />";
        ...
        echo "<p class='max-w-xs text-sm text-gray-500 truncate'>" . htmlspecialchars($row["msg"]) . "</p>";
