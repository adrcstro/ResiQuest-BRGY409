...
<?php
$residentTableUrl = '../Backend/AdminTables/residenttable.php';
?>

<div id="Allresidenttbl"> 
    <?php include $residentTableUrl; ?>
</div>

<script>
var residentTableUrl = '<?php echo $residentTableUrl; ?>';

function loadTablepagination(page) {
    fetch(residentTableUrl, {
        method: 'POST',
        headers: {
    ...
    .then(response => {
        document.getElementById('Allresidenttbl').innerHTML = response;
    })
    .catch(() => {
