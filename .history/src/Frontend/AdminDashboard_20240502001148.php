...
<div>
    ...
    <li href="AdminLogin.php"><a>Sign out</a></li>
  </ul>
     </div>
  ...
  <div class="modal-box w-100 max-w-4xl rounded-lg h-full">
    ...
    <div class="mb-2 lg:mb-0">
              ...
              <span class="flex text-base font-medium text-blue-500 justify-center text-center">Administrator Details</span>
            </div>
  ...
  <script>
    ...
    if (file) {
      ...
      reader.readAsDataURL(file);
                ...
                <input  required="" type="text" name="requestId" id="requestId" autocomplete="given-name" placeholder="First Name"
            ...
            <div class="hidden">
                ...
                <input  required="" type="text" name="serviceType" id="serviceType" autocomplete="additional-name" placeholder="Middle Name"
                    class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
            </div>
