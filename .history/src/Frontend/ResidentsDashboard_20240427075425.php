    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        // Fetch and display each row
          ...
          while($row = mysqli_fetch_assoc($result)) {
            if ($row["Status"] !== "Completed") {
              ...
              <div tabindex="0" role="button" class=" text-white font-semibold  btn m-1 w-40 bg-blue-400 hover:bg-blue-500">Action</div>
              <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                  <li  class="open-modal-btn" data-request-id="' . $row["RequestID"] . '"  ><a>View Details</a></li>
        ...
        <div class="modal-box w-100 max-w-6xl rounded-none">
          <div class="bg-blue-500 shadow-2xl rounded-md p-6">
            <div class="mb-2 lg:mb-0">
              <h3 class="text-2xl font-bold text-white text-center">BRGY-409 Document Request Management System</h3>
              <span class="flex text-base font-medium text-white justify-center text-center">Request Details</span>
            </div>
          </div>
          ...
          <div class="mt-4 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
            <button id="close-modal-btn" class="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-500 hover:bg-red-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400  sm:w-auto sm:text-sm">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
                <path stroke-linecap="round" stroke-linejoin="round" d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
              </svg>
              Close
