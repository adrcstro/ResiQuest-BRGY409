        ...
        <select required id="voter-status" name="voter-status" autocomplete="family-name"
            ...
            <option value="Pending Registration">Pending Registration</option>
                                     ...
                                     <div>
                                         ...
                                         <div class="mt-2">
                                             <input value="<?php echo $row["email"]?>"  required="" type="email" name="email" id="email" autocomplete="family-name"
                                                 placeholder="Enter Email"
                                                 class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                         </div>
                                     </div>
                                 ...
                                 <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                                    ...
                                    <div class="sm:flex-1">
                                        ...
                                        <div class="mt-2">
                                            <input required="" type="text" name="Occupation" id="Occupation" autocomplete="organization"
                                    ...
                                    <div class="sm:flex-1">
                                        ...
                                        <div class="mt-2">
                                            <input value="<?php echo $row["ContactNumber"]?>"  required="" type="number" name="Contact-Number" id="Contact-Number" autocomplete="Contact-Number"
                                                placeholder="Your Contact Number"
                                                class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 flex-1">
                                        </div>
                                    </div>
                             ...
                             <div class="mt-3">
                              <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900">Citizenship</label>
                              <div class="mt-2">
                                  <input value="Filipino" required="" type="text" name="last-name" id="last-name" autocomplete="family-name"
                                      placeholder="Select Citizenship"
                                      class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                              </div>
                          </div>
