...
$row = mysqli_fetch_assoc($result);
    ...
    $query = "SELECT password FROM your_table_name WHERE id = :id";
    $stmt = $pdo->prepare($query);
    $stmt->execute(['id' => $user_id]); // Assuming $user_id is the ID of the user whose password you want to display
    $row = $stmt->fetch(PDO::FETCH_ASSOC);
    
    // Assuming $row["password"] contains the original, unhashed password
