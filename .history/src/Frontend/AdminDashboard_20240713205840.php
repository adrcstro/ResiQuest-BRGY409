            ...
            <div class="overflow-x-auto rounded-lg">
                ...
                <div class="flex flex-col items-center mt-4">
                    <div class="w-full flex items-center justify-center mb-2">
                        <img src="/Images/printcahrt.svg" alt="Illustration" class="w-1/2 md:w-1/4 h-auto">
                    </div>
                    <div class="w-full flex flex-col items-center justify-center">
                        <div class="mt-3 flex flex-col sm:flex-row gap-y-6 gap-x-4">
                            <div class="flex flex-row items-center justify-center gap-x-6">
                                <div class="flex items-center border border-gray-200 rounded dark:border-gray-700 w-full lg:w-72 p-4">
                                ...
                                <div class="flex items-center border border-gray-200 rounded dark:border-gray-700 w-full lg:w-72 p-4 mt-2 lg:mt-0">
                            ...
                            <div class="flex justify-center align-center flex-col sm:flex-row gap-x-4">
                                <div class="sm:flex-1">
