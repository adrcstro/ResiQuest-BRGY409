...
$query = "SELECT users.*, adminactivitylog.*
          FROM users INNER JOIN adminactivitylog";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  <div class="sm:flex-1">
  <label for="Adminidlog" class="block text-sm font-medium text-gray-700">AdminID</label>
  <input value="${adminidlogs}"  type="text" name="Adminidlog" id="Adminidlog" autocomplete="street-address" 
      class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
</div>
