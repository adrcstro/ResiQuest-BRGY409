...
<div>
        ...
        <div class="dropdown dropdown-end  *:relative ml-3">
         <div>
             <button type="button"  tabindex="0" role="button"
                     class="btn m-1 relative flex rounded-full"
    ...
    <li><a>Item 2</a></li>
             ...
             <a onclick="my_modal_3.showModal()" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                id="user-menu-item-0">Your Profile</a>
                <a href="AdminLogin.php" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
