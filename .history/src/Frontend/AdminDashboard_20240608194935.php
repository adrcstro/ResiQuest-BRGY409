...
function loadTablepagination(page) {
    ...
    // Construct the URL for residenttable.php relative to the current page's URL
    var url = currentUrl.substring(0, currentUrl.lastIndexOf('/')) + '../Backend/AdminTables/residenttable.php';
