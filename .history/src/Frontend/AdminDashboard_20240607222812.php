        ...
        <div class="flex-shrink-0 w-full">
            ...
            <script>
                ...
                var myChart = new Chart(ctx, {
                    ...
                    backgroundColor: 'rgba(75, 192, 192, 0.2)',borderColor: 'rgba(255, 255, 255, 1)',borderWidth: 1}]},
                    options: {responsive: true,maintainAspectRatio: false,scales: {
    ...
    <div class="flex items-center">
        <div class="flex-shrink-0 w-full">
            ...
            <script>
                ...
                var myChart = new Chart(ctx, {
                    type: 'bar',data: {labels: ['Verified', 'Not-Verified'],datasets: [{label: 'Residents Account Status',data: <?php echo json_encode($counts); ?>,
                    backgroundColor: 'rgba(75, 192, 192, 0.2)',borderColor: 'rgba(255, 255, 255, 1)',borderWidth: 1}]},
                    options: {responsive: true,maintainAspectRatio: false,
