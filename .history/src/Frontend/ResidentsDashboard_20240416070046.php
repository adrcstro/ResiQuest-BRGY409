  ...
  <div class="modal-box">
    <form id="passwordForm" method="post">
      ...
      <div class="mt-3 flex items-center justify-center">
        <button type="button" id="verifyButton" onclick="my_modal_3.showModal()" class="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-400 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm" onclick="verifyPassword()"> 
...
<dialog id="my_modal_3" class="modal">
  <div class="modal-box">
    ...
    <p class="py-4">Password is correct!</p>
  </div>
</dialog>
  ...
  xhr.onreadystatechange = function() {
    if (xhr.readyState === XMLHttpRequest.DONE) {
      if (xhr.status === 200) {
        ...
        if (response === 'success') {
          // Password is correct
          my_modal_3.showModal(); // Show Daisy UI modal dialog
        } else {
