...
if(mysqli_num_rows($result) > 0) {
   ...
   echo '<table class="min-w-full divide-y divide-gray-200 mt-3">
           <thead class="bg-gray-50">
               ...
               <th scope="col" class="p-4 border-2 border-inherit text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Residents Name</th>
               <th scope="col" class="p-4 border-2 border-inherit text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Verification Status</th>
               ...
               <th scope="col" class="p-4 border-2 border-inherit text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Civil Status</th>
               </tr>
           </thead>
           <tbody class="bg-white">';
   ...
   while($row = mysqli_fetch_assoc($result)) {
       ...
       echo '<td class="p-3 border border-inherit text-center  whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["CivilStatus"] . '</td>';
