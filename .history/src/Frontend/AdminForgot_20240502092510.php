...
<!-- login -------------------------------------------------------------------------------------------------------------->
    ...
    <div class="min-h-full m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        ...
        class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100  border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white pl-12"
            ...
            <option value="Barangay Chairman">Chairman</option>
            <option value="Barangay Kagawad">Kagawad</option>
            <option value="Barangay Secretary">Secretary</option>
            <option value="Barangay Treasurer">Treasurer</option>
            <option value="Barangay Tanod">Tanod</option>
        </select>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="-2" stroke="currentColor"  class="absolute left-4 top-1/2 transform -translate-y-1/2 h-6 w-6 text-gray-400"><path fill="currentColor" d="M20 6h3v2h-1v11h1v2H1v-2h1V8H1V6h3V4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1zm0 2H4v11h3v-7h2v7h2v-7h2v7h2v-7h2v7h3zM6 5v1h12V5z"/></svg>
    </div>
                                </div>
