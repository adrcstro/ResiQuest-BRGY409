  ...
  <div>
    <div class="relative">
      ...
      <div class="relative mx-16 lg:mx-20">
        <!-- text-->
        <div class="mt-12 flex flex-col pt-20 md:pt-52 justify-center items-center">
  <div class="text-center">
    <h2 class="text-white text-md sm:text-xl md:text-2xl lg:text-3xl font-extralight tracking-widest pt-5">
    ...
    <div class="flex justify-center mt-3">
      <button type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-md text-sm px-6 sm:px-8 md:px-12 py-2.5 text-center mb-2">
        Get Started
      </button>
    </div>
  </div>
