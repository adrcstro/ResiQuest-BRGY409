          ...
          <div class="bg-white shadow-2xl rounded-lg p-6 h-full">
             ...
             <form action="ResidentsDashboard.php" method="post"  class="mx-auto max-w-3xl mt-8">
               ...
               <div>
                ...
                <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                  <div class="sm:flex-1">
                      <label for="SSSGSISbrgyID" class="block text-sm font-semibold leading-6 text-gray-900 mt-3">Contact Number</label>
                        <div class="mt-2">
                            <input value="<?php echo $row["ContactNumber"]?>" required="" type="text" name="SSSGSISbrgyID" id="SSSGSISbrgyID" autocomplete="family-name"
                                placeholder="Ex. +63 ****-***-***"
                                class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                        </div>
                  </div>
                  ...
                  <div class="sm:flex-1">
                      <label for="DaterequestedbrgyID" class="block text-sm font-semibold leading-6 text-gray-900 mt-3">Date Filed</label>
                      <div class="mt-2">
                          <input required="" type="date" name="DaterequestedbrgyID" id="DaterequestedbrgyID" autocomplete="family-name"
                              placeholder="Select Date"
                              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
...
<div class="mb-2 mt-4 lg:mb-0 ">
  ...
  <div>
    <label for="ContactpersonNamebrgyID" class="block text-sm font-semibold leading-6 text-gray-900">Select Type of Complaint</label>
    <div class="mt-2.5">
        <select required name="ContactpersonNamebrgyID" id="ContactpersonNamebrgyID" 
...
<label for="comment" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">State Report Details Here</label>
