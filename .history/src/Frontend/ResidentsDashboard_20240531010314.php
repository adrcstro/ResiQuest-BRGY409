  ...
  <div class="modal-box w-full max-w-6xl rounded-none">
    ...
    <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
      ...
      <ul class="list-disc text-sm">
        ...
        <div class="col-span-4 sm:col-span-9">
            <div class="bg-white shadow-2xl rounded-lg p-6">
               ...
               <form action="ResidentsDashboard.php" method="post" class="mx-auto max-w-3xl mt-12">
                ...
                <div>
                <label for="PurposebrgyIndigency" class="block text-sm font-medium text-gray-700">Select your purpose:</label>
        <select required name="PurposebrgyIndigency" id="PurposebrgyIndigency" class="block w-full mt-1 rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
        ...
        <div id="otherPurposeDiv" class="hidden mt-4">
            <label for="otherPurpose" class="block text-sm font-medium text-gray-700">Please specify:</label>
            <input type="text" id="otherPurpose" name="otherPurpose" class="block w-full mt-1 rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
        </div>

        <button type="submit" class="mt-4 inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Submit</button>
    </form>

    <script>
        document.getElementById('PurposebrgyIndigency').addEventListener('change', function () {
        ...
        document.getElementById('purposeForm').addEventListener('submit', function (e) {
            ...
            const otherInputElement = document.getElementById('otherPurpose');

            if (selectElement.value === 'Other' && !otherInputElement.value.trim()) {
                e.preventDefault();
...
<input type="file" name="profofevidence" id="profofevidence" class="file-input file-input-bordered file-input-md w-full"/>
</div>
