...
if ($result->num_rows > 0) {
    ...
    foreach($messages as $senderID => $senderMessages) {
        ...
        echo "<p class='max-w-2xl text-sm text-gray-500 truncate'>Resident ID: " . htmlspecialchars($senderID) . "</p>";
        echo "<button class='mt-2 p-1 bg-blue-500 text-white rounded'>View Message</button>";
        // Iterate over each message for the current SenderID
