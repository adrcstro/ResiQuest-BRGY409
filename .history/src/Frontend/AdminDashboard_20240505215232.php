                   ...
                   <div class="bg-blue-400 shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                      <div class="flex items-center">
                         <div class="flex-shrink-0">
                            ...
                            <button class="btn btn-outline inline-flex justify-center rounded-md  shadow-sm mt-2 px-2 py-2 border-2 border-white hover:bg-blue-500 hover:border-white text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400  sm:w-auto sm:text-sm"> 
