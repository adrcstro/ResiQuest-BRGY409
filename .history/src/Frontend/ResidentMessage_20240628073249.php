...
<div  id="ResidentsMessage"  class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
  ...
  <form class="mt-12">
    ...
    <div class="flex items-center py-2 px-3 bg-gray-50 rounded-lg dark:bg-gray-700">
        ...
        <textarea id="chat" rows="5" class="block mx-4 p-1 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..."></textarea>
