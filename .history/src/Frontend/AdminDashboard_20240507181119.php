  ...
  openModalButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      ...
      <select required name="AdminEditresicivilstat" id="AdminEditresicivilstat" autocomplete="additional-name" 
          ...
          <option value="Single" <?php echo ($civilstatu === 'Single') ? 'selected' : ''; ?>>Single</option>
          <option value="Married" <?php echo ($civilstatu === 'Married') ? 'selected' : ''; ?>>Married</option>
          <option value="Divorced" <?php echo ($civilstatu === 'Divorced') ? 'selected' : ''; ?>>Divorced</option>
          <option value="Widowed" <?php echo ($civilstatu === 'Widowed') ? 'selected' : ''; ?>>Widowed</option>
      </select>
  </div>
