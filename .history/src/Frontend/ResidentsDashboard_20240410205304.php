...
<!-- Pesonal Profile -------------------------------------------------------------------------------------------------------------->
  ...
  <div class="absolute bottom-0 right-2 transform translate-x-1/3 -translate-y-1/3">
    <button onclick="openFileManager()" class="p-1 bg-gray-500 text-white rounded-full hover:bg-gray-700 focus:outline-none focus:bg-gray-700" title="Edit Profile">
