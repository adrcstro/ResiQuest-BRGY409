...
<script>
  function displaySelectedImage(event) {
    ...
    <option value="Purok 1"<?php if ($row["Gpurok"] == "Purok 1") echo " selected"; ?>>Purok Sunflower</option>
    <option value="Purok 2"<?php if ($row["Gpurok"] == "Purok 2") echo " selected"; ?>>Purok Rosal</option>
    <option value="Purok 3"<?php if ($row["Gpurok"] == "Purok 3") echo " selected"; ?>>Purok Dahlia</option>
    <option value="Purok 4"<?php if ($row["Gpurok"] == "Purok 4") echo " selected"; ?>>Purok Camia</option>
    <option value="Purok 5"<?php if ($row["Gpurok"] == "Purok 5") echo " selected"; ?>>Purok Gumamela</option>
    <option value="Purok 6"<?php if ($row["Gpurok"] == "Purok 6") echo " selected"; ?>>Purok Jasmin</option>
    <option value="Purok 7"<?php if ($row["Gpurok"] == "Purok 7") echo " selected"; ?>>Purok Sampaguita</option>
</select>
