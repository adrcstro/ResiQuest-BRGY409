...
$row = mysqli_fetch_assoc($result);
    ...
    $content = isset($_GET['content']) ? $_GET['content'] : 'main-content';
?>
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <div class="relative flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white pt-0">
             <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                <div class="flex-1 px-3 bg-white divide-y space-y-1">
                   ...
                   <li>
            <a href="AdminDashboard.php?content=main-content" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                <span class="ml-3">Dashboard</span>
            </a>
        </li>
        <li>
            <a href="AdminDashboard.php?content=ResidentRecord" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                <span class="ml-3">Resident Record</span>
            </a>
        </li>
        <li>
            <a href="AdminDashboard.php?content=showRequestedDocuments" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                <span class="ml-3">Requested Documents</span>
            </a>
        </li>
        <li>
            <a href="AdminDashboard.php?content=ManageBlotterReports" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                <span class="ml-3">Blotter Report</span>
            </a>
        </li>
        <li>
            <a href="AdminDashboard.php?content=showpublicNews" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                <span class="ml-3">Public News</span>
            </a>
        </li>
        <li>
            <a href="AdminDashboard.php?content=showBrgyOfficials" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                <span class="ml-3">Barangay Officials</span>
            </a>
        </li>
        <li>
            <a href="AdminDashboard.php?content=showMessage" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
    ...
    <div class="text-center lg:text-left">
        ...
        <span class="text-base font-normal text-gray-500">This is a list of Residents Complaint Report</span>
                            ...
                            <div class="flex-shrink-0">
                                ...
                                <div class="lg:flex lg:items-center lg:pl-32">
                     <button onclick="Blotter_Archive.showModal()" class="mt-3 w-full relative text-white border-2 border-gray-200  bg-green-400 dark:bg-gray-800 dark:border-gray-700 hover:bg-green-500  font-semibold py-2 px-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white"class="w-5 h-5 inline-block align-middle text-white">
