...
<dialog id="ViewComplain" class="modal p-3">
  ...
  <div class="flex flex-col mt-8">
    ...
    <div class="absolute top-0 left-0 flex items-center justify-center w-6 h-6 bg-red-400 rounded-full text-white text-xs"><?php echo $pendingCount; ?></div>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="gray" class="w-5 h-5 mr-2 inline-block align-middle text-white">
...
<li class="inline-flex items-center relative">
    <div class="absolute top-0 left-0 flex items-center justify-center w-6 h-6 bg-red-400 rounded-full text-white text-xs"><?php echo $onProcessCount; ?></div>
    <div class="flex items-center">
...
<li class="inline-flex items-center relative">
    <div class="absolute top-0 left-0 flex items-center justify-center w-6 h-6 bg-red-400 rounded-full text-white text-xs"><?php echo $onScheduleCount; ?></div>
    <div class="flex items-center">
        <svg class="rtl:rotate-180 block w-3 h-3 mx-1 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="gray" class="w-5 h-5 inline-block align-middle text-white">
            <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 .75 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-9-6h.008v.008H12v-.008ZM12 15h.008v.008H12V15Zm0 2.25h.008v.008H12v-.008ZM9.75 15h.008v.008H9.75V15Zm0 2.25h.008v.008H9.75v-.008ZM7.5 15h.008v.008H7.5V15Zm0 2.25h.008v.008H7.5v-.008Zm6.75-4.5h.008v.008h-.008v-.008Zm0 2.25h.008v.008h-.008V15Zm0 2.25h.008v.008h-.008v-.008Zm2.25-4.5h.008v.008H16.5v-.008Zm0 2.25h.008v.008H16.5V15Z" />
        </svg>
...
<li class="inline-flex items-center relative">
    <div class="absolute top-0 left-0 flex items-center justify-center w-6 h-6 bg-red-400 rounded-full text-white text-xs"><?php echo $settledCount; ?></div>
    <div class="flex items-center">
        <svg class="rtl:rotate-180 block w-3 h-3 mx-1 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
        </svg>
        ...
        <a href="#" data-status="Settled" class="status-link ms-1 text-sm font-medium focus:outline-none focus:text-blue-600 text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Complaint History</a>
    </div>
</li>
