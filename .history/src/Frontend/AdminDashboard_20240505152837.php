...
<body>
    <button onclick="showPendingrequest()" id="pendingBtn" class="filter-button bg-red-400 text-white font-bold py-2 px-4 rounded">
    ...
    <button onclick="showOnprocessrequest()" id="onProcessBtn" class="filter-button bg-yellow-400 text-white font-bold py-2 px-4 rounded">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
    ...
    <button onclick="showCompleterequest()" id="completeBtn" class="filter-button bg-green-400 text-white font-bold py-2 px-4 rounded">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
    ...
    <script>
        ...
        buttons.forEach(button => {
            button.addEventListener('click', () => {
                buttons.forEach(btn => {
                    btn.classList.remove('hover:bg-red-600', 'hover:bg-yellow-600', 'hover:bg-green-600');
                });
        ...
        function showPendingrequest() {
            // Add your logic here to show pending requests
        }

        function showOnprocessrequest() {
            // Add your logic here to show on-process requests
        }

        function showCompleterequest() {
            // Add your logic here to show completed requests
        }
    </script>
                            </div>
                        </div>
