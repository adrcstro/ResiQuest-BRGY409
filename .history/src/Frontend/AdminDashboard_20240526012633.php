        ...
        <span class="text-base font-normal text-gray-500">This is a list of Residents</span>
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <div
                                ...
                                <div class="lg:flex lg:items-center lg:pl-32">
                                <button
                                class="relative w-full text-gray-600 border-2 border-gray-200 focus:outline-none focus:bg-gray-100 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100  font-semibold py-2 px-4">
