        ...
        <div class="flex pt-52 justify-center">
          <div class="text-center">
            ...
            <div class="flex justify-center">
              <button class="border-2 border-white bg-transparent rounded-md text-xl lg:text-2xl xl:text-3xl mt-14  font-bold relative flex h-[80px] w-72 items-center justify-center overflow-hidden bg-gray-800 text-white transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-primary hover:scale-105 before:duration-500 before:ease-out hover:shadow-primary hover:before:h-56 hover:before:w-72">
