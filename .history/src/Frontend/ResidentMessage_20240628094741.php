...
<div  id="ResidentsMessage"  class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
  ...
  <form id="residentmessage" class="mt-12" onsubmit="displayValues(event)">
    ...
    <div class="relative ">
  <input value="../Backend/uploads/<?php echo $row["Profile"]; ?>" type="file" id="PRofileMEssagesender" name="PRofileMEssagesender" class="hidden" accept=".jpg, .png .jpeg .pdf, .doc, .docx">
