        ...
        <span class="text-base font-normal text-gray-500">This is a list of Residents Requested Documents</span>
                        ...
                        <div class="flex justify-center mb-4">
                            <div class="flex mt-4 lg:mt-3 space-x-2">
                                ...
                                <button onclick="showPendingrequest()" class="bg-gray-400 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">
                                ...
                                <button  onclick="showOnprocessrequest()"  class="bg-gray-400 hover:bg-yellow-600 text-gray-900 font-bold py-2 px-4 rounded">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
                                ...
                                <button  onclick="showCompleterequest()"  class="bg-gray-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
