...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<p class='text-xs text-gray-500 mb-2'>SVG, PNG, JPG, or GIF (MAX. 800x400px)</p>";
        echo "</div>";
        ...
        echo "<input value='" . htmlspecialchars($row["NewsTittle"]) . "' type='text' class='input input-bordered w-full' readonly />";
        echo "</div>";
        echo "<div class='flex gap-4'>";
        echo "<div>";
        echo "<label class='block text-sm font-semibold leading-6 text-gray-900'>News Date</label>";
        echo "<input value='" . htmlspecialchars($row["NewsDate"]) . "' type='date' class='input input-bordered w-full' disabled readonly />";
        echo "</div>";
        echo "<div>";
        echo "<label class='block text-sm font-semibold leading-6 text-gray-900'>News Time</label>";
        echo "<input value='" . htmlspecialchars($row["Newstime"]) . "' type='time' class='input input-bordered w-full' disabled readonly />";
        echo "</div>";
        echo "</div>";
        echo "<div>";
        echo "<span class='block text-sm font-semibold leading-6 text-gray-900'>News Content</span>";
        echo "<textarea class='textarea textarea-bordered w-full h-64 resize-none' readonly>" . htmlspecialchars($row["NewsContent"]) . "</textarea>";
        echo "</div>";
