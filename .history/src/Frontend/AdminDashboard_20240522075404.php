                ...
                <form action="../Backend/Insert.php" method="post" enctype="multipart/form-data">
                    <div class="mt-4 px-4 py-3 sm:px-6 flex align-items justify-between p-4 gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <textarea name="NewsContent" rows="6" class="rounded-lg border-gray-200 w-full pt-2 text-gray-900 border-1 h-full bg-white input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500 resize-none" placeholder="Enter News Content" required></textarea>
