...
<dialog id="EditResidentprofile" class="modal p-3">
  ...
  <div class="absolute bottom-0 right-2 ">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-6 h-6">
        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                           ...
                           <div class="bg-white shadow-2xl rounded-lg p-3 mt-4">
                             ...
                             <div>
                                   <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900 text-center">Submit Government ID</label>
                                   <div class="mt-2.5">
                                       <input required="" type="file" name="last-name" id="last-name" autocomplete="family-name"
                                           placeholder="Password"
                                           class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
    ...
    <div class="mt-2">
        <select required="" name="occupation" id="occupation" onchange="toggleOther(this);" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 flex-1">
        ...
        <input type="text" name="other_occupation" id="other_occupation" placeholder="Specify your occupation" class="hidden block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 flex-1">
    </div>
</div>
