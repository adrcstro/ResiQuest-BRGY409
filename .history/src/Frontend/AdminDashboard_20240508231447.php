      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        <h1 class="text-sm font-bold">Residents-ID: ${ID}</h1>
            ...
            <div class="hidden items-center justify-center mt-3">
                <input type="text" name="verificationstat" id="verificationstat" autocomplete="given-name" placeholder="Verification choice"
                    class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
            </div>
            ...
            <div class="flex flex-col sm:flex-row mt-3 space-y-2 sm:space-y-0 sm:space-x-4">
                <li onclick="markVerified()" class="btn btn-outline inline-flex justify-center bg-green-400 hover:bg-green-500 text-white hover:border-white rounded-md shadow-sm px-2 py-2 border-2 border-white text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm h-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 0 1-1.043 3.296 3.745 3.745 0 0 1-3.296 1.043A3.745 3.745 0 0 1 12 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 0 1-3.296-1.043 3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0 0 1 3 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 0 1 1.043-3.296 3.746 3.746 0 0 1 3.296-1.043A3.746 3.746 0 0 1 12 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.746 3.746 0 0 1 1.043 3.296A3.745 3.745 0 0 1 21 12Z" />
              </svg>
              
                    Mark as Verified Residents
                </li>
        
                <li onclick="markUnverified()" class="btn btn-outline inline-flex justify-center bg-red-400 hover:bg-red-500 text-white hover:border-white   rounded-md shadow-sm px-2 py-2 border-2 border-white text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm h-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
              </svg>
              
                    Mark as Unverified Residents
                </li>
            </div>
        </div>
...
function markVerified() {
    document.getElementById("verificationstat").value = "Verified";
}

function markUnverified() {
    document.getElementById("verificationstat").value = "NotVerified";
}
</script>';
...
<div id="showRequestedDocuments" style="display: none;" class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
    ...
    <div class="text-center lg:text-left">
       ...
       <ul tabindex="0"  class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
           <li class="view-request-btn" data-request-id="' . $row["RequestID"] . '" data-request-Sertype="' . $row["ServiceType"] . '"    ><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
           <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
           <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
         </svg>
          View Request</a></li>
 
           <li class="edit-request-btn"  data-request-id="' . $row["RequestID"] . '" data-request-Fname="' . $row["FirstName"] . '" data-request-Mname="' . $row["Middlename"] . '" data-request-Lname="' . $row["Lastname"] . '" data-request-Sertype="' . $row["ServiceType"] . '" data-request-DateRequested="' . $row["DateRequested"] . '" data-request-Address="' . $row["Address"] . '" data-request-DateofBirth="' . $row["DateofBirth"] . '"
           data-request-PlaceofBirth="' . $row["PlaceofBirth"] . '" data-request-Civilstat="' . $row["Civilstat"] . '"  data-request-SSSGSIS="' . $row["SSSGSIS"] . '" data-request-Contactname="' . $row["Contactname"] . '" data-request-Contactname="' . $row["Contactname"] . '" data-request-Contactaddress="' . $row["Contactaddress"] . '"  data-request-Contactnum="' . $row["Contactnum"] . '" 
