  ...
  if ($row["Status"] !== "Completed" && $row["Status"] !== "Released") {
    {
      ...
      <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
         ...
         View Details</a></li>
          <li class="open-modal-editrequest" data-request-id="' . $row["RequestID"] . '"><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
echo '<script>
  ...
  <div class="modal-box w-100 max-w-4xl rounded-none">
    ...
    <div class="mt-4 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
    <button id="close-modal-btn-edit" class="btn btn-sm btn-circle btn-ghost absolute top-2 right-2">
    ✕
  </button>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const modalContent = document.getElementById("modal-content-edit");
  const openModalButtons = document.querySelectorAll(".open-modal-editrequest");
  const closeModalButton = document.getElementById("close-modal-btn-edit");
