...
<div  id="showpublicNews"  style="display: none;" class="bg-white h-full  shadow rounded-lg p-4 sm:p-6 xl:p-8  xl:gap-4 my-4">
   <div class="pt-3 px-4">
      <div class="bg-white h-full  shadow rounded-lg p-4 sm:p-6 xl:p-8  xl:gap-4 my-4">
        ...
        <div class="flex flex-col mt-8">
           <div class="overflow-x-auto rounded-lg">
              <div class="align-middle inline-block min-w-full">
                ...
                <div class="overflow-x-auto h-screen"><table class="table-auto min-w-full divide-y divide-gray-200">
                       <thead class="bg-gray-50">
                          <tr>
