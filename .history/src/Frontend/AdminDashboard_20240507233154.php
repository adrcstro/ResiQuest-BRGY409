...
echo '<dialog id="Verifyresidents" class="modal p-3 ">
        <div class="modal-box w-70 max-w-3xl rounded-lg">
            ...
            <form id="Verifyresidentinfo" action="" method="post" enctype="multipart/form-data">
