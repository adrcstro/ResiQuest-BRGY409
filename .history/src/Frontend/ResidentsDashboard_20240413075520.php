...
<dialog id="EditResidentprofile" class="modal p-3">
  <div class="modal-box w-full max-w-6xl rounded-none">
    ...
    <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
      <div class="col-span-4 sm:col-span-3">
      <div class="bg-white shadow-2xl rounded-lg p-6 ">
      <form id="clear" action="ResidentsDashboard.php" method="post" autocomplete="off" class="sign-in-form" enctype="multipart/form-data">
                               <div class="flex flex-col items-center">
                                 
                               
                               <div class="relative">
  <input type="file" id="PRofile" name="PRofile" class="hidden" accept=".jpg, .jpeg, .png, .svg" onchange="displaySelectedImage(event)">
...
<script>
  function displaySelectedImage(event) {
    ...
    <div class="mt-2.5">
        <input required="" type="file" name="Government-ID" id="Government-ID" autocomplete="family-name"
            placeholder="Password"
            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
            multiple>
    </div>
        ...
        <select required id="civil-status" name="civil-status" autocomplete="family-name"
            ...
            <option value="Separated">Separated</option>
                                     ...
                                     <div>
                                         ...
                                         <div class="mt-2">
                                             <input value="<?php echo $row["Gender"]?>" required="" type="Gender" name="Gender" id="last-name" autocomplete="family-name"
                                                 placeholder="Select Gender"
                                                 class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                         </div>
                                     </div>
            ...
            <option value="Pending Registration">Pending Registration</option>
                                 ...
                                 <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                                    ...
                                    <div class="sm:flex-1">
                                        ...
                                        <div class="mt-2">
                                            <input value="<?php echo $row["ContactNumber"]?>"  required="" type="number" name="email" id="email" autocomplete="email"
                                                placeholder="Your Contact Number"
                                                class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 flex-1">
                                        </div>
                                    </div>
