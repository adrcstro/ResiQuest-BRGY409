  ...
  <ul class="flex items-center flex-wrap mb-6 md:mb-0">
    <li class="flex items-center mr-4 md:mr-6">
      <svg class="w-5 h-5 text-gray-500 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m2 4h-1m4-4h-4v4h4v4h-4v4h4m4-16h4m0 0H4m0 0H4m0 0H4m0 0H4M4 12H3.5M4 8H3.5M4 16H3.5" />
      </svg>
      <a href="#" class="text-sm font-normal text-gray-500 hover:underline">Terms and conditions</a>
    </li>
    <li class="flex items-center mr-4 md:mr-6">
      <svg class="w-5 h-5 text-gray-500 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12h18m-6 8l6-6-6-6m-6 0l-6 6 6 6" />
      </svg>
      <a href="#" class="text-sm font-normal text-gray-500 hover:underline">Privacy Policy</a>
    </li>
    <li class="flex items-center mr-4 md:mr-6">
      <svg class="w-5 h-5 text-gray-500 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v4a2 2 0 01-2 2h-2m-4 0h-4m-4 0H5a2 2 0 01-2-2v-4a2 2 0 012-2h2m0 8V8m0 8h4m-4 0v-8m4 8v-8" />
      </svg>
      <a href="#" class="text-sm font-normal text-gray-500 hover:underline">Facebook Page</a>
    </li>
  </ul>
</footer>
