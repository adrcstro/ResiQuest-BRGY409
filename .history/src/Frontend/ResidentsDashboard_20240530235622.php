...
<div class="items-center justify-center mt-3 w-full">
<label for="complainreportdetails" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Submit Prof of Evidence</label>
<input type="file" class="file-input file-input-primary focus:border-blue border-2 border-solid w-full" />
</div>
