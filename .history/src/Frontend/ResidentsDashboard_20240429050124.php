...
echo '<script>
  ...
  <div class="modal-box w-100 max-w-4xl rounded-none">
    ...
    <div id="modal-content-edit" class="mt-8 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row"></div>
        ...
        button.addEventListener("click", function () {
            ...
            switch (serviceType) {
                ...
                case "Certificate of Indigency":
                    inputsHtml = "<input type=\"text\" name=\"FirstName\" placeholder=\"First Name\" />" +
