...
<div id="Allresidenttbl"> 
    <?php 
    // Set a flag to indicate a direct include request
    $_SESSION['direct_include'] = true;
    include '../Backend/AdminTables/residenttable.php'; 
    ?>
</div>
...
function loadTablepagination(page) {
    $.ajax({
        url: '../Backend/AdminTables/residettable.php',
        type: 'POST',
