...
<dialog id="ViewGovernmentID" class="modal">
  <div class="modal-box w-full max-w-5xl rounded-none">
    <form method="dialog">
      <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" onclick="closeCustomModal()">✕</button>
    </form>
    

    <img src="../Backend/uploads/<?php echo $row["GovernmentID"]; ?>" class="w-32 h-32 bg-gray-300 rounded-none mb-4" alt="Profile Picture">
