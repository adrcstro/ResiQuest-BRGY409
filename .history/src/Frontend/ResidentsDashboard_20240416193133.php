...
<script>
  ...
  if (file) {
    ...
    <div class="mt-2.5">
        <input required type="file" name="Government-ID-1" id="Government-ID-1" accept=".jpg, .png, .jpeg, .pdf, .doc, .docx" autocomplete="family-name"
            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
        <input required type="file" name="Government-ID-2" id="Government-ID-2" accept=".jpg, .png, .jpeg, .pdf, .doc, .docx" autocomplete="family-name"
            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
    </div>
</div>
