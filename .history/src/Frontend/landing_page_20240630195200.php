...
<div class="bg-secondary">
  ...
  <div>
    <div class="relative">
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="hidden  items-center justify-center w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex md:items-center flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-transparent md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent">
              ...
              <li>
                <a href="services.html" class="block py-2 px-3 text-slate-600 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 hover:text-primary md:p-0">News & Updates</a>
              </li>


              <li>
                <a href="services.html" class="block py-2 px-3 text-slate-600 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 hover:text-primary md:p-0">About Us</a>
              </li>

              <li>
                <a href="services.html" class="block py-2 px-3 text-slate-600 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 hover:text-primary md:p-0">FAQs</a>
              </li>
      ...
      <!-- hero -->
      <div class="relative mx-4 sm:mx-8 md:mx-12 lg:mx-16 xl:mx-20">
    <!-- text-->
    <div class="mt-12 flex pt-32 sm:pt-40 md:pt-48 lg:pt-52 justify-center">
        <div class="text-center">
            <h2 class="text-white text-lg sm:text-xl lg:text-2xl xl:text-3xl font-extralight tracking-widest pt-5">Welcome to Barangay-409</h2>
            <h1 class="text-white text-4xl sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl font-bold pt-3 pb-5">Document Request and Blotter Report Management System</h1>
            <div class="flex justify-center mt-8">
                <button type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-md text-sm px-6 sm:px-8 md:px-10 lg:px-12 py-2.5 text-center me-2 mb-2">Get Started</button>
            </div>
        </div>
    </div>
    <!-- card row -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-auto mt-20 sm:mt-30 md:mt-40 px-4 sm:px-8 md:px-12 lg:px-20">
        <!-- card container -->
        <div class="card-container bg-gray-800 rounded-lg shadow-lg p-6">
            <div class="flex justify-center min-h-32 min-w-32">
                <img class="h-32 w-32 sm:h-36 sm:w-36 md:h-40 md:w-40" src="/Images/News.svg" alt="vector1" />
            </div>
            <div class="flex items-start justify-between space-x-3 mt-4">
                <div class="w-full text-center space-y-3">
                    <h5 class="text-xl sm:text-2xl font-semibold">News & Announcements</h5>
        ...
        <div class="card-container bg-gray-800 rounded-lg shadow-lg p-6">
            <div class="flex justify-center min-h-32 min-w-32">
                <img class="h-32 w-32 sm:h-36 sm:w-36 md:h-40 md:w-40" src="/Images/Documents.svg" alt="vector2" />
            </div>
            <div class="flex items-start justify-between space-x-3 mt-4">
                <div class="w-full text-center space-y-3">
                    <h5 class="text-xl sm:text-2xl font-semibold">Document Issuance</h5>
        ...
        <div class="card-container bg-gray-800 rounded-lg shadow-lg p-6">
            <div class="flex justify-center min-h-32 min-w-32">
                <img class="h-32 w-32 sm:h-36 sm:w-36 md:h-40 md:w-40" src="/Images/New team members.svg" alt="vector3" />
            </div>
            <div class="flex items-start justify-between space-x-3 mt-4">
                <div class="w-full text-center space-y-3">
                    <h5 class="text-xl sm:text-2xl font-semibold">Barangay Officials</h5>
    ...
    <section class="bg-white w-full mt-32 pt-10 lg:mt-32 z-50 px-4 md:px-10" id="services">
...
<section class=" lg:mt-48 z-50" id="news">
...
?>
  ...
  <section class="mt-32 lg:mt-32 z-50 pt-10">
  ...
  <section class="pt-10 lg:mt-32 bg-white z-50" id="FAQ">
    <span class="pl-3 border-l-8 mx-10 md:mx-40 border-primary flex flex-col">
      <h1 class= "text-black text-5xl font-semibold mb-2">
        Barangay <b>FAQ's</b>
      </h1>
