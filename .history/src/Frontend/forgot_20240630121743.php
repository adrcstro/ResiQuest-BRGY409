...
<!-- login -------------------------------------------------------------------------------------------------------------->
        ...
        <div class="relative flex-1 text-center hidden lg:flex">
            ...
            <div class="mt-8 absolute top-0 left-1/2 transform -translate-x-1/2 text-white">
                ...
                <div class="grid grid-cols-2 grid-rows-2 gap-9 mt-16">
                    <!-- Illustration 1 -->
                    <div class="bg-white p-4 rounded-lg shadow-2xl flex flex-col items-first">
    ...
    <h2 class="text-lg font-semibold text-gray-600">Used Strong Passsword</h2>
    ...
    <h2 class="text-lg font-semibold text-gray-600">Confirm Password</h2>
