            ...
            <form id="residentmessage" class="mt-12" onsubmit="displayValues(event)">
                ...
                <div class="flex items-center py-2 px-3 bg-gray-50 rounded-lg dark:bg-gray-700">
                    ...
                    <div class="mt-2.5 hidden">
                        <input value="<?php echo $row['ID']; ?>" required="" type="text" name="ResidentIDMessage" id="ResidentIDMessage" autocomplete="given-name" placeholder="ResidentIDMessage" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                    </div>
                    <div class="mt-2.5 hidden">
                    ...
                    <div class="image-input">
                        <img src="<?php echo htmlspecialchars($row['profile_image_path']); ?>" alt="Profile Image" style="max-width: 100px; max-height: 100px;">
                    </div>
                    <?php endif; ?>
