...
while($row = mysqli_fetch_assoc($result)) {
  ...
  echo "<td><img src='../Backend/uploads/" . $row["NewsImages"] . "' alt='News Image' style='width: 70%; height: auto;' class='p-3 border border-inherit text-center  whitespace-nowrap text-sm font-semibold text-gray-900'></td>";
