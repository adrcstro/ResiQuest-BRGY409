...
<label for="PRofile" class="absolute bottom-0 right-0 p-2 bg-white text-black rounded-full hover:bg-gray-400 focus:outline-none focus:bg-gray-400 cursor-pointer border-4 " title="Edit Profile">
