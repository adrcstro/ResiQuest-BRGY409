                  ...
                  echo '</tr>';
                    ...
                    echo '<script>
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                          ...
                          <h1 class="text-xl font-bold">${fname}, ${mname} ${lname}</h1>
                          <h1 class="text-sm font-bold"><span style="font-weight: normal;">Request-ID:</span> ${ID}</h1>
                          <h1 class="text-sm font-bold"><span style="font-weight: normal;">Service-Type:</span> ${servietype}</h1>
                              <div class="hidden items-center justify-center mt-3">
