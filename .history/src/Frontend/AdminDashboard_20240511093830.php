                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                          ...
                          openModalButtons.forEach(function (button) {
                            button.addEventListener("click", function () {
                              ...
                              <h1 class="text-xl font-bold">${fname}, ${mname} ${lname}</h1>
                              <h1 class="text-sm font-bold"><label for="request-id class="font-semibold"  ">Request-ID:</label> ${ID}</h1>
                              <h1 class="text-sm font-bold"><label for="service-type">Service-Type:</label> ${servietype}</h1>
