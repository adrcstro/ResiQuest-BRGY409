                  ...
                  echo '</tr>';
                    ...
                    echo '<script>
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                          ...
                          <h1 class="text-xl font-bold">${fname}, ${mname} ${lname}</h1>
                          <div class="flex flex-col">
    <h1 class="text-sm font-bold flex items-start"><span class="font-normal">Request-ID:</span> ${ID}</h1>
    <h1 class="text-sm font-bold flex items-start"><span class="font-normal">Service-Type:</span> ${servietype}</h1>
</div>
