...
<div  id="ResidentsMessage"  class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
  ...
  <form id="residentmessage" class="mt-12" onsubmit="displayValues(event)">
    ...
    <?php if(isset($row["Profile"])): ?>
        <img src="../Backend/uploads/<?php echo $row["Profile"]; ?>" alt="Profile Image" />
    <?php endif; ?>
    <input type="text" id="PRofileMEssagesender" name="PRofileMEssagesender" accept=".jpg, .png, .jpeg, .pdf, .doc, .docx">
</div>
