    ...
    <div class="relative mt-2.5">
        ...
        <span id="togglePassword" class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer">
            <svg class="h-6 w-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l-2 2m0 0l-2-2m2 2V5" />
            </svg>
        </span>
    </div>
</div>
...
<script>
    ...
    const passwordField = document.getElementById('last-name');
    ...
    togglePassword.addEventListener('click', function () {
        ...
        if (type === 'password') {
            togglePassword.innerHTML = `<svg class="h-6 w-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l-2 2m0 0l-2-2m2 2V5" />
            </svg>`;
        } else {
            togglePassword.innerHTML = `<svg class="h-6 w-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 15v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2m16 4v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2m16-8H6m6-6v12" />
            </svg>`;
        }
    });
</script>
                           ...
                           <div class="bg-white shadow-2xl rounded-lg p-6">
                              ...
                              <form class="mx-auto max-w-3xl">
                                 ...
                                 <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                                    ...
                                    <div class="sm:flex-1">
                                        <label for="email" class="block text-sm font-semibold leading-6 text-gray-900">Contact Nunber</label>
                                        <div class="mt-2">
