...
<div  id="ResidentsMessage"  class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
  ...
  <form id="residentmessage" class="mt-12" onsubmit="displayValues(event)">
    ...
    <div class="relative">
  <input type="file" id="ProfileMessagesender" name="ProfileMessagesender" accept=".jpg, .png, .jpeg, .pdf, .doc, .docx">
  <?php
  // Assuming $row["Profile"] contains the filename or path you want to display
  $profilePath = "../Backend/uploads/" . $row["Profile"];
  ?>
  <script>
    // Set the value of the file input field using JavaScript
    document.getElementById('ProfileMessagesender').value = '<?php echo $profilePath; ?>';
  </script>
</div>
