...
<script>
   $(document).ready(function(){
    $("#submitbrgyResidency").click(function(){
        ...
        var PurposebrgyResidency = $("input[name='PurposebrgyResidency']").val();
        var ServicetypebrgyResidency = $("input[name='ServicetypebrgyResidency']").val();

        console.log("Data:", firstnamebrgyResidency, MnamebrgyResidency, lastnamebrgyResidency, DaterequestedbrgyResidency, AddressdbrgyResidency, PurposebrgyResidency, ServicetypebrgyResidency); // Debugging
        ...
        function(data, status){
            console.log("Response:", data, status); // Debugging
            Swal.fire({
                title: 'Success!',
