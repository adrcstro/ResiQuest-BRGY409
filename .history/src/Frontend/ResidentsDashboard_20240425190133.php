...
while($row = mysqli_fetch_assoc($result)) {
  echo '<tr>';
  echo '<td class="p-4 whitespace-nowrap text-sm font-normal text-gray-900">' . (isset($row["RequestID"]) ? $row["RequestID"] : '') . '</td>';
  echo '<td class="p-4 whitespace-nowrap text-sm font-normal text-gray-900">' . (isset($row["ServiceType"]) ? $row["ServiceType"] : '') . '</td>';
  echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">' . (isset($row["DateRequested"]) ? $row["DateRequested"] : '') . '</td>';
  echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">' . (isset($row["Status"]) ? $row["Status"] : '') . '</td>';
  echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">' . (isset($row["PickUpDate"]) ? $row["PickUpDate"] : '') . '</td>';
