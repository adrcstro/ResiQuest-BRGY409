...
while($row = mysqli_fetch_assoc($result)) {
  ...
  if ($row["Status"] !== "Completed") {
      ...
      echo '<td class="p-1 text-center whitespace-nowrap text-sm font-semibold text-gray-900 ' . $statusBgColor . '">';
      echo '<span class="p-0.5 inline-block ' . $statusBgColor . '">' . $row["Status"] . '</span>';
      echo '</td>';
