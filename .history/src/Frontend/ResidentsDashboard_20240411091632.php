...
<div class="flex items-center">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="text-yellow-300" class="w-6 h-6 text-yellow-300">
 ...
 <h3 class="text-lg font-semibold mb-2">Submmiting Government ID</h3>
              ...
              <ul class="list-disc ml-6 mb-4">
                <li>Only these Government ID's we will accept (Barangay ID, Philhealth ID, National ID, Drivers License, Postal ID) if you dont have thse ID's </li>
