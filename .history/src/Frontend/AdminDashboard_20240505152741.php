...
<div id="showRequestedDocuments" style="display: none;" class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
    ...
    function showCompleterequest() {
        // Add your logic here to show completed requests
                                ...
                                <button onclick="showPendingrequest()" class="bg-red-400 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">
                                ...
                                <button onclick="showOnprocessrequest()"  class="bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
                                ...
                                <button onclick="showCompleterequest()"  class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
