...
document.addEventListener("DOMContentLoaded", function () {
  ...
  closeModalButton.addEventListener("click", function () {
    ...
    <ol class="inline-flex items-end space-x-8 md:space-x-6 rtl:space-x-reverse">
        ...
        <li>
            <div class="flex items-center">
                <svg class=" space-x-8 rtl:rotate-180 block w-3 h-3 text-gray-400 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4" />
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="rtl:rotate-180 block w-6 h-6 text-gray-400">
