...
document.addEventListener("DOMContentLoaded", function () {
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
    ...
    <dialog id="Schedulerequest" class="modal p-3 ">
        <div class="modal-box w-70 max-w-3xl rounded-lg">
    ...
    $(document).ready(function() {
        // Fetch the content from Scheduleoverduerequest.php
        $('#tableContainer').load('../Backend/Scheduleoverduerequest.php', function() {
            // Reinitialize modal triggers after loading new content
            $('.Schedule-resident-pickup').on('click', function() {
                $('#Schedulerequest').show();
            });
            ...
            $(window).on('click', function(event) {
                if (event.target.id == 'Schedulerequest') {
                    $('#Schedulerequest').hide();
                }
            });
        });
    });
