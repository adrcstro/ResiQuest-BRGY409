                   ...
                   <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                       <div class="col-span-4 sm:col-span-3">
                           ...
                           <div class="bg-white shadow-2xl rounded-lg p-6 ">
                               ...
                               <div class="relative">
    <?php if(isset($row["Profile"]) && !empty($row["Profile"])): ?>
        <img src="../Backend/uploads/<?php echo $row["Profile"]; ?>" class="w-32 h-32 bg-gray-300 rounded-full mb-4" alt="Profile Picture">
    <?php else: ?>
        <img src="/Images/blank.png" class="w-32 h-32 bg-gray-300 rounded-full mb-4" alt="Default Profile Picture">
    <?php endif; ?>
    ...
    <div class="absolute bottom-0 right-2">
        <!-- Additional content here -->
                              ...
                              <div class="mt-4">
                                ...
                                <progress class="progress progress-success w-50" value="60" max="100"></progress>
                           ...
                           <div class="bg-white shadow-2xl rounded-lg p-3 mt-4">
                             
                          
                           <div>
                                 <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900 text-center">Submitted Government ID</label>
                                 <div class="mt-2.5">
                                     <input required="" type="file" name="last-name" id="last-name" autocomplete="family-name"
                                         placeholder="Password"
                                         class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                 </div>
                             </div>
...
<dialog id="EditResidentprofile" class="modal p-3">
  ...
  <div class="relative">
    <?php if(isset($row["Profile"]) && !empty($row["Profile"])): ?>
        <img id="profilePicture" src="../Backend/uploads/<?php echo $row["Profile"]; ?>" class="w-32 h-32 bg-gray-300 rounded-full mb-4" alt="Profile Picture">
    <?php else: ?>
  ...
  <label for="PRofile" class="absolute bottom-0 right-0 p-2 bg-gray-200 text-black rounded-lg hover:bg-gray-400 focus:outline-none focus:bg-gray-400 cursor-pointer" title="Edit Profile">
  ...
  function displaySelectedImage(event) {
    ...
    if (file) {
      ...
      reader.readAsDataURL(file);
                              ...
                              <div class="mt-4">
                                <div>
                                  <h2 class="text-sm text-gray-400 text-center">Profile Veification Progress</h2>
                                </div>
                                <progress class="progress progress-success w-50" value="60" max="100"></progress>
                           ...
                           <div>
    <label for="Government-ID" class="block text-sm font-semibold leading-6 text-gray-900 text-center">Submit Government ID</label>
    <div class="mt-2.5">
        <input required="" type="file" name="Government-ID" id="Government-ID" accept=".jpg, .png .jpeg .pdf, .doc, .docx" autocomplete="family-name"
            placeholder="Password"
            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
            multiple>
    </div>
          ...
          <div class="mx-auto max-w-3xl">
                                 <div class="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-4">
                                     ...
                                     <div>
                                         ...
                                         <div class="mt-2.5">
                                             <input  value="<?php echo $row["Age"]?>" required="" type="text" name="Age" id="Age" autocomplete="given-name"
                                                 placeholder="Enter Age"
                                                 class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                         </div>
                                     </div>
    ...
    <div class="mt-2.5">
    <select required id="civil-status" name="civil-status" autocomplete="family-name"
    class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
    ...
    <option value="Purok Sunflower"<?php if ($row["Purok"] == "Purok Sunflower") echo " selected"; ?>>Purok Sunflower</option>
    <option value="Purok Rosal"<?php if ($row["Purok"] == "Purok Rosal") echo " selected"; ?>>Purok Rosal</option>
    <option value="Purok Dahlia"<?php if ($row["Purok"] == "Purok Dahlia") echo " selected"; ?>>Purok Dahlia</option>
    <option value="Purok Camia"<?php if ($row["Purok"] == "Purok Camia") echo " selected"; ?>>Purok Camia</option>
    <option value="Purok Gumamela"<?php if ($row["Purok"] == "Purok Gumamela") echo " selected"; ?>>Purok Gumamela</option>
    <option value="Purok Jasmin"<?php if ($row["Purok"] == "Purok Jasmin") echo " selected"; ?>>Purok Jasmin</option>
    <option value="Purok Sampaguita"<?php if ($row["Purok"] == "Purok Sampaguita") echo " selected"; ?>>Purok Sampaguita</option>
</select>
    ...
    <option value="Registered"<?php if ($row["VoterStatus"] == "Registered") echo " selected"; ?>>Registered</option>
    <option value="Not Registered"<?php if ($row["VoterStatus"] == "Not Registered") echo " selected"; ?>>Not Registered</option>
    <option value="Pending Registration"<?php if ($row["VoterStatus"] == "Pending Registration") echo " selected"; ?>>Pending Registration</option>
</select>
                                 ...
                                 <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                                    ...
                                    <div class="sm:flex-1">
                                        ...
                                        <div class="mt-2">
                                            <input required="" type="text" name="Occupation" id="Occupation" autocomplete="Occupation"
                                ...
                                <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                                 ...
                                 <div class="sm:flex-1">
                                     ...
                                     <div class="mt-2">
                                         <input required="" type="number" name="Zip-Code" id="Zip-Code" autocomplete="Zip-Code"
                             ...
                             <div class="mt-3">
                              ...
                              <div class="mt-2">
                                  <input value="Filipino" required="" type="text" name="Citizenship" id="Citizenship" autocomplete="Citizenship"
                                      placeholder="Select Citizenship"
                                      class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                              </div>
                          </div>
...
<div class="flex items-center">
 ...
 <h3 class="text-lg font-semibold mb-2">Submmision of Government ID</h3>
              ...
              <ul class="list-disc ml-6 mb-4">
                <li>Only these Government ID's we will accept (Barangay ID, Philhealth ID, National ID, Drivers License, Postal ID) if you dont have these ID's you can submit your PSA/Birt Certificate and make sure it is a scanned Copy</li>
...
<div class="px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row mt-3">
  <button id="SubmitInfotoVerify"  type="submit" class=" inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-400 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400  sm:w-auto sm:text-sm"> 
...
<script>
  $(document).ready(function() {
    $("#SubmitInfotoVerify").click(function(e) {
      ...
      var PRofile = $("input[name='PRofile']").prop('files')[0];
      var GovernmentID = $("input[name='Government-ID']").prop('files')[0];
      ...
      formData.append('Nick-name', Nickname);
      formData.append('PlaceofBirth', PlaceofBirth);
      formData.append('Birthdate',Birthdate);
      formData.append('Age', Age);
      formData.append('civil-status', civilstatus);
      formData.append('Gender', Gender);
      formData.append('purok', purok);
      formData.append('voter-status',voterstatus);
      ...
      formData.append('Government-ID', GovernmentID);


      $.ajax({
        url: "../Backend/Update.php", // Replace with the actual file name for update
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
        success: function(data) {
          Swal.fire({
            title: 'Application for Verification Submmitted Successfully',
            icon: 'success',
   ...
   <div  id="ResidentsDocumentsRequested"  style="display: none;" class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
      <div class="pt-3 px-4">
         <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  xl:gap-4 my-4">
              ...
              <div class="flex flex-wrap justify-center gap-y-0 gap-x-0 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-4 items-start">

               <div class="bg-white py-8 px-10 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2">
               ...
               <div class="bg-white py-8 px-10 text-center rounded-md shadow-2xl  transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2">
                 <h2 class="font-semibold text-xl mb-3">Certificate of Indigency</h2>
                 <div class="flex items-center justify-center">
               ...
               <div class="bg-white py-8 px-10 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2">
                 <h2 class="font-semibold text-xl mb-3">Barangay ID</h2>
                 <div class="flex items-center justify-center">
...
<dialog id="Businesspermit" class="modal p-3">
  <div class="modal-box w-full max-w-6xl rounded-none">
    ...
    <div class="bg-blue-500 shadow-2xl rounded-md p-6 mb-3 ">
        <div class="mb-2 lg:mb-0">
            <h3 class="text-2xl font-bold text-white text-center">BRGY-409 Document Request Management System</h3>
            <span class="flex text-base font-medium text-white justify-center text-center">Request for Business Permit Document</span>
        </div>
    </div>
          ...
          <div class="bg-white shadow-2xl rounded-lg p-6 h-full">
              <div class="flex flex-col items-center">
                <svg class="w-25 h-25  p-1 " fill="none" viewBox="0 0 24 24" s className="w-6 h-6" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg"  version="1.1" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">
                  ...
                  <h1 class="text-sm font-bold">Business Permit</h1>
    ...
    <ul class="list-disc text-sm">
      ...
      <div class="col-span-4 sm:col-span-9">
          <div class="bg-white shadow-2xl rounded-lg p-6">
             ...
             <form class="mx-auto max-w-3xl mt-4">

            
                  <div>
                      <label for="first-name" class="block text-sm font-semibold leading-6 text-gray-900">Business / Trade Activity</label>
                      <div class="mt-2.5">
                          <input required="" type="text" name="first-name" id="first-name" autocomplete="given-name"
                              placeholder="Enter Business / Trade Activity"
                  ...
                  <div>
                      <label for="last-name" class="mt-2 block text-sm font-semibold leading-6 text-gray-900">Location</label>
                      <div class="mt-2.5">
                  ...
                  <div>
                      <label for="last-name" class="mt-2 block text-sm font-semibold leading-6 text-gray-900">Business Operator/Manager</label>
                      <div class="mt-2">
                          <input required="" type="text" name="last-name" id="last-name" autocomplete="family-name"
                              placeholder="Enter Business Operator/Manager"
                              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm sm:leading-6">
                      </div>
                  </div>
                  ...
                  <div class="flex flex-col sm:flex-row gap-x-6">
                      <div class="sm:flex-1">
                          <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900 mt-3">Date Requested</label>
                            <div class="mt-2">
                                <input required="" type="date" name="last-name" id="last-name" autocomplete="family-name"
                                    placeholder="Select Birthdate"
                                    class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                            </div>
                      </div>
                      <div class="sm:flex-1">
                          <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900 mt-3">Address</label>
                          <div class="mt-2.5">
                              <input required="" type="text" name="last-name" id="last-name" autocomplete="family-name"
...
<div class=" mt-8 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
  <button  type="button" class=" inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-500 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400  sm:w-auto sm:text-sm"> 
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
      </svg>
    Submit Request 
      ...
      <ul class="list-disc text-sm">
        ...
        <div class="col-span-4 sm:col-span-9">
            <div class="bg-white shadow-2xl rounded-lg p-6">
               ...
               <form class="mx-auto max-w-3xl mt-12">
                ...
                <div class="flex justify-end space-x-2 mt-8 mb-8">
                    <button class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 mt-3 rounded">
                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
    ...
    <ul class="list-disc text-sm">
      ...
      <div class="col-span-4 sm:col-span-9">
          <div class="bg-white shadow-2xl rounded-lg p-6">
             ...
             <form class="mx-auto max-w-3xl mt-8">
               ...
               <div class="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-3">
                  ...
                  <div>
                    <label for="first-name" class="block text-sm font-semibold leading-6 text-gray-900">Date of Birth</label>
                    <div class="mt-2.5">
                        <input required="" type="date" name="first-name" id="first-name" autocomplete="given-name"
                            placeholder="Enter Your First Name"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div>
                    <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900">Status</label>
                    <div class="mt-2.5">
                        <input required="" type="text" name="last-name" id="last-name" autocomplete="family-name"
                ...
                <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                  <div class="sm:flex-1">
                      <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900 mt-3">SSS/GSIS</label>
                        <div class="mt-2">
                            <input required="" type="text" name="last-name" id="last-name" autocomplete="family-name"
...
<div class="mb-2 lg:mb-0 ">
  ...
  <div class="mt-4 grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-3">
    ...
    <div>
        <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900">Contact Number</label>
        <div class="mt-2">
            <input required="" type="text" name="last-name" id="last-name" autocomplete="family-name"
