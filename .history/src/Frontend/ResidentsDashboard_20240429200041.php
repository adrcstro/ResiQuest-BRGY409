  ...
  if ($row["Status"] !== "Completed" && $row["Status"] !== "Released") {
    {
      ...
      <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
         ...
         View Details</a></li>
          ...
          <li class="edit-request-btn" data-request-id="' . $row["RequestID"] . '" data-service-type="' . $row["ServiceType"] . '" data-First-name="' . $row["FirstName"] . '"   data-Middle-name="' . $row["Middlename"] . '"  ><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    openModalButtons.forEach(function (button) {
        button.addEventListener("click", function () {
            ...
            <div class=" gap-y-6 gap-x-6">
                <div class="font-semibold mb-4 mt-8" >
