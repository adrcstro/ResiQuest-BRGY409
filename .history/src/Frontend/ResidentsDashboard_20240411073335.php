...
<!-- Pesonal Profile -------------------------------------------------------------------------------------------------------------->
  ...
  <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='w-32 h-32 bg-gray-300 rounded-full mb-4'%3E%3Cpath d='M12 2C6.48 2 2 6.48 2 12c0 3.09 1.64 5.93 4.31 7.49-1.55 1.4-2.42 3.37-2.42 5.51 0 .33.03.66.08.98C2.93 23.4 6.3 25 10 25c3.68 0 7.05-1.6 9.34-4.14.05-.32.08-.65.08-.98 0-2.14-.87-4.11-2.42-5.51C20.36 17.93 22 15.09 22 12c0-5.52-4.48-10-10-10zM12 6c2.21 0 4 2.24 4 5s-1.79 5-4 5-4-2.24-4-5 1.79-5 4-5zM12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8z'%3E%3C/path%3E%3C/svg%3E" class="w-32 h-32 bg-gray-300 rounded-full mb-4" alt="Hero Person Icon">
