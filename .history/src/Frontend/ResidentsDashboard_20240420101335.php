    ...
    <div class="col-span-4 sm:col-span-9">
        <div class="bg-white shadow-2xl rounded-lg p-6">
           ...
           <form action="ResidentsDashboard.php" method="post" enctype="multipart/form-data" class="mx-auto max-w-3xl mt-12">
            ...
            <div>
                    <label for="lastnamebrgyResidency" class="block text-sm font-semibold leading-6 text-gray-900 mt-4">State your Purpose for Requesting Certificate of Residency</label>
                    <div class="mt-2">
