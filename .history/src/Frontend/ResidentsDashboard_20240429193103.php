  ...
  if ($row["Status"] !== "Completed" && $row["Status"] !== "Released") {
    {
      ...
      <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
         ...
         View Details</a></li>
          ...
          <li class="edit-request-btn" data-request-id="' . $row["RequestID"] . '" data-service-type="' . $row["ServiceType"] . '" ><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
