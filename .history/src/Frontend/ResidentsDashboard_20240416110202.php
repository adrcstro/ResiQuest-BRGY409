...
<button id="SubmitInfotoVerify" type="button" class="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-400 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    </svg>
    Save Profile
...
$(document).ready(function() {
    $("#SubmitInfotoVerify").click(function(e) {
        ...
        formData.append('ResidentID', $("input[name='ResidentID']").val());
        formData.append('first-name', $("input[name='first-name']").val());
        formData.append('Middle-name', $("input[name='Middle-name']").val());
        formData.append('last-name', $("input[name='last-name']").val());
        formData.append('Nick-name', $("input[name='Nick-name']").val());
        formData.append('PlaceofBirth', $("input[name='PlaceofBirth']").val());
        ...
        formData.append('Occupation', $("input[name='Occupation']").val());
        formData.append('Contact-Number', $("input[name='Contact-Number']").val());
        formData.append('Address', $("input[name='Address']").val());
        formData.append('Zip-Code', $("input[name='Zip-Code']").val());
        formData.append('Citizenship', $("input[name='Citizenship']").val());
        formData.append('PRofile', $("input[name='PRofile']").prop('files')[0]);
        formData.append('Government-ID', $("input[name='Government-ID']").prop('files')[0]);
