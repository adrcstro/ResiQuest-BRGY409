  ...
  if ($row["Status"] !== "Completed" && $row["Status"] !== "Released") {
    {
      ...
      <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
         ...
         View Details</a></li>
         <li onclick="editRequest(event)" data-request-id="' . $row["RequestID"] . '" data-service-type="' . $row["ServiceType"] . '">
         <a>
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
echo '<script>
  ...
  <div class="modal-box w-100 max-w-4xl rounded-none">
      ...
      <div class="mb-2 lg:mb-0">
        <h3 class="text-2xl font-bold text-blue-500 text-center">BRGY-409 Document Request Management System</h3>
        <span class="flex text-base font-medium text-blue-500 justify-center text-center">Edit Document Request Details</span>
      </div>
    
    <div id="modal-content-edit" class="mt-8 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
...
function editRequest(event) {
    ...
    const serviceType = event.currentTarget.getAttribute("data-service-type");

    // Now you have the requestId and serviceType, you can use them as needed
    console.log("Request ID:", requestId);
    console.log("Service Type:", serviceType);

    // Add your logic here to handle the edit request
    // For example, you can pass these values to your modal dialog function
    editrequestdetails.showModal();
}
...
document.addEventListener("DOMContentLoaded", function () {
    const editRequestModal = document.getElementById("editrequestdetails");
    ...
    const closeModalButton = document.querySelector("#editrequestdetails form button");
    ...
    editRequestButtons.forEach(function (button) {
        button.addEventListener("click", function () {
            ...
            // Create input fields based on the service type
            let inputsHtml = "";
            switch (serviceType) {
                ...
                case "Business Clearance":
                    inputsHtml = `
                        ...
                        <input type="text" name="LastName" placeholder="Last Name" />
                        <input type="text" name="Address" placeholder="Address" />
                        <input type="text" name="BusinessAct" placeholder="Business Activity" />
                        <input type="text" name="BusinessLoc" placeholder="Business Location" />
                    `;
                    break;
            ...
            // Display input fields in modal
            modalContentEdit.innerHTML = inputsHtml;

            // Show modal
            editRequestModal.showModal();
        });
    });
