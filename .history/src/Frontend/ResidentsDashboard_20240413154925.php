                   ...
                   <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                       <div class="col-span-4 sm:col-span-3">
                           ...
                           <div class="bg-white shadow-2xl rounded-lg p-6 ">
                               ...
                               <div class="relative">
  <img src="https://randomuser.me/api/portraits/men/94.jpg" class="w-32 h-32 bg-gray-300 rounded-full mb-4" alt="Profile Picture">
...
<dialog id="EditResidentprofile" class="modal p-3">
  ...
  <img id="profilePicture" src="https://randomuser.me/api/portraits/men/94.jpg" class="w-32 h-32 bg-gray-300 rounded-full mb-4" alt="Profile Picture">
  ...
  function displaySelectedImage(event) {
          ...
          <div class="mx-auto max-w-3xl">
                                 <div class="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-4">
                                     ...
                                     <div>
                                         ...
                                         <div class="mt-2.5">
                                             <input  required="" type="text" name="Middle-name" id="Middle-name" autocomplete="family-name"
                                                 placeholder="Enter Your Last Name"
                                                 class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                         </div>
                                     </div>
                                     ...
                                     <div>
                                         ...
                                         <div class="mt-2.5">
                                             <input required="" type="text" name="Nick-name" id="Nick-name" autocomplete="given-name"
                                                 placeholder="Add NickName"
                                                 class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                         </div>
                                     </div>
                                     <div>
                                         ...
                                         <div class="mt-2.5">
                                             <input required="" type="text" name="PlaceofBirth" id="PlaceofBirth" autocomplete="family-name"
                                                 placeholder="Enter Place of Birth"
                                                 class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                         </div>
                                     </div>
                                     <div>
                                         ...
                                         <div class="mt-2">
                                             <input required="" type="date" name="Birthdate" id="Birthdate" autocomplete="family-name"
                                                 placeholder="Select Birthdate"
                                                 class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                         </div>
                                     </div>
                                     <div>
                                         ...
                                         <div class="mt-2.5">
                                             <input required="" type="text" name="Age" id="Age" autocomplete="given-name"
                                                 placeholder="Enter Age"
                                                 class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                         </div>
                                     </div>
    ...
    <div class="mt-2.5">
        <select required id="purok" name="purok" autocomplete="given-name"
            ...
            <option value="Purok 1">Purok Sunflower</option>
            <option value="Purok 2">Purok Rosal</option>
            <option value="Purok 3">Purok Dahlia</option>
            <option value="Purok 3">Purok Camia</option>
            <option value="Purok 3">Purok Gumamela</option>
            <option value="Purok 3">Purok Jasmin</option>
            <option value="Purok 3">Purok Sampaguita</option>
        </select>
    </div>
</div>
...
<script>
  $(document).ready(function() {
    $("#SubmitInfotoVerify").click(function(e) {
      ...
      var civilstatus = $("input[name='civil-status']").val();
      var Gender = $("input[name='Gender']").val();
      var purok = $("input[name='purok']").val();
      var voterstatus = $("input[name='voter-status']").val();
   ...
   $(function(){
    $('#SubmitInfotoVerify').click(function(e){
        ...
        if(valid){
            ...
            formData.append('Government-ID', $('#Government-ID')[0].files[0]);
            formData.append('first-name', $('#first-name').val());
            formData.append('Middle-name', $('#Middle-name').val());
            formData.append('last-name', $('#last-name').val());
            formData.append('Nick-name', $('#Nick-name').val());
            formData.append('PlaceofBirth', $('#PlaceofBirth').val());
            formData.append('Birthdate', $('#Birthdate').val());
            formData.append('Age', $('#Age').val());
            formData.append('civil-status', $('#civil-status').val());
            formData.append('Gender', $('#Gender').val());
            formData.append('purok', $('#purok').val());
            formData.append('voter-status', $('#voter-status').val());
            formData.append('email', $('#email').val());
            formData.append('Occupation', $('#Occupation').val());
            formData.append('Contact-Number', $('#Contact-Number').val());
            formData.append('Address', $('#Address').val());
            formData.append('Zip-Code', $('#Zip-Code').val());
