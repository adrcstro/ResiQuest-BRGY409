             ...
             <div>
                  ...
                  <div class="flex flex-col sm:flex-row gap-x-6">
                    ...
                    <div class="mt-2">
                      ...
                      <div class="hidden">
                      <label for="UserIDBGClerance" class="block text-sm font-semibold leading-6 text-gray-900 mt-3">Document Status</label>
                    <div class="mt-2">
                        <input value="Pending" type="text" name="UserIDBGClerance" id="UserIDBGClerance" autocomplete="family-name" required
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6" >
                    </div>
                      </div>
