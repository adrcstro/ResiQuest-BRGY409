                        ...
                        <div class="mt-3 flex flex-col sm:flex-col gap-y-6">
                            <div class="flex flex-row items-center justify-center gap-x-6 ">
                                <div class="flex items-center border border-gray-200 rounded dark:border-gray-700 w-64 lg:w-72">
                                    ...
                                    <label for="bordered-radio-1" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Document Request</label>
                                </div>
                                <div class="flex items-center border border-gray-200 rounded dark:border-gray-700 w-64 lg:w-72">
                                    ...
                                    <label for="bordered-radio-2" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Complaint Report</label>
                                </div>
                            </div>
