                   ...
                   <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                       <div class="col-span-4 sm:col-span-3">
                           ...
                           <div class="bg-white shadow-2xl rounded-lg p-6 ">
                               ...
                               <div class="relative">
  <img src="https://randomuser.me/api/portraits/men/94.jpg" class="w-40 h-40 bg-gray-300 rounded-full mb-4" alt="Profile Picture">
  <div class="absolute bottom-0 right-0 top-3">
