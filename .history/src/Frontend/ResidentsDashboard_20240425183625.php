...
// Connect to the database (replace dbname, username, password, and hostname with your actual credentials)
...
// Fetch data from the table based on the user's request
$sql = "SELECT RequestID, FirstName, ServiceType, DateRequested, Status FROM requestdocument";
