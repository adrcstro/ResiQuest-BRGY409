             ...
             <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                <div class="flex-1 px-3 bg-white divide-y space-y-1">
                   <ul class="space-y-2 pb-2">
                      ...
                      <li>
            <a href="#" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group" onclick="showRequestedDocuments(event)">
                <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
...
<div id="requestedDocumentsPlaceholder" class="hidden"></div>

<script>
        function showRequestedDocuments(event) {
            event.preventDefault(); // Prevent default link behavior
            $.ajax({
                url: 'Requesteddocument.php',
                type: 'GET',
                success: function(data) {
                    $('#requestedDocumentsPlaceholder').html(data);
                },
                error: function() {
                    alert('Failed to load requested documents.');
                }
            });
        }
    </script>
