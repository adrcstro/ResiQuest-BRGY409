...
<div class="bg-white shadow-2xl rounded-md p-6 mb-3  mt-4">
    ...
    <div class="flex flex-col items-center justify-center w-full">
        ...
        <label for="Government-ID" class="flex flex-col items-center justify-center w-full h-64 p-2 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600" style="background-image: url(''); background-size: cover; background-position: center;">
            ...
            <div class="relative">
    <?php if(isset($row["GovernmentIDFront"]) && !empty($row["GovernmentIDFront"])): ?>
        <img id="GovernmentIDFront" src="../Backend/uploads/<?php echo $row["GovernmentIDFront"]; ?>" class="w-32 h-32 bg-gray-300 rounded-full  mb-4 " alt="Profile Picture">
    <?php else: ?>
        <img id="GovernmentIDFront"  src="/Images/blank.png" class="w-32 h-32 bg-gray-300 rounded-full mb-4" alt="Default Profile Picture">
    <?php endif; ?>
...
<script>
    ...
    if (file) {
      const reader = new FileReader();
      reader.onload = function(e) {
        document.getElementById('GovernmentIDFront').src = e.target.result;
      };
      reader.readAsDataURL(file);
    }
  }
  ...
  const fileInput = event.target;
  const file = fileInput.files[0];
  const profileImg = document.getElementById("GovernmentIDFront");
