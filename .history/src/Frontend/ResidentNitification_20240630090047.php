...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<button class='bg-blue-400 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded mt-2 view-details-btn' onclick=\"openModal('$newsId')\">View News & Events</button>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
    ...
    // Close button
    echo "<button class='btn btn-sm btn-circle btn-ghost absolute right-2 top-2' onclick=\"closeModal('$newsId')\">";
    echo"✕";
    echo "</button>";
