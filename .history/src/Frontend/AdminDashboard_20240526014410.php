        ...
        <span class="text-base font-normal text-gray-500">This is a list Released Documents</span>
             ...
             <div class="flex-shrink-0">
                 ...
                 <div class="lg:flex lg:items-center lg:pl-32">
                     <button class="mt-3 w-full relative text-gray-600 border-2 border-gray-200  bg-green-400 dark:bg-gray-800 dark:border-gray-700 hover:bg-green-500  font-semibold py-2 px-4">
