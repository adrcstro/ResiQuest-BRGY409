...
if(!empty($_SESSION["ID"])) {
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        echo '<table class="min-w-full divide-y divide-gray-200 mb-20">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="p-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Request ID</th>
                        <th scope="col" class="p-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Service Type</th>
                        <th scope="col" class="p-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Date Requested</th>
                        <th scope="col" class="p-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                        <th scope="col" class="p-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Schedule for Release</th>
                        <th scope="col" class="p-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Action</th>
                    </tr>
                </thead>
                <tbody class="bg-white">';
...
while($row = mysqli_fetch_assoc($result)) {
  ...
  switch ($row["Status"]) {
      case 'Pending':
          $statusBgColor = 'text-red-400 text-white';
          break;
      case 'On-Process':
          $statusBgColor = 'text-yellow-300 text-white ';
          break;
      case 'Completed':
          $statusBgColor = 'text-green-400 text-white';
          break;
      default:
  ...
  if ($row["Status"] !== "Completed") {
      echo '<tr>';
      echo '<td class="p-1 border-2 border-inherit text-center  whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["RequestID"] . '</td>';
      echo '<td class="p-1  border-2 border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["ServiceType"] . '</td>';
      echo '<td class="p-1  border-2 border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["DateRequested"] . '</td>';
      ...
      echo '<td class="p-1  border-2 border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["PickUpDate"] . '</td>';
      echo '<td class="p-1   border-2 border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">
