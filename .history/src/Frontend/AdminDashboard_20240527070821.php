...
?>
    ...
    <div id="showRequestedDocuments">
    </div>
    <script>
        async function showRequestedDocuments() {
            try {
                const response = await fetch('Requesteddocument.php');
                const text = await response.text();
                document.getElementById('showRequestedDocuments').innerHTML = text;
            } catch (error) {
