...
<div class="bg-white shadow-2xl rounded-md p-6 mb-3  mt-3">
        <div class="mb-2 lg:mb-0">
            <h3 class="text-2xl font-bold text-black text-center">Account Verification Process</h3>
            <span class="flex text-base font-medium text-black justify-center text-center">Edit User Personal Information</span>
        </div>
    </div>
