    ...
    document.getElementById('printdocument-btn').addEventListener('click', function() {
        ...
        <ol class="inline-flex items-end space-x-4 md:space-x-6 rtl:space-x-reverse">
            <li class="inline-flex items-center">
                <a href="#" data-filter="set_schedule" class="nav-link inline-flex items-center text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" data-filter="future_schedule" class="nav-link text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">View Future's Schedule</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" data-filter="today_schedule" class="nav-link text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">View Today's Schedule</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" data-filter="overdue_schedule" class="nav-link text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Over Due</a>
                </div>
            </li>
        </ol>
    </nav>
    <div id="table-container" class="container mx-auto mt-8">
    ...
    <script>
        $(document).ready(function() {
            $('.nav-link').on('click', function(e) {
                ...
                $.ajax({
                    url: 'Scheduleoverduerequest.php',
                    type: 'POST',
                    data: { filter: filter },
