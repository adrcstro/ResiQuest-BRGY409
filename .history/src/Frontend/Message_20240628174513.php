...
<!-- Message -------------------------------------------------------------------------------------------------------------->
<div  id="showMessage"   class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
   <div class="pt-3 px-4">
...
if ($result->num_rows > 0) {
    ...
    foreach($messages as $senderID => $senderMessages) {
        ...
        echo "<img class='object-cover w-12 h-12 rounded-lg' src='../Backend/uploads/" . htmlspecialchars($senderMessages[0]["SenderProfile"]) . "' alt='Sender Profile' />";
    ...
    echo '<div class="mx-auto text-center " style="width: 200px;">';
    echo '<img src="/Images/norequest.svg" alt="Illustration" class="w-30 h-auto">';
    echo "<p class='text-lg font-semibold text-center '>No Message found</p>";
    echo '</div>';
}
...
function openModal(messages) {
    ...
    messages.forEach(message => {
        ...
        if (message.MessageImage) {
            ...
            msgImage.classList.add('mt-2', 'w-full', 'h-auto', 'rounded'); // Adjusted classes for image
