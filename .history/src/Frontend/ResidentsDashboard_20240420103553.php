    ...
    <div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-sm mx-auto mt-2 sm:m-2">
        <div class="flex justify-between items-center">
            ...
            <div class="text-left ml-4">
                ...
                <p class="capitalize text-sm mt-2 mb-2">Consult with a physician for the necessary medical examination</p>
  ...
  <ul class="list-disc text-sm">
    ...
    <div class="col-span-4 sm:col-span-9">
        <div class="bg-white shadow-2xl rounded-lg p-6">
           ...
           <form action="ResidentsDashboard.php" method="post" enctype="multipart/form-data" class="mx-auto max-w-3xl mt-12">
             ...
             <div class="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-3">
              ...
              <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                <div class="sm:flex-1">
                    <label for="lastnamebrgyResidency" class="block text-sm font-semibold leading-6 text-gray-900 mt-3">Date Requested</label>
                      <div class="mt-2">
                          <input required="" type="date" name="lastnamebrgyResidency" id="lastnamebrgyResidency" autocomplete="family-name"
                              placeholder="Select Birthdate"
                              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                      </div>
                </div>
                <div class="sm:flex-1">
                    <label for="DaterequestedbrgyResidency" class="block text-sm font-semibold leading-6 text-gray-900 mt-3">Address</label>
                    <div class="mt-2.5">
                        <input value="<?php echo $row["Address"]?>" required="" type="text" name="DaterequestedbrgyResidency" id="DaterequestedbrgyResidency" autocomplete="family-name"
                            placeholder="Enter Complete Address"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
            ...
            <div>
                    ...
                    <div class="mt-2">
                        <input  required="" type="text" name="PurposebrgyResidency" id="PurposebrgyResidency" autocomplete="family-name"
                ...
                <div>
                    <label for="ServicetypebrgyResidency" class="block text-sm font-semibold leading-6 text-gray-900 mt-6 hidden">Service Type</label>
                    <div class="mt-2">
                        <input value="Certificate of Residency" type="text" name="ServicetypebrgyResidency" id="ServicetypebrgyResidency" autocomplete="family-name"
                            placeholder="Ex. Employment , School Enrollment , Government Requirements , Legal Matters etc"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
            ...
            <div class="flex justify-center space-x-2 mt-5 mb-3">
                <button class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 mt-3 rounded">
                   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
                      <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                    </svg>
...
<div class=" mt-8 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
  <button id="submitbrgyResidency"  type="button" class=" inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-500 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400  sm:w-auto sm:text-sm"> 
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
      </svg>
    Submit Request 
