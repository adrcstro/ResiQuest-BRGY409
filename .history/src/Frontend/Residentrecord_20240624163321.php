...
<!-- Residents Record -------------------------------------------------------------------------------------------------------------->
    ...
    <div class="pt-3 px-4">
        <div class="flex flex-col">
            ...
            <div class="lg:flex lg:items-center lg:pl-32">
                 <button onclick="Admin_addresident.showModal()"  class="mt-2 w-full relative text-white border-2 rounded-lg bg-red-400 dark:bg-gray-800 dark:border-gray-700 hover:bg-red-500  font-semibold py-2 px-4">
