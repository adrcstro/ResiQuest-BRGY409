    ...
    <div class="text-center lg:text-left">
        ...
        <span class="text-base font-normal text-gray-500">This is a list of Residents Requested Documents</span>
                        ...
                        <div class="flex justify-center mb-4">
                            ...
                            <button onclick="showPendingrequest(this)" class="bg-red-300 hover:bg-red-600 focus:outline-none focus:bg-red-600 text-white font-bold py-2 px-4 rounded">
...
<button onclick="showOnprocessrequest(this)" class="bg-yellow-300 hover:bg-yellow-600 focus:outline-none focus:bg-yellow-600 text-white font-bold py-2 px-4 rounded">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<button onclick="showCompleterequest(this)" class="bg-green-300 hover:bg-green-600 focus:outline-none focus:bg-green-600 text-white font-bold py-2 px-4 rounded">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<script>
    function showPendingrequest(button) {
        // Your code to handle the pending request
        // Remove focus from the button
        button.blur();
    }

    function showOnprocessrequest(button) {
        // Your code to handle the on-process request
        // Remove focus from the button
        button.blur();
    }

    function showCompleterequest(button) {
        // Your code to handle the complete request
        // Remove focus from the button
        button.blur();
    }
</script>
