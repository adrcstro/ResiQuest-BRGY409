...
<script>
    // PHP code to check password hash and display appropriate modal/alert
    <?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (password_verify($password, $hashed_password)) {
            // Passwords match, open a new modal dialog
            echo "const modal = new daisyUI.Modal('#successModal'); modal.open();";
        } else {
            // Passwords don't match, display an error alert
            echo "Swal.fire('Wrong Password', 'Please try again.', 'error');";
        }
    }
    ?>
</script>
