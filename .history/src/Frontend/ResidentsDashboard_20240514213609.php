      ...
      <div class="col-span-4 sm:col-span-3">
          ...
          <div class="bg-white shadow-2xl rounded-lg p-6 h-full">
              ...
              <img src="/Images/violence.svg" alt="Illustration" class="w-30 h-auto">
                  ...
                  <p class="text-black font-normal text-center text-sm">Confirm the Privided Information and Provide Details for your Complain</p>
             
                  <h3 class="mt-1 text-sm text-center font-bold mb-2">Upon Submmiting Complain Document you must:</h3>
    <ul class="list-disc text-sm">
      <li class="text-green-500">Verified Resident</li>
      <li class="text-green-500">Complete Information</li>
    </ul>
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />
      ...
      <div class="col-span-4 sm:col-span-9">
          <div class="bg-white shadow-2xl rounded-lg p-6 h-full">
              ...
              <div class="mb-2 lg:mb-0 ">
                  <h3 class="text-2xl font-bold text-blue-500 mb-2 text-center">
