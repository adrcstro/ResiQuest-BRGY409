...
// Initialize an empty variable to capture the output
$output = '';
...
if (!empty($_SESSION["ID"])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Loop through the $rows array to display each row
        foreach ($rows as $row) {
            echo '<tr>';
        ...
        $output = '<div class="text-center">
                      <img src="/Images/norequest.svg" alt="Illustration">
                      <p class="text-lg">No requests found for this user.</p>
                   </div>';
    }
}
...
<!-- Use the $output variable wherever you need it -->
<?php echo $output; ?>
