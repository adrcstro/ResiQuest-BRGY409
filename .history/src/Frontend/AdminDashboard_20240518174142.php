    ...
    <ol class="inline-flex items-end space-x-4 md:space-x-6 rtl:space-x-reverse">
        ...
        <li>
            <div class="flex items-center">
                ...
                <svg class="rtl:rotate-180 block w-6 h-6 ml-10 text-gray-400"  fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="rtl:rotate-180>  
                  ...
                  <line x1="11" y1="15" x2="12" y2="15" />  <line x1="12" y1="15" x2="12" y2="18" /></svg>                           
        ...
        <div class="mb-4 flex flex-col lg:flex-row items-center justify-between">
               ...
               <div class="flex-shrink-0">
                   ...
                   <div class="flex justify-end mt-2 lg:mt-3 space-x-2">
                       <button class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded btn" onclick="publish_news.showModal()">
                       ...
                       <?php
                           ...
                           if (mysqli_num_rows($result) > 0) {
                              ...
                              while($row = mysqli_fetch_assoc($result)) {
                                 ...
                                 echo "<td><img src='uploads/" . $row["NewsImages"] . "' alt='News Image' style='max-width: 100px; max-height: 100px;'></td>";
                                 echo '<td class="p-1   border border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">
                                 <div class="dropdown  dropdown-end">
                                 <div tabindex="0" role="button" class="flex items-center justify-between text-white font-semibold btn w-40 bg-blue-400 hover:bg-blue-500">
                                 Action Details
