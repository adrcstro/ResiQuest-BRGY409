  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="#" onclick="showtodaysBlotterschedule()" class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white" >View Today's Schedule</a>
            </div>
        </li>
        <li>
            <div class="flex items-center">
               ...
               <?php include '../Backend/AdminTables/ComFutureSchedBlottertbl.php'; ?>
                ...
                <div id="BlotterTodaysSchedule" class="hidden mt-3">
               <?php include '../Backend/AdminTables/ComTodaysschedBlottertbl.php'; ?>
                </div>
                <div id="BlotterOverdueSchedule" class="hidden mt-3">
