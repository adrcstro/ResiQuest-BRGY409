...
while($row = mysqli_fetch_assoc($result)) {
  ...
  if ($row["Status"] !== "Completed") {
      ...
      echo '<td class="p-1  border-2 border-black text-center whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["ServiceType"] . '</td>';
      echo '<td class="p-1  border-2 border-black text-center whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["DateRequested"] . '</td>';
      echo '<td class="text-center border-2 border-black rounded-md text-sm font-semibold text-gray-900 ' . $statusBgColor . '">' . $row["Status"] . '</td>';
      echo '<td class="p-1  border-2 border-black text-center whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["PickUpDate"] . '</td>';
      echo '<td class="p-1   border-2 border-black text-center whitespace-nowrap text-sm font-semibold text-gray-900">
