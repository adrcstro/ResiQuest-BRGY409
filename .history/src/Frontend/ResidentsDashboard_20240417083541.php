...
$query = "SELECT GovernmentIDFront, GovernmentIDBack FROM users WHERE ID = :ID"; // Modify this query as per your table structure
$stmt = $pdo->prepare($query);
$stmt->execute(['id' => $id]); // Assuming $id contains the ID of the record you want to fetch
$row = $stmt->fetch(PDO::FETCH_ASSOC);

$frontImageUrl = $row['GovernmentIDFront'];
$backImageUrl = $row['GovernmentIDBack'];
?>
