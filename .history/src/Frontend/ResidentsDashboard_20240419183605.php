...
<dialog id="EditResidentprofile" class="modal p-3">
  ...
  <div class="relative">
    <?php if(isset($row["Profile"]) && !empty($row["Profile"])): ?>
        <img id="profilePicture" src="../Backend/uploads/<?php echo $row["Profile"]; ?>" class="w-32 h-32 bg-gray-300 rounded-full  mb-4 border-8" alt="Profile Picture">
    <?php else: ?>
...
<label for="PRofile" class="absolute bottom-0 right-0 p-2 bg-gray-200 text-black rounded-full hover:bg-gray-400 focus:outline-none focus:bg-gray-400 cursor-pointer border-3  " title="Edit Profile">
