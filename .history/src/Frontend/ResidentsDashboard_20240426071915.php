...
if(!empty($_SESSION["ID"])) {
    ...
    if(mysqli_num_rows($result) > 0) {
      ...
      echo '<img src="/Images/norequest.svg" alt="Illustration">';
...
// Check if $row is not null and if it has the key "fname"
if ($row !== null && isset($row["fname"])) {
    echo $row["fname"];
} else {
    // Handle the case where $row is null or "fname" key doesn't exist
