        ...
        <div class="bg-white shadow-2xl rounded-lg p-6">
           ...
           <form action="ResidentsDashboard.php" method="post" enctype="multipart/form-data" class="mx-auto max-w-3xl mt-12">
            ...
            <div>
                ...
                <div>
                    <label for="PurposebrgyResidency" class="block text-sm font-semibold leading-6 text-gray-900 mt-6">Service Type</label>
                    <div class="mt-2">
                        <input value="Certificate of Residency" type="text" name="PurposebrgyResidency" id="PurposebrgyResidency" autocomplete="family-name"
                            placeholder="Ex. Employment , School Enrollment , Government Requirements , Legal Matters etc"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
