...
<form action="../Backend/Insert.php" method="post" enctype="multipart/form-data">
    <div class="mt-4 px-4 py-3 sm:px-6 flex flex-col md:flex-row gap-4">
        <!-- Left side inputs -->
        <div class="flex-1 flex flex-col">
            <div class="flex flex-col items-center justify-center w-full h-full">
                ...
                <label for="Government-ID" class="flex flex-col items-center justify-center w-full h-full p-2 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                    style="background-image: url('<?php echo isset($row["GovernmentIDFront"]) && !empty($row["GovernmentIDFront"]) ? "../Backend/uploads/" . $row["GovernmentIDFront"] : ""; ?>'); background-size: cover; background-position: center;">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="mt-3 flex flex-col sm:flex-row gap-x-6">
                <div class="sm:flex-1">
                    <label for="Address" class="block text-sm font-semibold leading-6 text-gray-900">News Date</label>
                    <div class="mt-2">
                        <input required type="date" name="Address" id="Address" autocomplete="Address" placeholder="Enter Address" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 flex-1">
                    </div>
                </div>
                <div class="sm:flex-1">
                    <label for="Zip-Code" class="block text-sm font-semibold leading-6 text-gray-900">News Time</label>
                    <div class="mt-2">
                        <input required type="time" name="Zip-Code" id="Zip-Code" autocomplete="Zip-Code" placeholder="Enter City Zip Code Ex. 1008" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 flex-1">
                    </div>
                </div>
            </div>
