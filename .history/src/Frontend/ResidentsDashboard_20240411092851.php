...
<div class="bg-blue-200 p-3 rounded-md mt-2 ">
<div class="flex items-center">
  <h2 class="text-lg font-semibold mr-2">Note</h2>
 ...
 <h3 class="text-lg font-semibold mb-2">Submmiting Government ID</h3>
              <p>Please make sure to follow the Following:</p>
              <ul class="list-disc ml-6 mb-4">
                <li>Only these Government ID's we will accept (Barangay ID, Philhealth ID, National ID, Drivers License, Postal ID) if you dont have these ID's you can submit your PSA and make sure it is a Scan Copy</li>
                <li>Upon Submmiting Govenrment ID's please make sure that it is Clear Front and Back</li>
                <li class="text-center">Failed to Follow these will results not verificationg your account</li>
              </ul>
