...
<!-- Pesonal Profile -------------------------------------------------------------------------------------------------------------->
  ...
  <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1' stroke='currentColor' class='w-25 h-25 bg-gray-300 rounded-full mb-4'%3E%3Cpath stroke-linecap='round' stroke-linejoin='round' d='M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z'/%3E%3C/svg%3E" class="w-32 h-32 bg-gray-300 rounded-full mb-4" alt="Hero Person Icon">
  ...
  <div class="modal-box w-full max-w-6xl rounded-none">
    ...
    <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
      ...
      <div class="bg-white shadow-2xl rounded-lg p-6 ">
                               ...
                               <div class="relative">
  <img src="https://randomuser.me/api/portraits/men/94.jpg" class="w-32 h-32 bg-gray-300 rounded-md mb-4 shrink-0" alt="Profile Picture">
  <div class="absolute bottom-0 right-2 transform translate-x-1/3 -translate-y-1/3">
    <button onclick="openFileManager()" class="p-1 bg-gray-600 text-white rounded-full hover:bg-gray-700 focus:outline-none focus:bg-gray-700" title="Edit Profile">
