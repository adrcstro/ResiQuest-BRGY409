...
<div class="bg-secondary">
      ...
      <div class="relative mx-16 lg:mx-20">
        ...
        <div class="flex pt-52 justify-center">
          <div class="text-center">
            ...
            <button type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-md text-sm px-12 py-2.5 text-center me-2 mb-2">Get Started</button>
            </div>
          </div>
        </div>
        <!-- card row -->
  ...
  <!-- card container -->
  <div class="card-container flex flex-row-reverse items-center justify-between bg-gray-800 p-4 rounded-lg">
    <div class="flex-shrink-0">
      <img class="h-40 w-40" src="/Images/News.svg" alt="vector1" />
    </div>
    <div class="flex flex-col items-start space-y-3 text-left">
      <h5 class="text-2xl font-semibold text-white">News & Announcements</h5>
      <p class="font-extralight text-gray-300">Stay updated with the latest news and announcements from our community.</p>
  ...
  <div class="card-container flex flex-row-reverse items-center justify-between bg-gray-800 p-4 rounded-lg">
    ...
    <div class="flex flex-col items-start space-y-3 text-left">
      <h5 class="text-2xl font-semibold text-white">Document Issuance</h5>
      <p class="font-extralight text-gray-300">Get your documents processed efficiently with our document issuance services.</p>
      <button class="rounded-full border-2 bg-transparent border-white p-2 pr-5 pl-5 hover:bg-white hover:text-primary transform text-white btn" onclick="my_modal_2.showModal()">View Details</button>
    </div>
  </div>
  <!-- card container -->
  <div class="card-container flex flex-row-reverse items-center justify-between bg-gray-800 p-4 rounded-lg">
    ...
    <div class="flex flex-col items-start space-y-3 text-left">
      <h5 class="text-2xl font-semibold text-white">Barangay Officials</h5>
      <p class="font-extralight text-gray-300">Meet our new barangay officials and learn about their roles in our barangay.</p>
      <button class="rounded-full border-2 bg-transparent border-white p-2 pr-5 pl-5 hover:bg-white hover:text-primary transform text-white btn" onclick="my_modal_3.showModal()">View Details</button>
    </div>
  </div>
</div>
    ...
    <section class="bg-blue-100 w-full mt-32 pt-10 lg:mt-32 z-50 px-4 md:px-10" id="services">
    ...
    <div class="flex justify-center">
      <div class="h-auto w-10/12 mt-12 grid grid-cols-1 lg:grid-cols-2 rounded-md ">
        ...
        <div class="p-10 text-black text-lg text-justify font-extralight pt-0 lg:pt-10 lg:pl-0 space-y-4">
          ...
          <h2 class="font-bold text-black text-xl">VISSION</h2>
