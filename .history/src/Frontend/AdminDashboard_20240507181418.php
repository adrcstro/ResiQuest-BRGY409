...
document.addEventListener("DOMContentLoaded", function () {
  ...
  openModalButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      ...
      <input  type="file" id="PRofile" name="PRofile" class="hidden" accept=".jpg, .png .jpeg .pdf, .doc, .docx">
      ...
      <div class="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-3">
          <div class="flex flex-col">
              ...
              <input value="${fname}"  required="" type="text" name="AdminEditresidentFirstName" id="AdminEditresidentFirstName" autocomplete="given-name" placeholder="First Name"
                  class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
          </div>
          <div class="flex flex-col">
              <label for="AdminEditresidentMiddleName" class="block text-sm font-medium text-gray-700">Middle Name</label>
              <input value="${mname}" required="" type="text" name="AdminEditresidentMiddleName" id="AdminEditresidentMiddleName" autocomplete="additional-name" placeholder="Middle Name"
                  class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
          </div>
          <div class="flex flex-col">
              <label for="AdminEditresidentLastName" class="block text-sm font-medium text-gray-700">Last Name</label>
              <input value="${lname}"  required="" type="text" name="AdminEditresidentLastName" id="AdminEditresidentLastName" autocomplete="family-name" placeholder="Last Name"
                  class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
          </div>
          ...
          <div class="flex flex-col">
              ...
              <input value="${Nname}" required="" type="text" name="AdminEditresidentnickname" id="AdminEditresidentnickname" autocomplete="given-name" 
                  class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
          </div>
          <div class="flex flex-col">
              <label for="AdminEditresidentplaceofbirth" class="block text-sm font-medium text-gray-700">Place of Birth</label>
              <input value="${Placeorbirth}"  required="" type="text" name="AdminEditresidentplaceofbirth" id="AdminEditresidentplaceofbirth" autocomplete="additional-name" 
                  class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
          </div>
          <div class="flex flex-col">
              <label for="AdminEditresibirthdate" class="block text-sm font-medium text-gray-700">Birthdate</label>
              <input value="${dateofrbirth}" required="" type="date" name="AdminEditresibirthdate" id="AdminEditresibirthdate" autocomplete="family-name" 
                  class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
          </div>
          ...
          <input value="${age}"  required="" type="number" name="AdminEditresiage" id="AdminEditresiage" autocomplete="given-name" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
      </div>
      ...
      <select required name="AdminEditresicivilstat" id="AdminEditresicivilstat" autocomplete="additional-name" 
          class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
          <option value="" disabled selected>value="${civilstatu}"</option>
          <option value="Single" <?= $civilstatu === "Single" ? "selected" : "" ?>>Single</option>
          <option value="Married" <?= $civilstatu === "Married" ? "selected" : ""?>>Married</option>
          <option value="Divorced" <?= $civilstatu === "Divorced" ? "selected" : "" ?>>Divorced</option>
          <option value="Widowed" <?= $civilstatu === "Widowed" ? "selected" : "" ?>>Widowed</option>
      </select>
  </div>
      ...
      <div class="flex flex-col">
          ...
          <input value="${gender}" required="" type="text" name="AdminEditLastName" id="AdminEditLastName" autocomplete="family-name" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 ">
      </div>
      </div>
      ...
      <div class="sm:flex-1">
          ...
          <input value="${purok}"  required="" type="text" name="AdminsID" id="AdminsID" autocomplete="street-address" 
      ...
      <div class="sm:flex-1">
          ...
          <input value="${voterstat}"  required="" type="text" name="AdminsID" id="AdminsID" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
  </div>
  ...
  <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
      <div class="sm:flex-1">
          ...
          <input value="${email}"  required="" type="text" name="AdminsID" id="AdminsID" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
      <div class="sm:flex-1">
          <label for="AdminsID" class="block text-sm font-medium text-gray-700">Occupation</label>
          <input value="${occupation}"  required="" type="text" name="AdminsID" id="AdminsID" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
  </div>
  ...
  <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
      <div class="sm:flex-1">
          ...
          <input value="${contactnum}"  required="" type="text" name="AdminsID" id="AdminsID" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
      <div class="sm:flex-1">
          <label for="AdminsID" class="block text-sm font-medium text-gray-700">Address</label>
          <input value="${address}"  required="" type="text" name="AdminsID" id="AdminsID" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
  </div>
  ...
  <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
      <div class="sm:flex-1">
          ...
          <input value="${zipcode}"  required="" type="text" name="AdminsID" id="AdminsID" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
      <div class="sm:flex-1">
          <label for="AdminsID" class="block text-sm font-medium text-gray-700">Citizenship</label>
          <input value="${citizenship}"  required="" type="text" name="AdminsID" id="AdminsID" autocomplete="street-address" 
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
      </div>
  </div>
        ...
        <span class="text-base font-normal text-gray-500">This is a list of Residents Requested Documents</span>
                        ...
                        <div class="flex justify-center mb-4">
                            <div class="flex mt-4 lg:mt-3 space-x-2">
                                ...
                                <button onclick="showPendingrequest()" class="bg-red-300 hover:bg-red-600 focus:outline-none focus:bg-red-600 text-white font-bold py-2 px-4 rounded">
                                ...
                                <button  onclick="showOnprocessrequest()"  class="bg-yellow-300 hover:bg-yellow-600 focus:outline-none focus:bg-yellow-600 text-white font-bold py-2 px-4 rounded">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
                                ...
                                <button  onclick="showCompleterequest()"  class="bg-green-300 hover:bg-green-600 focus:outline-none focus:bg-green-600 text-white font-bold py-2 px-4 rounded">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
