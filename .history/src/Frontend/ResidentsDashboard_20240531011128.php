...
<dialog id="RequestIndigency" class="modal p-3">
  <div class="modal-box w-full max-w-6xl rounded-none">
      ...
      <ul class="list-disc text-sm">
        ...
        <div class="col-span-4 sm:col-span-9">
            <div class="bg-white shadow-2xl rounded-lg p-6">
               ...
               <form action="ResidentsDashboard.php"  onsubmit="updatePurposeValue()" method="post" class="mx-auto max-w-3xl mt-12">
    ...
    <div id="otherPurposeContainer" class="mt-2 hidden">
        ...
        <input type="text" name="otherPurpose" id="otherPurpose" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
    </div>
    <input type="hidden" name="finalPurpose" id="finalPurpose">
    <button type="submit" class="mt-4 px-4 py-2 bg-blue-600 text-white rounded-md">Submit</button>
</form>
...
<script>
    ...
    function updatePurposeValue() {
        ...
        const finalPurposeInput = document.getElementById('finalPurpose');

        if (selectElement.value === 'Other') {
            finalPurposeInput.value = otherPurposeInput.value;
        } else {
            finalPurposeInput.value = selectElement.value;
        }

        // Ensure the select element's name is not submitted
        selectElement.name = '';
    }
