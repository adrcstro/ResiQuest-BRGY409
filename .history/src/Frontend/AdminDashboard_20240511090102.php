    ...
    Mark Complete</a></li>
                  ...
                  echo '</tr>';
                    ...
                    echo '<script>
                          ...
                          echo '<dialog id="mamrkascompleteresidentrequest" class="modal p-3 ">
                          <div class="modal-box w-70 max-w-3xl rounded-lg">
                          ...
                          <button" id="completedsidentbutton" class="inline-flex justify-center  rounded-md border border-transparent shadow-sm px-4 py-4 bg-green-500 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm"> 
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
                        ...
                        echo '<script>
                        document.addEventListener("DOMContentLoaded", function () {
                          const modal = document.getElementById("mamrkascompleteresidentrequest");
