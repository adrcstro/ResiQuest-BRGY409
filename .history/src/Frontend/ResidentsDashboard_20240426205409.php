    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while($row = mysqli_fetch_assoc($result)) {
          if ($row["Status"] !== "Completed") {
            ...
            <div tabindex="0" role="button" class=" text-white  btn m-1 w-40 bg-blue-400 hover:bg-blue-500"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
