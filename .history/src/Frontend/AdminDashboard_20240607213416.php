...
?>
            <div class="relative" style="height: 200px;">
                <canvas id="requestchart" width="420" height="200"></canvas>
            </div>
...
var myChart = new Chart(ctx, {
    ...
    },options: {scales: {y: {beginAtZero: true,ticks: {color: 'white' },grid: {
    color: 'rgba(255, 255, 255, 0.5)' }},x: {ticks: {color: 'white' },grid: {color: 'rgba(255, 255, 255, 0.5)' }}},plugins: {legend: {
    labels: {color: 'white' }}}}});
</script>
    ...
    <div class="flex items-center">
        <div class="flex-shrink-0 w-full">
            <?php countComplaints(); ?>
            <div class="relative" style="height: 200px;">
                <canvas id="myChart" width="420" height="200"></canvas>
            </div>
...
var myChart = new Chart(ctx, {
    ...
    data: {
        labels: <?php echo json_encode($dates); ?>,
        datasets: [{
            label: 'Complaint Count Report over Months',
            data: <?php echo json_encode($counts); ?>,
            backgroundColor: 'rgba(75, 192, 192, 0.2)',
            borderColor: 'rgba(255, 255, 255, 1)', // Changed to white
            borderWidth: 1
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
    ...
    <div class="flex items-center">
        ...
        <?php countUsers();?>
            <div class="relative" style="height: 200px;">
                <canvas id="ResidentChart" width="420" height="200"></canvas>
            </div>
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {labels: ['Male', 'Female'],datasets: [{label: 'Registered Residents',data: <?php echo json_encode($counts); ?>,backgroundColor: 'rgba(75, 192, 192, 0.2)',
            borderColor: 'rgba(255, 255, 255, 1)',borderWidth: 1}]},options: {
        scales: {y: {beginAtZero: true,ticks: { color: 'white' },grid: { color: 'rgba(255, 255, 255, 0.5)' }
    ...
    <div class="flex items-center">
        ...
        <?php countUsers();?>
            <div class="relative" style="height: 200px;">
                <canvas id="VotersChart" width="420" height="200"></canvas>
            </div>
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: { labels: ['Not Registered', 'Registered', 'Pending Registration'],datasets: [{label: 'Residents Voter Status',data: <?php echo json_encode($counts); ?>,backgroundColor: 'rgba(75, 192, 192, 0.2)',
            borderColor: 'rgba(255, 255, 255, 1)',borderWidth: 1}]},options: {
        scales: {y: {beginAtZero: true,ticks: { color: 'white' },grid: { color: 'rgba(255, 255, 255, 0.5)' }
            },x: {ticks: { color: 'white' },grid: { color: 'rgba(255, 255, 255, 0.5)' }}},plugins: {legend: {labels: { color: 'white' }}}}});
</script>
        ...
        <div class="absolute top-0 right-0 mt-2 mr-2">
<svg  xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-file-description"><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><path d="M9 7l1 0" /><path d="M9 13l6 0" /><path d="M13 17l2 0" /></svg>
        </div>
    </div>
    <div class="flex items-center">
        <div class="flex-shrink-0 w-full">
        <?php countUsers();?>
            <div class="relative" style="height: 200px;">
                <canvas  id="MstatChart" width="420" height="200"></canvas>
            </div>
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: { labels: ['Married', 'Single','Divorced', 'Widowed','Separated'],datasets: [{label: 'Residents Marital Status',data: <?php echo json_encode($counts); ?>,backgroundColor: 'rgba(75, 192, 192, 0.2)',
            borderColor: 'rgba(255, 255, 255, 1)',borderWidth: 1}]},options: {
        scales: {y: {beginAtZero: true,ticks: { color: 'white' },grid: { color: 'rgba(255, 255, 255, 0.5)' }
            },x: {ticks: { color: 'white' },grid: { color: 'rgba(255, 255, 255, 0.5)' }}},plugins: {legend: {labels: { color: 'white' }}}}});
</script>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 0 1-1.043 3.296 3.745 3.745 0 0 1-3.296 1.043A3.745 3.745 0 0 1 12 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 0 1-3.296-1.043 3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0 0 1 3 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 0 1 1.043-3.296 3.746 3.746 0 0 1 3.296-1.043A3.746 3.746 0 0 1 12 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.746 3.746 0 0 1 1.043 3.296A3.745 3.745 0 0 1 21 12Z" />
    ...
    <div class="flex items-center">
        ...
        <?php countUsers();?>
            <div class="relative" style="height: 200px;">
                <canvas  id="VerifiedChart" width="420" height="200"></canvas>
            </div>
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: { labels: ['Verified', 'Not-Verified'],datasets: [{label: 'Residents Account Status',data: <?php echo json_encode($counts); ?>,backgroundColor: 'rgba(75, 192, 192, 0.2)',
            borderColor: 'rgba(255, 255, 255, 1)',borderWidth: 1}]},options: {
        scales: {y: {beginAtZero: true,ticks: { color: 'white' },grid: { color: 'rgba(255, 255, 255, 0.5)' }
            },x: {ticks: { color: 'white' },grid: { color: 'rgba(255, 255, 255, 0.5)' }}},plugins: {legend: {labels: { color: 'white' }}}}});
</script>
                ...
                <div class="flex items-center justify-between">
                  <h3 class="text-base  text-black font-semibold text-center">Resident DOcument Request & Blotter Report Monitoring Chart</h3>
        <div class="absolute top-0 right-0 mt-2 mr-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-file-description">
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 0 1-1.043 3.296 3.745 3.745 0 0 1-3.296 1.043A3.745 3.745 0 0 1 12 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 0 1-3.296-1.043 3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0 0 1 3 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 0 1 1.043-3.296 3.746 3.746 0 0 1 3.296-1.043A3.746 3.746 0 0 1 12 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.746 3.746 0 0 1 1.043 3.296A3.745 3.745 0 0 1 21 12Z" />
</svg>
    ...
    <div class="flex items-center">
        <div class="flex-shrink-0 w-full">
            <div class="relative" style="height: 500px; width: 500px;">
                <canvas  id="MainChart" width="800" height="900"></canvas>
            </div>
...
Add Residents Information
         ...
         <nav class="flex space-x-8 mb-3 justify-center px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
    <ol class="inline-flex items-end space-x-4 md:space-x-6 rtl:space-x-reverse">
        <li class="inline-flex items-center">
        ...
        <li>
            <div class="flex items-center">
                ...
                <svg  xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="rtl:rotate-180 block w-6 h-6 ml-10 text-gray-400"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 14m-5 0a5 5 0 1 0 10 0a5 5 0 1 0 -10 0" /><path d="M19 5l-5.4 5.4" /><path d="M19 5h-5" /><path d="M19 5v5" /></svg>
                <a href="#" onclick="displayMaleresident()" class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white" >Male Resident</a>
            </div>
        </li>
        <li>
            <div class="flex items-center">
                ...
                <svg  xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="rtl:rotate-180 block w-6 h-6 ml-10 text-gray-400"   ><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 9m-5 0a5 5 0 1 0 10 0a5 5 0 1 0 -10 0" /><path d="M12 14v7" /><path d="M9 18h6" /></svg>
                <a href="#" onclick="displayFemaleresident()" class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white" >Female Resident</a>
            </div>
        </li>
        <li>
            <div class="flex items-center">
                ...
                <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="rtl:rotate-180 block w-6 h-6 ml-10 text-gray-400"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M11 21l-1 -4l-2 -3v-6" /><path d="M5 14l-1 -3l4 -3l3 2l3 .5" /><path d="M8 4m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M7 17l-2 4" /><path d="M16 21v-8.5a1.5 1.5 0 0 1 3 0v.5" /></svg>
                <a href="#" onclick="displaySenioreresident()"  class="ms-1 text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Senior Resident</a>
            </div>
        </li>
