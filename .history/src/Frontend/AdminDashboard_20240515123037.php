...
<button onclick="showPendingrequest()" class="relative text-gray-600 border-2 border-gray-200  bg-gray-50 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100  font-semibold py-2 px-4 rounded-lg">
