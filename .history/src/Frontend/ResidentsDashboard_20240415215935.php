...
<!-- Pesonal Profile -------------------------------------------------------------------------------------------------------------->
  ...
  <form method="dialog">
    ...
    <form method="post" id="passwordForm">
      ...
      <button type="submit" onclick="verifyPassword(event)" class="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-400 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm"> 
...
<script>
  function verifyPassword(event) {
    ...
    // Send a POST request to the same file
    ...
    .then(data => {
      Swal.fire({
        title: data.includes("matched") ? 'Password Matched!' : 'Password Wrong!',
        icon: data.includes("matched") ? 'success' : 'error',
