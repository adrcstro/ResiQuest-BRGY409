  ...
  if ($row["Status"] !== "Completed" && $row["Status"] !== "Released") {
    {
      ...
      <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
         ...
         <a onclick="checkStatus(' . $row["Status"] . ')"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
function checkStatus(status) {
    if (status === "On-Process" || status === "Completed") {
        ...
        // Add logic to handle the edit request action
    }
}
</script>
';
