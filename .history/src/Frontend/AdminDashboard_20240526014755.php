...
<div  id="showBrgyOfficials"  style="display: none;" class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
   <div class="pt-3 px-4">
      ...
      <div class="flex-shrink-0">
                 ...
                 <button class="mt-2 w-full relative text-white border-2 border-gray-200rounded-lg bg-green-400 dark:bg-gray-800 dark:border-gray-700 hover:bg-green-500  font-semibold py-2 px-4">
