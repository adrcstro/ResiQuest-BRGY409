...
<div class="bg-white p-4 rounded-lg shadow-2xl flex flex-col items-center">
    <img src="/Images/verification.svg" alt="Illustration" class="w-32 h-auto">
    <h2 class="text-lg font-semibold text-gray-600">Account Verification</h2>
    <p class="text-sm text-gray-600">Verification Done</p>
</div>

<div class="bg-white p-4 rounded-lg shadow-2xl flex flex-col items-center">
    <img src="/Images/request.svg" alt="Illustration" class="w-32 h-auto">
    <h2 class="text-lg font-semibold text-gray-600">Request Concern Once Verified</h2>
    <p class="text-sm text-gray-600">Request Document & File Complaint</p>
</div>
