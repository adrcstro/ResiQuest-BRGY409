...
while($row = mysqli_fetch_assoc($result)) {
  ...
  echo "<td><img src='../Backend/uploads/" . $row["NewsImages"] . "' alt='News Image' style='flex justify-content-center align-items-center  max-width: 100px; max-height: 100px;'></td>";
