...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const closeEditModalButton = editRequestModal.querySelector(".close");
...
<dialog id="edit-request-btn" class="modal p-3">
<div class="modal-content">
  ...
  <form id="editRequestForm">
    <!-- Input fields for updated request details -->
    <!-- Adjust the fields based on the service type -->
    ...
    <input type="text" id="businessAct" name="businessAct" placeholder="Business Activity">
    <input type="text" id="businessLoc" name="businessLoc" placeholder="Business Location">
