...
?>
                 ...
                 <button class="relative bg-red-300 hover:bg-red-600 focus:outline-none focus:bg-red-600 text-white font-bold py-2 px-4 rounded" onclick="ViewSchedule.showModal()"  >
