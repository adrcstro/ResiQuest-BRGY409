...
Add News/Announcement
    ...
    <div class="modal-box w-full h-full max-w-6xl rounded-lg px-4 sm:px-6 md:px-8 lg:px-10">
        <div class="flex flex-col">
            <div class="overflow-x-auto rounded-lg">
                <div class="mb-2 lg:mb-0">
                ...
                <form action="../Backend/Insert.php" method="post" enctype="multipart/form-data">
                    <div class="mt-4 px-4 py-3 sm:px-6 flex flex-col md:flex-row align-items justify-between gap-4">
                        <!-- Left side inputs -->
                        <div class="flex-1">
                            <span class="label-text block mb-2 mt-4">News Image</span>
                            <div class="mt-2">
                                <input required type="file" name="NewsImage" accept=".jpg,.jpeg,.png" class="block w-full rounded-md px-3.5 py-2 text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6 dark:bg-white input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500">
                            </div>
                        </div>
                        ...
                        <div class="flex-1">
                            ...
                            <input required type="date" name="NewsDate" class="block w-full rounded-md px-3.5 py-2 text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6 dark:text-white input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500">
                            
                            <span class="label-text block mb-2 mt-4">News Time</span>
                            <input required type="time" name="NewsTime" class="block w-full rounded-md px-3.5 py-2 text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6 dark:text-white input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500">
                            
                            <span class="label-text block mb-2 mt-4">News Content</span>
                            <textarea name="NewsContent" rows="6" class="rounded-lg border-gray-200 w-full pt-2 text-gray-900 border-1 bg-white input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500 resize-none" placeholder="Enter News Content" required></textarea>
                        </div>
                    </div>

                    <div class="modal-action flex justify-center items-center">
                        <button name="btnSubmit" class="btn bg-green-500 hover:bg-green-700 text-md text-white">Publish News</button>
                    </div>
                </form>
            </div>
        </div>
