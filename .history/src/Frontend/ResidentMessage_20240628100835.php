...
<div  id="ResidentsMessage"  class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
  ...
  <form id="residentmessage" class="mt-12" onsubmit="displayValues(event)">
   ...
   <?php
// Assume $row["Profile"] contains the URL or path to the image file
$imagePath = $row["Profile"];
?>
<input type="file" id="ProfileMessageSender" name="ProfileMessageSender" accept=".jpg, .png, .jpeg" onchange="displayImage(this)">
<img id="profileImage" src="<?php echo $imagePath; ?>" alt="Profile Image" style="<?php echo $imagePath ? 'display:block;' : 'display:none;'; ?>"/>
