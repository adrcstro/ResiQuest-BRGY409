...
<div class="flex items-center">
          ...
          <div class="bg-white shadow-2xl rounded-lg p-6 h-full">
             ...
             <form action="ResidentsDashboard.php" method="post"  class="mx-auto max-w-3xl mt-8">
               ...
               <div class="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-3">
                  ...
                  <div>
                      <label for="lastnamebrgyID" class="block text-sm font-semibold leading-6 text-gray-900">Middle Name</label>
                      <div class="mt-2.5">
                          <input value="<?php echo $row["Mname"]?>" required="" type="text" name="lastnamebrgyID" id="lastnamebrgyID" autocomplete="family-name"
                              placeholder="Enter Your Last Name"
                              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                      </div>
                  </div>
  ...
  <div class="mt-4 grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-3">
    <div>
        <label for="ContactpersonfirstbrgyID" class="block text-sm font-semibold leading-6 text-gray-900">Full Name</label>
        <div class="mt-2.5">
            <input required="" type="text" name="ContactpersonfirstbrgyID" id="ContactpersonfirstbrgyID" autocomplete="given-name"
