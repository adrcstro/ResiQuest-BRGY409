    ...
    function filterRequests(status) {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("requestTable").innerHTML = this.responseText;
            }
        };
        xhttp.open("GET", "<?php echo $_SERVER['PHP_SELF']; ?>?status=" + status, true);
        xhttp.send();
    }
</script>


                            <button class="bg-red-400 hover:bg-red-600 text-white font-bold py-2 px-4 rounded" onclick="filterRequests('Pending')">
...
<button class="bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded" onclick="filterRequests('On-Process')">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<button class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded" onclick="filterRequests('Completed')">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
// Default status is 'Pending' if no status is provided
                ...
                <div class="dropdown  dropdown-end">
                    ...
                    <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52">
                        ...
                        <li class="delete-request-btn">
                            ...
                            </svg>Delete Request</a>
                        </li>

                        <li class="delete-request-btn">
                            <a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />
                            </svg>Process Request</a>
                        </li>
                    </ul>
                </div>
            </td>';
