...
?>
<button onclick="showCompleterequest()" class="relative text-gray-600 border-2 border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 font-bold py-2 px-4">
