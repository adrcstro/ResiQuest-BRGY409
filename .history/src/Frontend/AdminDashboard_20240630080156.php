...
?>
          ...
          <footer class="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
             <ul class="flex items-center flex-wrap mb-6 md:mb-0">
                ...
                <li><a href="#" class="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Contact</a></li>
                <li><a href="https://www.facebook.com/Barangay409" class="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Facebook Page</a></li>
             </ul>
