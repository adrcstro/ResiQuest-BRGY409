...
echo '<dialog id="EditRequestDetails" class="modal p-3">
        <div class="modal-box w-100 max-w-4xl rounded-none">
          ...
          <div id="Edit-modal-content" class="mt-8 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row"></div>
                        ...
                        if (serviceType === "Certificate of Residency" || serviceType === "Certificate of Indigency") {
                            inputFields = `
                                <div class="flex justify-center mb-4">
                                    <input class="w-32 h-8 px-2 mr-2" type="text" name="EditFirstName" placeholder="First Name">
                                    <input class="w-32 h-8 px-2 mr-2" type="text" name="EditMiddleName" placeholder="Middle Name">
                                    <input class="w-32 h-8 px-2" type="text" name="EditLastName" placeholder="Last Name">
                                </div>
                                <div class="flex justify-center mb-4">
                                    <input class="w-32 h-8 px-2 mr-2" type="text" name="EditAddress" placeholder="Address">
                                    <input class="w-32 h-8 px-2" type="text" name="EditPurpose" placeholder="Purpose">
                                </div>
                                <div class="flex justify-center">
                                    <input class="w-32 h-8 px-2 mr-2" type="text" name="EditAnotherField" placeholder="Another Field">
                                    <input class="w-32 h-8 px-2" type="text" name="EditOneMoreField" placeholder="One More Field">
                                </div>
                            `;
                            ...
                            inputFields = `
                                ...
                                <div class="flex justify-center mb-4">
                                    <input class="w-32 h-8 px-2 mr-2" type="text" name="EditAddress" placeholder="Address">
                                    <input class="w-32 h-8 px-2 mr-2" type="text" name="EditBusinessAct" placeholder="Business Activity">
                                    <input class="w-32 h-8 px-2" type="text" name="EditBusinessLoc" placeholder="Business Location">
                                </div>
                                <div class="flex justify-center">
                                    <input class="w-32 h-8 px-2 mr-2" type="text" name="EditAnotherField" placeholder="Another Field">
                                    <input class="w-32 h-8 px-2" type="text" name="EditOneMoreField" placeholder="One More Field">
                            ...
                            inputFields = `
                                ...
                                <div class="flex justify-center mb-4">
                                    <input class="w-32 h-8 px-2 mr-2" type="text" name="EditAddress" placeholder="Address">
                                    <input class="w-32 h-8 px-2 mr-2" type="text" name="EditDateOfBirth" placeholder="Date of Birth">
                                    <input class="w-32 h-8 px-2" type="text" name="EditPlaceOfBirth" placeholder="Place of Birth">
                                </div>
                                <div class="flex justify-center">
                                    <input class="w-32 h-8 px-2 mr-2" type="text" name="EditContactName" placeholder="Contact Name">
                                    <input class="w-32 h-8 px-2 mr-2" type="text" name="EditContactAddress" placeholder="Contact Address">
                                    <input class="w-32 h-8 px-2" type="text" name="EditContactNum" placeholder="Contact Number">
                                </div>
                            `;
                        }
