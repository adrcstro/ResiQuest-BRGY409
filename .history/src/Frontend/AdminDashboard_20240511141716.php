...
<nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
  <ol class="inline-flex items-end space-x-1 md:space-x-2 rtl:space-x-reverse">
    <li class="inline-flex items-center">
      <a href="#" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white" onclick="filterRequests('today')">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white" onclick="filterRequests('today')">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white" onclick="filterRequests('overdue')">
          Over Due
        </a>
      </div>
    </li>
...
<script>
  function filterRequests(type) {
    let rows = document.querySelectorAll('#requests-table tbody tr');
    rows.forEach(row => {
      let dateCell = row.querySelector('.pickup-date');
      let pickupDate = new Date(dateCell.textContent);
      let today = new Date();

      if (type === 'today' && pickupDate.toDateString() !== today.toDateString()) {
        row.style.display = 'none';
      } else if (type === 'overdue' && pickupDate < today) {
        row.style.display = 'none';
      } else {
        row.style.display = '';
      }
