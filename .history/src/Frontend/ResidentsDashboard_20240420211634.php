...
<script>
 $(document).ready(function(){
    $("#submitbrgyResidency").click(function(){
        ...
        if (!firstnamebrgyResidency || !MnamebrgyResidency || !lastnamebrgyResidency || !ServicetypebrgyResidency || !DaterequestedbrgyResidency || !AddressdbrgyResidency || !PurposebrgyResidency) {
            Swal.fire({
                title: 'Error!',
