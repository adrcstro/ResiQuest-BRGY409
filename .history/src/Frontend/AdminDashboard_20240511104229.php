       ...
       <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
        ...
        Mark Released</a></li>
                          ...
                          document.addEventListener("DOMContentLoaded", function () {
                            ...
                            <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                            <div class="sm:flex-1">
                                <label for="company" class="block text-sm font-semibold leading-6 text-gray-900">Set Date</label>
                                <div class="mt-2">
                                    <input  required="" type="date" name="company" id="company" autocomplete="organization"
                            ...
                            <div class="sm:flex-1">
                                <label for="email" class="block text-sm font-semibold leading-6 text-gray-900">Set Time</label>
                                <div class="mt-2">
                                    <input   required="" type="time" name="email" id="email" autocomplete="email"
