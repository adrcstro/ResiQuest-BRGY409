...
$(document).ready(function() {
    $(document).on('click', '.pagination-btn', function() {
        ...
        var url = $('#Allresidenttbl').data('url'); // Get the URL from the data attribute
...
function loadTablepagination(url, page) {
    $.ajax({
        url: url, // Use the URL passed as an argument
        type: 'POST',
        data: {page: page},
        success: function(response) {
...
// Initial load
loadTablepagination('../Backend/AdminTables/residenttable.php', 1); // Use the URL directly here
</script>
