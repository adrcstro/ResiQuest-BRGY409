     ...
     <div class="bg-white h-full  shadow rounded-lg p-4 sm:p-6 xl:p-8  xl:gap-4 my-4">
      ...
      <div class="mb-4 flex flex-col lg:flex-row items-center justify-between">
             ...
             <div class="flex-shrink-0">
                 ...
                 <button class=" w-60 mt-2 relative text-gray-600 border-2 border-gray-200 focus:outline-none focus:bg-gray-100 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100  font-semibold py-2 px-4" onclick="ViewSchedule.showModal()">
