...
<!-- login -------------------------------------------------------------------------------------------------------------->
                ...
                <form action="#" method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="relative">
                        ...
                        <button type="submit" name="submit"
                            class="mt-2 tracking-wide font-semibold bg-blue-700 text-white-500 w-full py-4 rounded-lg hover:bg-blue-500 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
    ...
    <h2 class="text-lg font-semibold text-gray-600">Manage Resident Information</h2>
    ...
    <h2 class="text-lg font-semibold text-gray-600">Manage Request</h2>
    ...
    <h2 class="text-lg font-semibold text-gray-600">Setup Schedule</h2>
    <p class="text-sm text-gray-600">Setup Resident Information</p>
                    ...
                    <!-- Illustration 4 -->
                    <div class="bg-white p-4 rounded-lg shadow-2xl flex flex-col items-center">
    <img src="/Images/MonitorComminity" alt="Illustration" class="w-32 h-auto">
    <h2 class="text-lg font-semibold text-gray-600">Monitor Comminity Status</h2>
