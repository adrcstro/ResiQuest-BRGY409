...
echo '<script>
  ...
  echo '<dialog id="edit-request-modal" class="modal p-3">
  <div class="modal-box w-100 max-w-4xl rounded-none">
      <div id="edit-request-modal-content" class="mt-8 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row"></div>
      <div class="mt-4 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
          <button id="edit-request-modal-close" class="btn btn-sm btn-circle btn-ghost absolute top-2 right-2">
              ✕
          </button>
      </div>
  </div>
