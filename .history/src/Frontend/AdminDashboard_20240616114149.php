...
$(document).ready(function() {
    ...
    $(document).on('click', '.open-resident-details-modal-btn', function() {
        ...
        // Load the resident details into the modal here
        $('#ViewResidentsdetails').show(); // Assuming you have a dialog element with id 'ViewResidentsdetails'
    });

    $(document).on('click', '.edit-residents-btn', function() {
        var residentId = $(this).data('residents-id');
        // Load the resident edit form into the modal here
        $('#EditResidentsdetails').show(); // Assuming you have a dialog element with id 'EditResidentsdetails'
    });

    $(document).on('click', '.delete-residents-btn', function() {
        var residentId = $(this).data('residents-id');
        // Confirm and delete the resident here
    });

    $(document).on('click', '.delete-verify-btn', function() {
        var residentId = $(this).data('residents-id');
        // Confirm and verify the resident here
    });
});
</script>
