          ...
          <div class="bg-white shadow-2xl rounded-lg p-6">
             ...
             <div>
                  ...
                  <div class="flex flex-col sm:flex-row gap-x-6">
                    ...
                    <div class="mt-2">
                        <input value="Certificate of Indigency" type="text" name="ServicetyBClearance" id="ServicetyBClearance" autocomplete="family-name" required
...
<script>
  $(document).ready(function(){
    $("#submitBClearance").click(function(){
     ...
     // Check if any field is empty
if (!firstnamebrgyBClearance || !MnameBClearance || !lastnameBClearance || !BusinessNameBClearance || !BusinessLocBClearance || !DateReqBClearance || !HomeAddBClearance || !ServicetyBClearance) {
    Swal.fire({
        title: 'Error!',
