...
?>
        ...
        <img src="../Backend/uploads/<?php echo $row["AdminProfile"]; ?>" class="h-8 w-8 rounded-full border-4 " alt="Profile Picture">
    <?php else: ?>
        <img src="/Images/brgylogo.png" class="h-8 w-8 rounded-full border-4" alt="Default Profile Picture">
    <?php endif; ?>
             </button>
         </div>
