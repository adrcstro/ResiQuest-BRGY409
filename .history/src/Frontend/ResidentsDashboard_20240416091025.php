  ...
  <div class="modal-box w-full max-w-6xl rounded-none">
    ...
    <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
      ...
      <form id="updateForm" action="../Backend/Update.php" method="post" enctype="multipart/form-data">
                               ...
                               <div class="relative">
                               <div class="relative">
    <input type="file" id="profileFile" name="profileFile" accept=".jpg, .png, .jpeg, .pdf, .doc, .docx" onchange="displaySelectedImage(event)">
    <label for="profileFile">Choose a file...</label>
</div>
<div>
    <?php if(isset($row["Profile"]) && !empty($row["Profile"])): ?>
        <p>Current file: <?php echo $row["Profile"]; ?></p>
    <?php else: ?>
