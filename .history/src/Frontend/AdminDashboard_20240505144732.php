            ...
            <div class="flex flex-col">
                ...
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 xl:gap-4 my-4">
                        ...
                        <div class="flex justify-center mb-4">
                            ...
                            <button class="bg-red-400 hover:bg-red-600 text-white font-bold py-2 px-4 rounded" onclick="window.location.href='?status=Pending'">
...
<button class="bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded" onclick="window.location.href='?status=On-Process'">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<button class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded" onclick="window.location.href='?status=Completed'">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
// Check if a status filter button was clicked
