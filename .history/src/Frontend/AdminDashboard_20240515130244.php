    ...
    <div class="text-center lg:text-left">
        ...
        <span class="text-base font-normal text-gray-500">This is a list Released Documents</span>
             ...
             <div class="flex-shrink-0">
                 ...
                 <div class="flex items-end justify-end mt-2 lg:mt-3 space-x-2">
                     <button class=" w-full relative text-gray-600 border-2 border-gray-200 focus:outline-none focus:bg-gray-100 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100  font-semibold py-2 px-4">
