...
<!-- Pesonal Profile -------------------------------------------------------------------------------------------------------------->
  ...
  <div class="absolute bottom-0 right-0">
    <button onclick="openFileManager()" class="p-2 bg-gray-200 text-black rounded-full hover:bg-gray-400 focus:outline-none focus:bg-gray-700" title="Edit Profile">
