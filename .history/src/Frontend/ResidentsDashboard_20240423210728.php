  ...
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />
              ...
              <ul class="list-disc ml-6 mb-4">
                ...
                <li>Fill up all Nessesarry Fields</li>
              </ul>
</div>
...
<div class=" mt-8 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
<form method="dialog">
<button id="brgyIndigency" class=" inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-500 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400  sm:w-auto sm:text-sm"> 
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
      </svg>
    Submit Request 
...
<script>
  $(document).ready(function(){
    $("#brgyIndigency").click(function(){
     ...
     // Check if any field is empty
if (!firstnamebrgyIndigency || !MnamebrgyIndigency || !lastnamebrgyIndigency || !ServicetypebrgyIndigency || !DaterequestedbrgyIndigency || !AddressbrgyIndigency || !PurposebrgyIndigency) {
    Swal.fire({
        title: 'Error!',
    ...
    return; // Exit the function
        ...
        $.post("../Backend/Insert.php",
        {
          ...
          aterequestedbrgyIndigency: aterequestedbrgyIndigency,
