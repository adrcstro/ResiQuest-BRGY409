...
<script>
    $(document).ready(function () {
        ...
        // Handle click events on the filter links
    ...
    function loadTable(filter) {
        $.ajax({
            url: '../Backend/Scheduleoverduerequest.php',
            type: 'GET',
            data: { filter: filter },
              ...
              <div class="align-middle inline-block min-w-full">
               ...
               document.getElementById("Edit-News-Button").addEventListener("click", function() {
                   ...
                   dialog.close();
                              ...
                              echo "<tr><td colspan='7' class='text-center text-lg text-gray-700'>0 results found</td></tr>";
                           }
