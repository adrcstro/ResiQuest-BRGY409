            ...
            <div class="flex flex-col">
                ...
                <div class="bg-white h-full shadow rounded-lg p-4  sm:p-6 xl:p-8 xl:gap-4 my-4">
                        ...
                        <div class="flex justify-center mb-4">
                            ...
                            <button id="pendingButton" onclick="showPendingrequest()" class="bg-red-400 text-white font-bold py-2 px-4 rounded">
...
<button id="onProcessButton" onclick="showOnprocessrequest()" class="bg-yellow-400 text-white font-bold py-2 px-4 rounded">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<button id="completeButton" onclick="showCompleterequest()" class="bg-green-400 text-white font-bold py-2 px-4 rounded">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<script>
    ...
    document.getElementById('pendingButton').addEventListener('click', () => handleClick('pendingButton'));
    document.getElementById('onProcessButton').addEventListener('click', () => handleClick('onProcessButton'));
    document.getElementById('completeButton').addEventListener('click', () => handleClick('completeButton'));
</script>
