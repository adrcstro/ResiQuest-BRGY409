...
Complete Request
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />
    ...
    <select id="scheduleFilter" class="rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        <option value="all">View All Schedule</option>
        <option value="today">View Schedule Today</option>
    </select>
</div>
<script>document.addEventListener("DOMContentLoaded", function () {
    const scheduleFilter = document.getElementById("scheduleFilter");
    const rows = document.querySelectorAll("#Completedrequesttable tbody tr");

    scheduleFilter.addEventListener("change", function () {
        const selectedValue = scheduleFilter.value;
        rows.forEach(function (row) {
            if (selectedValue === "all" || row.dataset.scheduledFor === selectedValue) {
       ...
       <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
        ...
        Mark Released</a></li>
                          ...
                          document.addEventListener("DOMContentLoaded", function () {
                            ...
                            <div class=" mt-3 flex flex-col sm:flex-row gap-x-6">
                            <div class="sm:flex-1">
                                <label for="setdate" class="block text-sm font-semibold leading-6 text-gray-900">Set Date</label>
                                <div class="mt-2">
                            ...
                            <div class="sm:flex-1">
                                <label for="settime" class="block text-sm font-semibold leading-6 text-gray-900">Set Time</label>
                                <div class="mt-2">
