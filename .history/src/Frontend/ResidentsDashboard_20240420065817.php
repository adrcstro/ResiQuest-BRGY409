...
?>
    ...
    <div class="mt-2.5">
    <select id="civil-status" name="civil-status" autocomplete="family-name" required
    class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
    ...
    <?php endif; ?>
            ...
            <option value="Pending Registration">Pending Registration</option>
                             ...
                             <div class="mt-3">
                              ...
                              <div class="mt-2">
                                  <input  value="<?php echo $row["Citezenship"]?>"  required="" type="text" name="Citizenship" id="Citizenship" autocomplete="Citizenship"
                                      placeholder="Select Citizenship"
                                      class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                        </div>
                  </div>
...
<div class="bg-white shadow-2xl rounded-md p-6 mb-3 mt-4">
    ...
    <div class="mt-8 flex items-center justify-center flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
        <div class="flex flex-col items-center justify-center w-full">
            ...
            <label for="Government-ID" class="flex flex-col items-center justify-center w-full h-64 p-2 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 " style="background-image: url('<?php echo isset($row["GovernmentIDFront"]) && !empty($row["GovernmentIDFront"]) ? "../Backend/uploads/" . $row["GovernmentIDFront"] : ""; ?>'); background-repeat: no-repeat;  background-size: cover; background-position: center;">
        ...
        <div class="flex flex-col items-center justify-center w-full">
            ...
            <label for="Government-ID-back" class="flex flex-col items-center justify-center w-full h-64 p-2 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600" style="background-image: url('<?php echo isset($row["GovernmentIDBack"]) && !empty($row["GovernmentIDBack"]) ? "../Backend/uploads/" . $row["GovernmentIDBack"] : ""; ?>'); background-repeat: no-repeat; background-size: cover; background-position: center;">
...
<!-- List of Requested Documents -------------------------------------------------------------------------------------------------------------->
   ...
   <div  id="ResidentsDocumentsRequested"  style="display: none;" class="absolute bg-gray-50 inset-0 overflow-y-auto lg:ml-64 mt-16">
      <div class="pt-3 px-4">
         <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  xl:gap-4 my-4">
              ...
              <div class="flex flex-wrap justify-center gap-y-0 gap-x-0 items-start">
   <div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2">
      <h2 class="font-semibold text-xl mb-3">Certificate of Residency</h2>
      <div class="flex items-center justify-center">
         <svg class="w-20 h-20  p-1" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" fill="none" viewBox="0 0 24 24" class="w-6 h-6">
   ...
   <div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl  transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2">
      ...
      <div class="flex items-center justify-center">
         <svg class="w-20 h-20  p-1" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M50.0898 13L40.3398 3.29C40.1535 3.10526 39.9021 3.0011 39.6398 3H14.7598C13.3072 3.00264 11.9149 3.58085 10.8878 4.60797C9.86063 5.6351 9.28243 7.02743 9.27979 8.48V49.93C9.28243 51.3826 9.86063 52.7749 10.8878 53.802C11.9149 54.8292 13.3072 55.4074 14.7598 55.41H44.8998C46.3541 55.41 47.749 54.833 48.7783 53.8056C49.8076 52.7781 50.3871 51.3843 50.3898 49.93V13.75C50.3947 13.611 50.3705 13.4725 50.3189 13.3434C50.2672 13.2142 50.1892 13.0973 50.0898 13V13Z" fill="#E6E6E6"/>
            <path d="M50.0898 13L40.3398 3.29C40.1535 3.10526 39.9021 3.0011 39.6398 3H14.7598C13.3072 3.00264 11.9149 3.58085 10.8878 4.60797C9.86063 5.6351 9.28243 7.02743 9.27979 8.48V49.93C9.28243 51.3826 9.86063 52.7749 10.8878 53.802C11.9149 54.8292 13.3072 55.4074 14.7598 55.41H44.8998C46.3541 55.41 47.749 54.833 48.7783 53.8056C49.8076 52.7781 50.3871 51.3843 50.3898 49.93V13.75C50.3947 13.611 50.3705 13.4725 50.3189 13.3434C50.2672 13.2142 50.1892 13.0973 50.0898 13V13ZM43.8798 47.25H16.75V10.71H39.1798L43.8798 15.41V47.25Z" fill="#fff"/>
            <path d="M17.7498 27.29H25.2498V37.81H17.7498V27.29Z" fill="#F0E9E0"/>
            <path d="M33.2598 27.29H40.7598V37.81H33.2598V27.29Z" fill="#F0E9E0"/>
         </svg>
      </div>
      <p class="capitalize text-sm mt-2 mb-2">Fill-out the needed requirements before requesting the documents</p>
      <button class="mt-2 rounded-md bg-gradient-to-r from-blue-400 to-indigo-500 text-xl text-white pt-3 pb-4 px-8 inline" onclick="RequestRecidency.showModal()">Request</button>
   ...
   <div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl  transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2">
      <h2 class="font-semibold text-xl mb-3">Good Moral Certificate</h2>
      <div class="flex items-center justify-center">
         <svg class="w-20 h-20  p-1" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" fill="none" viewBox="0 0 24 24" class="w-6 h-6">
            <g transform="translate(0 -1028.4)">
               <path d="m5 1030.4c-1.1046 0-2 0.9-2 2v8 4 6c0 1.1 0.8954 2 2 2h14c1.105 0 2-0.9 2-2v-6-4-4l-6-6h-10z" fill="#95a5a6"></path>
