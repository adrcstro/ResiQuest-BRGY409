        ...
        <div class="flex flex-col">
            <div class="overflow-x-auto rounded-lg">
                ...
                <div class="flex flex-col lg:flex-row mt-4">
                    <div class="w-full lg:w-1/2 flex items-center justify-center mb-4 lg:mb-0">
                        <img src="/Images/residencyt.svg" alt="Illustration" class="w-full h-auto">
                    </div>
                    <div class="w-full lg:w-1/2 flex items-center justify-center">
    <div class="mt-3 flex flex-col sm:flex-row gap-x-6">
        <div class="sm:flex-1">
            <label for="SelectYear" class="block text-sm font-semibold leading-6 text-gray-900">Select Year</label>
            <select required id="SelectYear" name="SelectYear" autocomplete="family-name"
                    placeholder="Select Year"
                    class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 lg:w-64 xl:w-72">
            </select>
        ...
        <div class="sm:flex-1">
            ...
            <select required id="SelectMonth" name="SelectMonth" autocomplete="family-name"
