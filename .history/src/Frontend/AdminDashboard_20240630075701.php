...
?>
          ...
          <footer class="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
             <ul class="flex items-center flex-wrap mb-6 md:mb-0">
                ...
                <li><a href="https://www.facebook.com/Barangay409" class="text-sm font-normal text-gray-500 hover:underline">Facebook Page</a></li>
             </ul>
             <div class="flex sm:justify-center space-x-6">
                <a href="https://www.facebook.com/Barangay409" class="text-gray-500 hover:text-gray-900">
