    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function filterRequests(filter) {
            requests.forEach(request => {
                const pickUpDate = request.querySelector(".pick-up-date").textContent.trim();
                if (filter === "set-schedule" && pickUpDate !== "") {
                    request.style.display = "none";
                } else if (filter === "view-future-schedule" && isPastDate(pickUpDate)) {
                    request.style.display = "none";
                } else if (filter === "view-todays-schedule" && !isToday(pickUpDate)) {
                    request.style.display = "none";
                } else if (filter === "view-overdue" && !isOverdue(pickUpDate)) {
                    request.style.display = "none";
                } else {
        ...
        document.getElementById("set-schedule").addEventListener("click", function() {
            filterRequests("set-schedule");
        });

        document.getElementById("view-future-schedule").addEventListener("click", function() {
            filterRequests("view-future-schedule");
        });

        document.getElementById("view-todays-schedule").addEventListener("click", function() {
            filterRequests("view-todays-schedule");
        });

        document.getElementById("view-overdue").addEventListener("click", function() {
            filterRequests("view-overdue");
        });
    });
</script>
';

// Your existing PHP code for the closing HTML tags goes here...
