    ...
    <ol class="inline-flex items-end space-x-4 md:space-x-6 rtl:space-x-reverse">
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="#" onclick="applyFilter('overdue'); return false;" class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Over Due</a>
            </div>
        </li>
    </ol>
</nav>
...
function applyFilter(filter) {
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status == 200) {
            ...
            const table = doc.querySelector('#table-container').innerHTML;
