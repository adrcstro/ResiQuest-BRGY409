    ...
    <ol class="inline-flex items-end space-x-4 md:space-x-6 rtl:space-x-reverse">
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="#" onclick="Displayblotterschedtoday()" class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white" >View Today's Schedule</a>
            </div>
        </li>
        <li>
            <div class="flex items-center">
