...
document.addEventListener("DOMContentLoaded", function () {
    ...
    deleteRequestButtons.forEach(function (button) {
        button.addEventListener("click", function () {
            ...
            // Show confirmation dialog with form
            Swal.fire({
                title: "Are you sure?",
                html: `
                    <div class="flex flex-col space-y-2">
                        ...
                        <div class="flex flex-col">
                            <label for="Adminactiondone" class="block text-sm font-medium text-gray-700">action-Done</label>
                            <input value="Edit Info of Resident ${ResidentId}" type="text" name="Adminactiondone" id="Adminactiondone" autocomplete="street-address" 
                                class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
                        </div>
                        <div class="flex flex-col">
                            <label for="categorization" class="block text-sm font-medium text-gray-700">categorization</label>
                        ...
                        <div class="flex flex-col">
                            <label for="DateCreated" class="block text-sm font-medium text-gray-700">Date Created</label>
                            <input value="${new Date().toLocaleDateString()}" type="text" name="DateCreated" id="DateCreated" autocomplete="street-address"
                                class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
                        </div>
                ...
                if (result.isConfirmed) {
                    ...
                    form.innerHTML = `
                        <input type="hidden" name="ADminIDlogs" value="${adminidlogs}">
                        <input type="hidden" name="Adminusername" value="${adminusernamelogs}">
                        <input type="hidden" name="AdminPosition" value="${adminpositionlogs}">
                        <input type="hidden" name="Adminactiondone" value="Edit Info of Resident ${ResidentId}">
                        <input type="hidden" name="categorization" value="Edit">
                        <input type="hidden" name="DateCreated" value="${new Date().toLocaleDateString()}">
                        <input type="hidden" name="resident_id" value="${ResidentId}">
                    `;
