    ...
    if (file) {
      ...
      reader.readAsDataURL(file);
                ...
                <div class="sm:flex-1">
                    ...
                    <input value="<?php echo $row["AdminID"]?>" required="" type="text" name="AdminsID" id="AdminsID" autocomplete="street-address" placeholder="Registered ID"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
                </div>
                <div class="sm:flex-1">
...
<script>
  $(document).ready(function() {
    $("#saveadmininfo").click(function(e) {
      e.preventDefault(); // Prevent default form submission

      var AdminsID = $("#AdminsID").val();
      var AdminEditFirstName = $("input[name='AdminEditFirstName']").val();
      var AdminEditMiddleName = $("input[name='AdminEditMiddleName']").val();
      var AdminEditLastName = $("input[name='AdminEditLastName']").val();
      var AdminGender = $("select[name='AdminGender']").val();
      var AdminEmail = $("input[name='AdminEmail']").val();
      var AdminPosition = $("select[name='AdminPosition']").val();
      var AdminPRofile = $("input[name='AdminPRofile']").prop('files')[0];
      var formData = new FormData();
      formData.append('AdminsID', AdminsID);
      formData.append('AdminEditFirstName', AdminEditFirstName);
      formData.append('AdminEditMiddleName', AdminEditMiddleName);
      formData.append('AdminEditLastName', AdminEditLastName);
...
document.getElementById('saveadmininfo').addEventListener('click', function() {
