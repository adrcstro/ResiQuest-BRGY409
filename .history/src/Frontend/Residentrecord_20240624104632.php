...
Add Residents Information
    ...
    <ol class="flex flex-wrap items-center space-x-2 sm:space-x-4 md:space-x-6 rtl:space-x-reverse">
        ...
        <li class="flex items-center">
            ...
            <a href="#"  class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white ml-1 sm:ml-2">Male Resident</a>
        </li>
        <li class="flex items-center">
            <svg class="rtl:rotate-180 block w-3 h-3 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4" />
            ...
            <a href="#"  class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white ml-1 sm:ml-2">Female Resident</a>
        </li>
        <li class="flex items-center">
            ...
            <a href="#"  class="text-sm font-medium text-gray-700 focus:outline-none focus:text-blue-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white ml-1 sm:ml-2">Senior Resident</a>
        </li>
    </ol>
</nav>
