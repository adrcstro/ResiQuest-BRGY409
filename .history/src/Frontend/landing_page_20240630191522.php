...
<div class="bg-secondary">
  ...
  <!-- card container -->
  <div class="card-container flex items-center justify-between bg-white p-4 rounded-lg shadow-lg">
    <div class="flex flex-col items-start space-y-3 text-left">
      <h5 class="text-xl font-semibold">Andre Thomas Liquido Castro</h5>
      <p class="text-gray-500">Resident ID: 42025748</p>
      <button class="rounded-full bg-blue-500 text-white py-2 px-4 hover:bg-blue-600" onclick="viewMessage()">View Message</button>
    </div>
    <div class="flex-shrink-0 ml-4">
      <img class="h-16 w-16 rounded-full" src="/Images/News.svg" alt="Resident Image" />
    </div>
  </div>
  ...
  <div class="card-container flex items-center justify-between bg-white p-4 rounded-lg shadow-lg">
    ...
    <div class="flex-shrink-0 ml-4">
      <img class="h-16 w-16 rounded-full" src="/Images/Documents.svg" alt="Resident Image" />
    </div>
  </div>
  <div class="card-container flex items-center justify-between bg-white p-4 rounded-lg shadow-lg">
    <div class="flex flex-col items-start space-y-3 text-left">
    ...
    <div class="flex-shrink-0 ml-4">
      <img class="h-16 w-16 rounded-full" src="/Images/New team members.svg" alt="Resident Image" />
    </div>
  </div>
</div>
...
function viewMessage() {
  // Your function to handle button click
}
</script>
