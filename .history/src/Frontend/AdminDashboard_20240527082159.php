    ...
    <div class="text-center lg:text-left">
        ...
        <span class="text-base font-normal text-gray-500">This is a list of Residents Requested Documents</span>
                            ...
                            <div class="flex-shrink-0">
                                ...
                                <div class="lg:flex lg:items-center lg:pl-32">
                     <button class="mt-3 w-full relative text-white border-2 border-gray-200  bg-red-400 dark:bg-gray-800 dark:border-gray-700 hover:bg-red-500  font-semibold py-2 px-4">
