    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while($row = mysqli_fetch_assoc($result)) {
          if ($row["Status"] !== "Completed") {
            ...
            <ul id="dropdownMenu" class="hidden absolute bg-white border rounded mt-1 py-1 right-0 shadow-md">
                <li class="hover:bg-gray-100">
                    <a href="#" class="block px-4 py-2 text-gray-800">Option 1</a>
                </li>
                <li class="hover:bg-gray-100">
                    <a href="#" class="block px-4 py-2 text-gray-800">Option 2</a>
                </li>
                <li class="hover:bg-gray-100">
                    <a href="#" class="block px-4 py-2 text-gray-800">Option 3</a>
                </li>
            </ul>
        </td>';
