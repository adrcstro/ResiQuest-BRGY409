  ...
  if ($row["Status"] !== "Completed" && $row["Status"] !== "Released") {
    {
      ...
      <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
         ...
         View Details</a></li>
         <li class="edit-request-btn" data-request-id="' . $row["RequestID"] . '">
  <a class="modal-open" data-modal="editRequestModal">Edit Request</a>
</li>
...
echo'<div id="editRequestModal" class="modal" data-modal="editRequestModal">
<div class="modal-box">
  <button class="modal-close" data-modal-close="editRequestModal">
  ...
  <form id="editRequestForm" class="space-y-4">
    ...
    <div class="form-control">
      ...
      <input type="text" id="firstName" name="firstName" placeholder="First Name" class="input input-bordered">
    </div>
    <div class="form-control">
      <label class="label">
        <span class="label-text">Middle Name</span>
      </label>
      <input type="text" id="middleName" name="middleName" placeholder="Middle Name" class="input input-bordered">
    </div>
    <div class="form-control">
      <label class="label">
        <span class="label-text">Last Name</span>
      </label>
      <input type="text" id="lastName" name="lastName" placeholder="Last Name" class="input input-bordered">
    </div>
    <div class="form-control">
      <label class="label">
    ...
    <div class="form-control" id="additionalFields" style="display: none;">
      <!-- Additional fields based on the service type -->
    </div>
    <!-- Buttons to submit or cancel the update operation -->
    <div class="flex justify-end">
      <button type="submit" class="btn btn-primary">Update</button>
      <button type="button" class="btn btn-outline" data-modal-close="editRequestModal">Cancel</button>
    </div>
  </form>
</div>
</div>
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const closeEditModalButtons = document.querySelectorAll("[data-modal-close]");
    const editRequestForm = document.getElementById("editRequestForm");
    const additionalFieldsContainer = document.getElementById("additionalFields");

    // Open modal when "Edit Request" button is clicked
    editRequestButtons.forEach(function (button) {
      button.addEventListener("click", function () {
        const requestId = button.getAttribute("data-request-id");
        document.getElementById("requestID").value = requestId;
        editRequestModal.classList.add("modal-open");

        // Show additional fields based on service type
    ...
    closeEditModalButtons.forEach(function (closeButton) {
      closeButton.addEventListener("click", function () {
        editRequestModal.classList.remove("modal-open");
      });
    });

    // Submit form data to Update.php
    ...
    // Function to show additional fields based on service type
    function showAdditionalFields(serviceType) {
      additionalFieldsContainer.innerHTML = ""; // Clear previous fields

      switch (serviceType) {
        case "Certificate of Residency":
        case "Certificate of Indigency":
          // Show fields for Certificate of Residency and Indigency
          additionalFieldsContainer.innerHTML = `
            <div class="form-control">
              <label class="label">
                <span class="label-text">Purpose</span>
              </label>
              <input type="text" id="purpose" name="purpose" placeholder="Purpose" class="input input-bordered">
            </div>
          `;
          break;
        case "Business Clearance":
          // Show fields for Business Clearance
          additionalFieldsContainer.innerHTML = `
            <div class="form-control">
              <label class="label">
                <span class="label-text">Business Activity</span>
              </label>
              <input type="text" id="businessAct" name="businessAct" placeholder="Business Activity" class="input input-bordered">
            </div>
            <div class="form-control">
              <label class="label">
                <span class="label-text">Business Location</span>
              </label>
              <input type="text" id="businessLoc" name="businessLoc" placeholder="Business Location" class="input input-bordered">
            </div>
          `;
          break;
        case "Barangay Identification":
          // Show fields for Barangay Identification
          additionalFieldsContainer.innerHTML = `
            <div class="form-control">
              <label class="label">
                <span class="label-text">Date of Birth</span>
              </label>
              <input type="text" id="dateOfBirth" name="dateOfBirth" placeholder="Date of Birth" class="input input-bordered">
            </div>
            <!-- Add other fields as needed -->
          `;
          break;
        default:
          // No additional fields for other service types
          break;
      }
    }
  });
