...
?>
<button  onclick="showCompleterequest()"  class="relative text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 py-2 px-4 rounded">
