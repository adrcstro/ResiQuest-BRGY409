...
if(mysqli_num_rows($result) > 0) {
   ...
   while($row = mysqli_fetch_assoc($result)) {
      ...
      switch ($row["Status"]) {
       ...
       echo '<tr>';
       echo '<td class="p-3 border border-inherit text-center  whitespace-nowrap text-sm font-semibold text-gray-900"><img src="uploads/' . $row["Profile"] . '" alt="Item Image" width="60"></td>';
