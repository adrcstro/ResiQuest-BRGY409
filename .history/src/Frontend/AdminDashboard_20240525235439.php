    ...
    <?php endif; ?>
        ...
        <option value="Barangay Tanod">Barangay Tanod</option>
                ...
                <div class="sm:flex-1 mt-2">
                        <label for="RenderedService" class="block text-sm font-semibold leading-6 text-gray-900">Rendered Service</label>
                        <select required id="RenderedService" name="RenderedService" autocomplete="family-name"
                placeholder="Select Voter Status"
                class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                <?php if (!empty($row["RenderedService"])): ?>
        <option value="<?php echo $row["RenderedService"]; ?>" selected><?php echo $row["RenderedService"]; ?></option>
    <?php else: ?>
      <option value="" disabled selected>Select Rendered Service</option>
    <?php endif; ?>
        <option value="Barangay Chairman">Barangay Chairman</option>
        <option value="Barangay Kagawad">Barangay Kagawad</option>
        <option value="Barangay Secretary">Barangay Secretary</option>
