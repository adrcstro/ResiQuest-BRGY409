...
?>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z" />
      ...
      <a href="#" @click="isOpen = true" class="hidden"  class="text-sm font-normal text-gray-500 hover:underline">Terms and conditions</a>
    </li>
    <li class="flex items-center mr-4 md:mr-6">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-500 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
</svg>
      <a href="#" class="text-sm font-normal text-gray-500 hover:underline">Privacy Policy</a>
    </li>
    <li class="flex items-center mr-4 md:mr-6">
    <svg class="w-5 h-5 text-gray-500 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <a href="https://www.facebook.com/Barangay409" class="text-sm font-normal text-gray-500 hover:underline">Facebook Page</a>
    </li>
  </ul>

  <div id="privacyPolicyModal" x-data="{ isOpen: false }" x-cloak>
    <!-- Modal backdrop -->
    <div x-show="isOpen" class="fixed z-10 inset-0 overflow-y-auto bg-black bg-opacity-50 flex items-center justify-center">
        <!-- Modal dialog -->
        <div class="bg-blue-600 rounded-lg overflow-hidden shadow-xl max-w-screen-md w-full m-4" x-show="isOpen" @click.away="isOpen = false">
            <div class="px-6 py-4 flex items-center justify-between">
                <h3 class="text-lg leading-6 font-medium text-white">Terms and Conditions</h3>
                <!-- Close button -->
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6 text-white cursor-pointer" @click="isOpen = false">
