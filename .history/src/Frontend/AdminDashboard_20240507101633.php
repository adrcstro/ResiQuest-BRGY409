  ...
  openModalButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      ...
      modalContent.innerHTML = `
        <input value="${ID}" type="text" id="resident-name" name="resident-name" placeholder="Name" />
        <input type="text" id="resident-age" name="resident-age" placeholder="Age" />
        <input type="text" id="resident-address" name="resident-address" placeholder="Address" />
        <button id="submit-resident-details">Save</button>
      `;
