        ...
        echo '<table class="min-w-full divide-y divide-gray-200 mb-20">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Date Requested</th>
                        <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                        <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Schedule for Release</th>
                        <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Action</th>
                    </tr>
                </thead>
                <tbody class="bg-white">';
        ...
        // Fetch and display each row
          ...
          while($row = mysqli_fetch_assoc($result)) {
            if ($row["Status"] !== "Completed") {
              ...
              <li class="open-modal-btn" data-request-id="' . $row["RequestID"] . '" data-service-type="' . $row["ServiceType"] . '"><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  ...
  openModalButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      ...
      if (serviceType === "Certificate of Residency" || serviceType === "Certificate of Indigency") {
        url = "../Backend/fetch_request_details_certificate.php?request_id=" + requestId;
      } else if (serviceType === "Business Clearance") {
        url = "../Backend/fetch_request_details_business.php?request_id=" + requestId;
      } else if (serviceType === "Barangay Identification") {
        url = "../Backend/fetch_request_details_barangay.php?request_id=" + requestId;
      }
