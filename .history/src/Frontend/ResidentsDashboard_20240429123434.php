                    ...
                    .then(data => {
                        ...
                        if (serviceType === "Certificate of Residency" || serviceType === "Certificate of Indigency") {
                            ...
                            inputFields = `
                                ...
                                <input type="text" name="LastName" placeholder="Last Name" value="${lastName}">
                                <input type="text" name="Address" placeholder="Address" value="${address}">
                                <input type="text" name="BusinessAct" placeholder="Business Activity" value="${businessAct}">
                                <input type="text" name="BusinessLoc" placeholder="Business Location" value="${businessLoc}">
                            `;
                            ...
                            inputFields = `
                                ...
                                <input type="text" name="LastName" placeholder="Last Name" value="${lastName}">
                                <input type="text" name="Address" placeholder="Address" value="${address}">
                                <input type="text" name="DateOfBirth" placeholder="Date of Birth" value="${dateOfBirth}">
                                <input type="text" name="PlaceOfBirth" placeholder="Place of Birth" value="${placeOfBirth}">
                                <input type="text" name="ContactName" placeholder="Contact Name" value="${contactName}">
                                <input type="text" name="ContactAddress" placeholder="Contact Address" value="${contactAddress}">
                                <input type="text" name="ContactNum" placeholder="Contact Number" value="${contactNum}">
                            `;
                        }
