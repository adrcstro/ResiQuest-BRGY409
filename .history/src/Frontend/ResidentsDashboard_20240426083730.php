    ...
    <div class="mt-2">
        <select required name="PurposebrgyResidency" id="PurposebrgyResidency" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
            ...
            <option value="Other">Other</option>
                ...
                <div class="hidden">
                    <label for="DocumentStatbrgyResidency" class="block text-sm font-semibold leading-6 text-gray-900 mt-6">UserID</label>
                    <div class="mt-2">
                        <input value="<?php echo $row["ID"]?>" type="text" name="DocumentStatbrgyResidency" id="DocumentStatbrgyResidency" autocomplete="family-name" required
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6" >
                    </div>
                </div>
