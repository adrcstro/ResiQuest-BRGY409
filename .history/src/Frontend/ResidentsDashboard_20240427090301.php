      ...
      <div class="mb-4 flex flex-col lg:flex-row items-center justify-between">
             ...
             <div class="flex-shrink-0">
                 ...
                 <div class="flex justify-end mt-2 lg:mt-3 space-x-2">
                     <button class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded" onclick="ViewHistoryRequest.showModal()"  >
         ...
         <dialog id="ViewHistoryRequest" class="modal p-3">
  <div class="modal-box w-full max-w-6xl rounded-none">
    <div class="bg-blue-500 shadow-2xl rounded-md p-6">
        <div class="mb-2 lg:mb-0">
            <h3 class="text-2xl font-bold text-white text-center">BRGY-409 Document Request Management System</h3>
            <span class="flex text-base font-medium text-white justify-center text-center">List of Completed Transactions</span>
        </div>
    </div>
        ...
        // Fetch and display each row
          ...
          while($row = mysqli_fetch_assoc($result)) {
            if ($row["Status"] !== "Completed") {
              // Display the row only if the status is not "Completed"
              echo '<tr class="mt-20">';
              echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["RequestID"] . '</td>';
              echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["ServiceType"] . '</td>';
              echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["DateRequested"] . '</td>';
              echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900 ">' . $row["Status"] . '</td>';
              echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["PickUpDate"] . '</td>';
              echo '<td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">
              <div class="dropdown dropdown-left dropdown-end">
              <div tabindex="0" role="button" class="text-white font-semibold btn w-40 bg-blue-400 hover:bg-blue-500">Action</div>
              <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52 mt-2">
                  <li class="open-modal-btn" data-request-id="' . $row["RequestID"] . '"><a><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 8h4m1 0h2m-2 0h2m-2 0h2m-6 0H7m-1 0H4m2 0H2m2 0H2m6 0h4m1 0h2m-2 0h2m-2 0h2m-6 0H7m-1 0H4m2 0H2m2 0H2m6 0h4m1 0h2m-2 0h2m-2 0h2m-6 0H7m-1 0H4m2 0H2m2 0H2m6 0h4m1 0h2m-2 0h2m-2 0h2m-6 0H7m-1 0H4m2 0H2m2 0H2m6 0h4m1 0h2m-2 0h2m-2 0h2m-6 0H7m-1 0H4m2 0H2m2 0H2m6 0h4m1 0h2m-2 0h2m-2 0h2m-6 0H7m-1 0H4m2 0H2m2 0H2m6 0h4m1 0h2m-2 0h2m-2 0h2m-6 0H7m-1 0H4m2 0H2m2 0H2m6 0h4m1 0h2"/></svg> View Details</a></li>
                  <li><a><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 8a2 2 0 00-2-2h-4a2 2 0 00-2 2v11a2 2 0 002 2h4a2 2 0 002-2V8zM8 9v4m0 0l3-3m-3 3l-3-3"/></svg> Edit Request</a></li>
                  <li><a><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6a2 2 0 012-2h14a2 2 0 012 2M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2m-3 6l-1.5 5.5M12 6v14"/></svg> Delete Request</a></li>
              </ul>
          </div>
        </td>';
    echo '</tr>';
...
<!-- modal for document request edit--->




<!-- modal for document request View--->
