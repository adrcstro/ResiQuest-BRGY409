...
<div class="sm:flex-1">
    ...
    <?php endif; ?>
        ...
        <option value="Barangay Tanod">Barangay Tanod</option>
            ...
            <button id="SubmitAdminInfo" class="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-500 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm"> 
...
<script>
$(function() {
    $('#SubmitAdminInfo').click(function(e) {
        e.preventDefault();
