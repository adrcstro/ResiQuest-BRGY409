...
Sign out</a></li>
  ...
  <div class="modal-box w-100 max-w-4xl rounded-lg ">
    ...
    <form id="updateadminform" action="../Backend/Update.php" method="post" enctype="multipart/form-data">
  ...
  <script>
    ...
    if (file) {
      ...
      reader.readAsDataURL(file);
                ...
                <div class="sm:flex-1">
                    <label for="AdminEditAddress" class="block text-sm font-medium text-gray-700">Administrator ID</label>
                    <input value="<?php echo $row["AdminID"]?>" disabled required="" type="text" name="AdminEditAddress" id="AdminEditAddress" autocomplete="street-address" placeholder="Registered ID"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-2">
                </div>
...
<button id="saveadmininfo"  class="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-500 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm"> 
