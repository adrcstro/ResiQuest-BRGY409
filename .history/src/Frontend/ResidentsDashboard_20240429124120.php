...
echo '<script>
  ...
  <div class="modal-box w-100 max-w-4xl rounded-none">
      ...
      <form id="edit-request-form" class="mt-8 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row" action="../Backend/Update.php" method="post">
          <div id="Edit-modal-content"></div>
          <div class="mt-4 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
              <button type="submit" class="btn btn-sm btn-circle btn-ghost">Submit</button>
              <button id="edit-close-modal-btn" class="btn btn-sm btn-circle btn-ghost absolute top-2 right-2">✕</button>
          </div>
      </form>
  </div>
</dialog>';
