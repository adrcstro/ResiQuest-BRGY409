    ...
    <div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-sm mx-auto mt-2 sm:m-2">
        <div class="flex justify-between items-center">
            ...
            <div class="text-left ml-4">
                ...
                <p class="capitalize text-sm mt-2 mb-2">Fill-Out The Needed Details Before Submmiting Report</p>
                <button class="mt-2 rounded-md bg-gradient-to-r from-blue-400 to-indigo-500 text-xl text-white pt-1 pb-2 px-8 inline" onclick="RequestbrgyID.showModal()">File Report</button>
            </div>
        </div>
    </div>
