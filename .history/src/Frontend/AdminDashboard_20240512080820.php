                        ...
                        button.addEventListener("click", function () {
                            ...
                            switch(servietype) {
                                ...
                                case "Certificate of Indigency":
                                    document.getElementById("printdocument-btn").setAttribute("data-href", "../Backend/GenerateResidenIndigen.php");
                                    break;
                                case "Business Clearance":
                                    document.getElementById("printdocument-btn").setAttribute("data-href", "../Backend/GenerateBusinessClerancen.php");
                                    break;
                                case "Barangay Identification":
                                    document.getElementById("printdocument-btn").setAttribute("data-href", "../Backend/GenerateBrgyForm.php");
                                    break;
                                default:
