...
<div class="bg-white py-4 px-5 text-center w-full rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2 flex items-center">
    <div class="w-20 h-20 p-1">
        <svg xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" fill="none" viewBox="0 0 24 24" class="w-6 h-6">
...
<div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2 flex items-center">
    <div class="w-20 h-20 p-1">
        <svg xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" fill="none" viewBox="0 0 24 24" class="w-6 h-6">
            <g transform="translate(0 -1028.4)">
                <path d="m5 1030.4c-1.1046 0-2 0.9-2 2v8 4 6c0 1.1 0.8954 2 2 2h14c1.105 0 2-0.9 2-2v-6-4-4l-6-6h-10z" fill="#95a5a6"></path>
    ...
    <div class="ml-4 text-left">
        <h2 class="font-semibold text-xl mb-3">Business Permit</h2>
        <p class="capitalize text-sm mt-2 mb-2">Secure your Business Permit before operating</p>
        <button class="mt-2 rounded-md bg-gradient-to-r from-blue-400 to-indigo-500 text-xl text-white pt-3 pb-4 px-8 inline" onclick="RequestBusinessPermit.showModal()">Request</button>
    </div>
</div>
...
<div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2 flex items-center">
    ...
    <div class="ml-4 text-left">
        <h2 class="font-semibold text-xl mb-3">Building Permit</h2>
        <p class="capitalize text-sm mt-2 mb-2">Ensure compliance with building regulations</p>
        <button class="mt-2 rounded-md bg-gradient-to-r from-blue-400 to-indigo-500 text-xl text-white pt-3 pb-4 px-8 inline" onclick="RequestBuildingPermit.showModal()">Request</button>
    </div>
</div>
...
<div class="bg-white py-4 px-5 text-center rounded-md shadow-2xl transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto mt-2 sm:m-2 flex items-center">
    ...
    <div class="ml-4 text-left">
        <h2 class="font-semibold text-xl mb-3">Barangay Clearance</h2>
        <p class="capitalize text-sm mt-2 mb-2">Obtain barangay clearance for legal transactions</p>
        <button class="mt-2 rounded-md bg-gradient-to-r from-blue-400 to-indigo-500 text-xl text-white pt-3 pb-4 px-8 inline" onclick="RequestBarangayClearance.showModal()">Request</button>
    </div>
</div>
