...
document.addEventListener("DOMContentLoaded", function () {
  ...
  closeModalButton.addEventListener("click", function () {
    ...
    <a href="?filter=empty" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white" data-filter="empty">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="rtl:rotate-180 block w-3 h-3 mx-1 text-gray-400">
        ...
        Set Schedule
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white" data-filter="today">View Today's Schedule</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white" data-filter="overdue">View Over Due</a>
                </div>
            </li>
        </ol>
    </nav>
