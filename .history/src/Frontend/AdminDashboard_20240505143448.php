            ...
            <div class="flex flex-col">
                ...
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 xl:gap-4 my-4">
                        ...
                        <div class="flex justify-center mb-4">
                            ...
                            <script>
    // Function to handle button clicks and update table using AJAX
    function showRequests(status) {
        ...
        xhr.onload = function() {
            ...
            if (xhr.status >= 200 && xhr.status < 300) {
                // Update the table container with the response HTML
                document.getElementById('requestTableContainer').innerHTML = xhr.responseText;
            } else {
                // Handle error
...
<!-- Update button attributes to trigger JavaScript functions -->
<button onclick="showRequests('Pending')" class="bg-red-400 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">
...
<button onclick="showRequests('On-Process')" class="bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
<button onclick="showRequests('Completed')" class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-5 h-5 inline-block align-middle text-white">
...
// SQL query to select requests based on status
$query = "SELECT * FROM requestdocument WHERE Status='$status'";
$result = mysqli_query($conn, $query);
