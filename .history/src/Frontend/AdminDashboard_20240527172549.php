...
if (!empty($_SESSION["AdminID"])) {
    ...
    $sql = "SELECT COUNT(*) AS pending_count FROM complaintbl WHERE status = 'Pending'";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $totalCount = $row["pending_count"];
...
if (!empty($_SESSION["AdminID"])) {
    ...
    $sql = "SELECT COUNT(*) AS pending_count FROM complaintbl WHERE status = 'On-Schedule'";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $totalCountonprocess = $row["pending_count"];
...
if (!empty($_SESSION["AdminID"])) {
    ...
    $sql = "SELECT COUNT(*) AS pending_count FROM complaintbl WHERE status = 'Completed'";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $totalCouncompleted = $row["pending_count"];
