...
document.addEventListener("DOMContentLoaded", function () {
    ...
    openModalButtons.forEach(function (button) {
        button.addEventListener("click", function () {
            ...
            const data-contactpersonname = button.getAttribute("data-dateofbirth");
            const contactpersonnumber = button.getAttribute("data-palceofbirth");
            const contactpersonaddress = button.getAttribute("data-sssgsis");
