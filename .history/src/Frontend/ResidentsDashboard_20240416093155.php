...
<div>
    <nav class="bg-white border-b border-gray-200 fixed z-30 w-full">
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-5 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <img src="../Backend/uploads/<?php echo $row["Profile"]; ?>" class="h-8 w-8 rounded-full border border-blue-600" alt="Profile Picture">
    <?php else: ?>
        <img src="/Images/blank.png" class="h-8 w-8 rounded-full border border-blue-600" alt="Default Profile Picture">
    <?php endif; ?>
             </button>
         </div>
         <div id="user-menu"
...
<dialog id="ViewGovernmentID" class="modal">
  <div class="modal-box w-full max-w-6xl rounded-none">
    ...
    <img src="../Backend/uploads/<?php echo $row["GovernmentID"]; ?>" class="w-32 h-32 bg-gray-300 rounded-none mb-4" alt="ID">
  ...
  <div class="modal-box w-full max-w-6xl rounded-none">
    ...
    <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
      ...
      <form id="updateForm" action="../Backend/Update.php" method="post" enctype="multipart/form-data">
                               ...
                               <div class="relative">
  <input value="<?php echo $row["Profile"]?>" type="file" id="PRofile" name="PRofile" class="hidden" accept=".jpg, .png .jpeg .pdf, .doc, .docx" onchange="displaySelectedImage(event)">


  <div class="relative">
    <?php if(isset($row["Profile"]) && !empty($row["Profile"])): ?>
        <img id="profilePicture" src="../Backend/uploads/<?php echo $row["Profile"]; ?>" class="w-32 h-32 bg-gray-300 rounded-full  mb-4 border-2 border-blue-600" alt="Profile Picture">
    <?php else: ?>
        <img id="profilePicture"  src="/Images/blank.png" class="w-32 h-32 bg-gray-300 rounded-full mb-4 border-2 border-indigo-600" alt="Default Profile Picture">
    <?php endif; ?>
