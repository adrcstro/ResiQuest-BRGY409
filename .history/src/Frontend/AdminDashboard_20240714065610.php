                        ...
                        <div class="mt-3 flex flex-col sm:flex-col gap-y-6">
                            <div class="flex flex-row items-center justify-center gap-x-6">
                                <div class="flex items-center  border border-gray-200 rounded dark:border-gray-700 w-64 lg:w-72 p-4">
                                    <input id="DocRequest" type="radio" value="" name="DocRequest" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="DocRequest" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Document Request</label>
                                </div>
                                <div class="flex items-center border border-gray-200 rounded dark:border-gray-700 w-64 lg:w-72 p-4">
                                    <input checked id="ComplaintReport" type="radio" value="" name="ComplaintReport" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="ComplaintReport" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Complaint/Blotter Report</label>
                                </div>
                            </div>
