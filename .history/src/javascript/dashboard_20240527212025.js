...
function showPendingComplaint() {
    ...
    document.getElementById('OnprocessBlottertable').style.display = 'none';
    document.getElementById('CompleteBlottertable').style.display = 'none';
}


function displayOnProcessComplaint() {
    document.getElementById('PendingBlottertablee').style.display = 'none';
    document.getElementById('OnprocessBlottertable').style.display = 'block';
    document.getElementById('CompleteBlottertable').style.display = 'none';
}
