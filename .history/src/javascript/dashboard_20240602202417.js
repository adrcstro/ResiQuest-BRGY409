...
function showsetBlotterschedule() {
    ...
    document.getElementById('OverdueScheduleBlotter').style.display = 'none';
}
...
function showblottertoday() {
    document.getElementById('BlotterSetschedule').style.display = 'none';
    document.getElementById('BlotterFutureSchedule').style.display = 'none';
    document.getElementById('TodaysScheduleBlotter').style.display = 'block';
    document.getElementById('OverdueScheduleBlotter').style.display = 'none';
}
function showblotteroverdue() {
    document.getElementById('BlotterSetschedule').style.display = 'none';
    document.getElementById('BlotterFutureSchedule').style.display = 'none';
    document.getElementById('TodaysScheduleBlotter').style.display = 'none';
    document.getElementById('OverdueScheduleBlotter').style.display = 'block';
}
...
//admin displaty all resident 
function displayallresident() {
    document.getElementById('Allresidenttbl').style.display = 'block';
    document.getElementById('Maleresidenttbl').style.display = 'none';
    document.getElementById('Femaleresidenttbl').style.display = 'none';
    document.getElementById('Seniorresidenttbl').style.display = 'none';
}
function displayMaleresident() {
    document.getElementById('Allresidenttbl').style.display = 'none';
    document.getElementById('Maleresidenttbl').style.display = 'block';
    document.getElementById('Femaleresidenttbl').style.display = 'none';
    document.getElementById('Seniorresidenttbl').style.display = 'none';
}
function displayFemaleresident() {
    document.getElementById('Allresidenttbl').style.display = 'none';
    document.getElementById('Maleresidenttbl').style.display = 'none';
    document.getElementById('Femaleresidenttbl').style.display = 'block';
    document.getElementById('Seniorresidenttbl').style.display = 'none';
}
function displaySenioreresident() {
    document.getElementById('Allresidenttbl').style.display = 'none';
    document.getElementById('Maleresidenttbl').style.display = 'none';
    document.getElementById('Femaleresidenttbl').style.display = 'none';
    document.getElementById('Seniorresidenttbl').style.display = 'block';
}
