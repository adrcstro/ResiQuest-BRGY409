...
function showsetBlotterschedule() {
    ...
    document.getElementById('BlotterTodaysSchedule').style.display = 'none';
    document.getElementById('BlotterOverdueSchedule').style.display = 'none';
}
...
function showtodaysBlotterschedule() {
    document.getElementById('BlotterSetschedule').style.display = 'none';
    document.getElementById('BlotterFutureSchedule').style.display = 'none';
    document.getElementById('BlotterTodaysSchedule').style.display = 'block';
    document.getElementById('BlotterOverdueSchedule').style.display = 'none';
}
function showoverdueBlotterschedule() {
    document.getElementById('BlotterSetschedule').style.display = 'none';
    document.getElementById('BlotterFutureSchedule').style.display = 'none';
    document.getElementById('BlotterTodaysSchedule').style.display = 'none';
    document.getElementById('BlotterOverdueSchedule').style.display = 'block';
}
