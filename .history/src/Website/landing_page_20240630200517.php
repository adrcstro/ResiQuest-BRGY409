          ...
          <div class="hidden  items-center justify-center w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex md:items-center flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-transparent md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent">
              ...
              <div class="grid grid-rows-2 md:grid-rows-1 md:grid-cols-2 gap-2 mt-2 md:mt-0">
                <button onclick="redirectTo('../frontend/Login.php')" class="text-white bg-blue-700 bg-opacity-90 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2"><a href="Login.php">
                  Login
                </a>
                </button>
                <button onclick="redirectTo('../frontend/signup.php')" class="text-primary hover:text-white border border-blue-700 hover:bg-blue-800 hover:border-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 text-center"><a href="signup.php">
                  Sign up
                </a>
                </button>
              </div>
