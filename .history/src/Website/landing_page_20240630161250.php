...
<div class="bg-secondary">
  ...
  <div class="flex pt-52 justify-center">
    <div class="text-center">
      ...
      <h1 class="text-white text-6xl lg:text-5xl xl:text-6xl font-bold pt-3 pb-5">Document Request And Complaint Management System</h1>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 lg:flex items-start text-center py-auto mt-40 md:mx-20 gap-4 rounded-lg">
    <!-- card container -->
    <div class="card-container flex flex-row items-center p-4 bg-gray-800 rounded-lg text-left">
      ...
      <div class="ml-4 flex-grow">
        ...
        <p class="font-extralight text-white">Stay updated with the latest news and announcements from our community.</p>
        <div class="flex justify-start items-end py-4">
    ...
    <div class="card-container flex flex-row items-center p-4 bg-gray-800 rounded-lg text-left">
      ...
      <div class="ml-4 flex-grow">
        ...
        <p class="font-extralight text-white">Get your documents processed efficiently with our document issuance services.</p>
        <div class="flex justify-start items-end py-4">
    ...
    <div class="card-container flex flex-row items-center p-4 bg-gray-800 rounded-lg text-left">
      ...
      <div class="ml-4 flex-grow">
        ...
        <p class="font-extralight text-white">Meet our new barangay officials and learn about their roles in our barangay.</p>
        <div class="flex justify-start items-end py-4">
    ...
    <section class="bg-white mt-32 pt-10 lg:mt-32 z-50 px-4 md:px-10" id="services">
  ...
  <!-- card columns -->
  <div class="mt-6 grid grid-cols-1 lg:grid-cols-3 p-6 md:p-12 lg:p-24 py-auto md:mx-20 gap-4 rounded-lg">
    <!-- card container -->
