...
<div class="bg-secondary">
  ...
  <div>
      ...
      <div class="relative mx-16 lg:mx-20">
        ...
        <div class="flex pt-52 justify-center">
          <div class="text-center">
            ...
            <h1 class="text-white text-5xl lg:text-5xl xl:text-6xl font-bold pt-3 pb-5">Document Request And Complaint Management System</h1>
    ...
    <section class="bg-white mt-32 pt-10 lg:mt-32 z-50" id="services">
      ...
      <!-- card columns -->
      <div class="mt-6 grid grid-cols-1 lg:grid-cols-3 p-24 py-auto md:mx-20 gap-4 rounded-lg">
        <!-- card container -->
