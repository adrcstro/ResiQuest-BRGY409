...
while ($row = $result->fetch_assoc()) {
    ...
    $letterContent = str_pad("", 120, " ", STR_PAD_LEFT) . "\n\n"; // Increased spacing for "BLOTTER REPORT"
    $dateOfReport = "PERSONAL DETAILS";
    $letterContent .= str_pad($dateOfReport, 150, " ", STR_PAD_LEFT) . "\n"; // Increased spacing for the date
    
    $letterContent .= "Complainant Name: " . $row['ComplainantLName'] . ", " . $row['ComplainantFName'] . "  " . $row['ComplainantMName'] . "\n";
    $letterContent .= "Respondent Name: " . $row['NameofComplainee'] . "\n";
    $letterContent .= "Date Filed: " . $row['DateofReport'] . "\n";
