...
if(mysqli_num_rows($result) > 0) {
  ...
  switch ($row["ServiceType"]) {
    ...
    case "Barangay Identification":
      $columns = ["RequestID" => "Request ID", "ServiceType" => "Service Type", "DateRequested" => "Date Requested", "Status" => "Status","FirstName" => "First Name", "Middlename" => "Middle Name", "Lastname" => "Last Name", "Contactname" => "Contact Person", "Contactaddress" => "Contact Person Address", "Contactnum" => "Contact Number"];
      break;
    default:
