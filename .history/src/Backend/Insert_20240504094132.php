...
if (isset($_POST['UserIDbrgyID'], $_POST['firstnamebrgyID'], $_POST['MnamebrgyID'], $_POST['lastnamebrgyID'], $_POST['DateofbirthbrgyID'], $_POST['PlaceofBirthbrgyID'], $_POST['CivilStatisbrgyID'], $_POST['SSSGSISbrgyID'], $_POST['DaterequestedbrgyID'], $_POST['AddressbrgyID'], $_POST['ContactpersonNamebrgyID'], $_POST['ContactpersonAddressbrgyID'], $_POST['ContactpersonnumberbrgyID'], $_POST['ServicetypebrgyID'], $_POST['DocStatbrgyID'])) {
    // Collect form data for insertion
    ...
    // Prepare and bind for insertion
    $stmt = $conn->prepare("INSERT INTO requestdocument (RequestID, UserID, FirstName, Middlename, Lastname, ServiceType, DateRequested, Address, DateofBirth, PlaceofBirth, Civilstat, SSSGSIS, Contactname, Contactaddress ,Contactnum, Status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)");
    $stmt->bind_param("isssssssssssssss", $RequestBRGYID , $UserIDbrgyID ,$firstnamebrgyID , $MnamebrgyID,  $lastnamebrgyID , $ServicetypebrgyID ,  $DaterequestedbrgyID ,  $AddressbrgyID ,$DateofbirthbrgyID,   $PlaceofBirthbrgyID, $CivilStatisbrgyID,  $SSSGSISbrgyID ,   $ContactpersonNamebrgyID,   $ContactpersonAddressbrgyID, $ContactpersonnumberbrgyID, $DocStatbrgyID);
...
if (isset($_POST['AdminaddFirstName'], $_POST['AdminaddMiddleName'], $_POST['AdminaddLastName'], $_POST['addAdminPosition'], $_POST['addAdminGender'], $_POST['AdminaddEmail'], $_POST['AdminPassword'])) {
    ...
    $stmt->bind_param('ssssssss', $AdminaddFirstName, $AdminaddMiddleName, $AdminaddLastName, $addAdminPosition, $addAdminGender, $AdminaddEmail, $AdminPassword,  $ItemImageFile);
