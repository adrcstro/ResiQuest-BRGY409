...
if (!empty($_SESSION["ID"]) && !empty($status)) {
    ...
    if ($stmt) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<tr><td colspan="6" class="px-6 py-4 border border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900"> echo '<div class="mx-auto text-center mt-8" style="width: 200px;">';
