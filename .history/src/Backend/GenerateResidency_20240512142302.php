...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // Add the text to $letterContent (assuming $row['RequestID'] is the RequestID)
            $letterContent = "CERTIFICATE OF INDIGENCY\n\n";
            $letterContent .= "Date Filed: " . $row['RequestID'] . "\n\n";
            
            // Reset font to regular and size 12
            $pdf->SetFont('times', '', 12);
