...
$sql = "SELECT DATE_FORMAT(DateRequested, '%Y-%m') as FormattedDateRequested FROM requestdocument WHERE YEAR(DateRequested) = ? AND MONTH(DateRequested) = ?";
...
while ($row = $result->fetch_assoc()) {
    $html .= '<tr>
                <td>' . $row['FormattedDateRequested'] . '</td>
              </tr>';
}
