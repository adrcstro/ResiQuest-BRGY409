...
if (mysqli_num_rows($result) > 0) {
    ...
    <!-- Left side inputs -->
        ...
        <div class="flex flex-col items-center justify-center w-full h-full">
            ...
            <div class="flex flex-col items-center justify-center w-full h-64 p-2 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                <img src="../Backend/uploads/' . $row["NewsImages"] . '" alt="News Image" class="object-cover w-full h-full border-2 border-gray-400 rounded-md">
            </div>
        </div>
