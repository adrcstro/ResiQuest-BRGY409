...
if (isset($_POST['ResidentIDMessage'], $_POST['chat'], $_POST['date'], $_POST['time'], $_POST['SenderFullname'], $_POST['PRofileMEssagesender'])) {
    $ResidentIDMessage = $_POST['ResidentIDMessage'];
    $chat = $_POST['chat'];
    $date = $_POST['date'];
    $time = $_POST['time'];
    $SenderFullname = $_POST['SenderFullname'];
    $PRofileMEssagesender = $_POST['PRofileMEssagesender'];
    ...
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('ssssssss',  $MessageID, $ResidentIDMessage, $PRofileMEssagesender, $SenderFullname, $chat, $date, $time,$imageuploadMessageFile);
    if ($stmt->execute()) {
