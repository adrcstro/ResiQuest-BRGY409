...
echo '<div>';
echo '<label for="middlename" class="block text-sm font-semibold leading-6 text-gray-900">Middle Name</label>';
echo '<input type="text" id="middlename" name="middlename" value="' . $row["Middlename"] . '" readonly class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mt-1">';
echo '</div>';

echo '<div>';
echo '<label for="last_name" class="block text-sm font-semibold leading-6 text-gray-900">Last Name</label>';
echo '<input type="text" id="last_name" name="last_name" value="' . $row["Lastname"] . '" readonly class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mt-1">';
echo '</div>';

echo '<div>';
echo '<label for="address" class="block text-sm font-semibold leading-6 text-gray-900">Address</label>';
echo '<input type="text" id="address" name="address" value="' . $row["Address"] . '" readonly class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mt-1">';
echo '</div>';

echo '<div>';
echo '<label for="purpose" class="block text-sm font-semibold leading-6 text-gray-900">Purpose</label>';
echo '<input type="text" id="purpose" name="purpose" value="' . $row["Purpose"] . '" readonly class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mt-1">';
echo '</div>';

echo '<div>';
echo '<label for="pickup_date" class="block text-sm font-semibold leading-6 text-gray-900">Pickup Date</label>';
echo '<input type="text" id="pickup_date" name="pickup_date" value="' . $row["PickUpDate"] . '" readonly class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mt-1">';
echo '</div>';
