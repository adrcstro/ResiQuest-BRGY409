...
while ($row = $result->fetch_assoc()) {
    ...
    // Set the text to be normal
    $pdf->SetFont('times', '', 12);
    $letterContent .= $row['Address'] . "\n";

    // Set the text to be bold
    $pdf->SetFont('times', 'B', 12);
    $letterContent .= "DATE OF BIRTH: ";
    
    // Set the text to be normal
    $pdf->SetFont('times', '', 12);
    $letterContent .= $row['DateofBirth'] . "\n";

    // Set the text to be bold
    $pdf->SetFont('times', 'B', 12);
    $letterContent .= "PLACE OF BIRTH: ";
    
    // Set the text to be normal
    $pdf->SetFont('times', '', 12);
    $letterContent .= $row['PlaceofBirth'] . "\n";

    // Set the text to be bold
    $pdf->SetFont('times', 'B', 12);
    $letterContent .= "STATUS: ";
    
    // Set the text to be normal
    $pdf->SetFont('times', '', 12);
    $letterContent .= $row['Civilstat'] . " SSS/GSIS: " . $row['SSSGSIS'] . "\n";
