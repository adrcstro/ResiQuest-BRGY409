...
________/ Complying with the provisions of existing Barangay ordinances, rules and regulations being enforced in this barangay:   
________/ Partially complying with the provision of existing Barangay ordinances, rules and regulations being enforced in this barangay: 
...
________/ Recommend only the issuance of TEMPORARY PERMIT for not more than (3) months and within the period of the requirements under existing barangay ordinances, rules and regulations on that matter should be totally complied with, otherwise this barangay would take the necessary action, within legal bounds to stop its continued operation.";
...
// Set the width for the paragraph to control the text flow better
$paragraphWidth = 150; // Adjust width as needed

// Output the paragraph text
$pdf->MultiCell($paragraphWidth, 10, $paragraphText, 0, 'J');

// Output each line separately to control line breaks and prevent large spaces
$lines = [
    "being applied for the NEW / RENEWAL of the corresponding Mayor's Permit has been found to be:",
    "________/ Complying with the provisions of existing Barangay ordinances, rules and regulations being enforced in this barangay:",
    "________/ Partially complying with the provision of existing Barangay ordinances, rules and regulations being enforced in this barangay:",
    "In view of the foregoing, this Barangay thru the undersigned ---",
    "________/ Interposes NO objection for the issuance of the corresponding Mayor's Permit being applied for:",
...
// Output each line separately to prevent large spaces
foreach ($lines as $line) {
    $pdf->MultiCell($paragraphWidth, 10, $line, 0, 'J');
    $pdf->Ln(2); // Add line break for spacing
}
