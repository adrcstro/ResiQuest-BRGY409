...
if (isset($_POST['ResidentIDMessage'], $_POST['chat'], $_POST['date'], $_POST['time'])) {
    ...
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('ssssss',  $MessageID, $ResidentIDMessage, $chat, $date, $time,$imageuploadMessageFile);
    if ($stmt->execute()) {
