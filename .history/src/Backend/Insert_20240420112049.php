...
if (isset($_POST['firstnamebrgyResidency'], $_POST['MnamebrgyResidency'], $_POST['lastnamebrgyResidency'], $_POST['DaterequestedbrgyResidency'], $_POST['AddressdbrgyResidency'], $_POST['PurposebrgyResidency'], $_POST['ServicetypebrgyResidency'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO requestdocument (ResidentsName, Middlename, Lastname, ServiceType, DateRequested, Address) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss",  $firstnamebrgyResidency,  $MnamebrgyResidency, $lastnamebrgyResidency, $ServicetypebrgyResidency, $DaterequestedbrgyResidency, $AddressdbrgyResidency,  );
