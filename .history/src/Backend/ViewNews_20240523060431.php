...
<div class="flex-1 flex flex-col">
    <div class="flex flex-col items-center justify-center w-full h-full">
        ...
        <div class=class="flex flex-col items-center justify-center w-full h-full p-2 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
        <img src="../Backend/uploads/' . $row["NewsImages"] . '" alt="News Image" class="w-80 h-80 object-contain border-2 border-gray-400 rounded-md p-2">
    </div>
    </div>
</div>
<!-- Right side input -->
