...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $sql = "SELECT * FROM requestdocument WHERE RequestID = '$searchID' AND (ServiceType = 'Certificate of Residency')";

   $query = "SELECT requestdocument.*, admintbl.*
   FROM requestdocument
   INNER JOIN admintbl ON requestdocument.DocumentID = admintbl.AdminID
   WHERE admintbl.AdminID = :id
   AND admintbl.BrgyPosition = 'Barangay Chairman'
   AND requestdocument.RequestID = :searchID
   AND requestdocument.ServiceType = 'Certificate of Residency'";
