...
if ($row = mysqli_fetch_assoc($result)) {
    ...
    if (file_exists($profileImagePath)) {
        ...
        // Display default image if profile image does not exist
        echo '<img id="profilePicture" src="/Images/brgylogo.png" class="w-32 h-32 bg-gray-300 rounded-full mb-2 border-4" alt="Default Profile Picture">';
    }
