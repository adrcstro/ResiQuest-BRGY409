...
if (!empty($_SESSION["ID"]) && !empty($status)) {
    ...
    if ($result->num_rows > 0) {
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 border-2 border-inherit text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                        </tr>
                    </thead>
        ...
        echo "<p class='text-lg font-semibold text-center'>No Filed Complaint</p>";
        echo '</div>';
    }
} else {
