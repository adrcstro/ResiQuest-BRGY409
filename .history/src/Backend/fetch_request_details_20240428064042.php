...
if(mysqli_num_rows($result) > 0) {
  ...
  switch ($row["ServiceType"]) {
    ...
    case "Business Clearance":
      $columns = ["RequestID" => "Request ID", "ServiceType" => "Service Type", "DateRequested" => "Date Requested", "Status" => "Status", "FirstName" => "First Name", "Middlename" => "Middle Name", "Lastname" => "Last Name", "Address" => "Address", "BusinessAct" => "Business Trade or Activity", "BusinessLoc" => "Business Location"];
      break;
