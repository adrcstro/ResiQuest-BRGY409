...
class PDF extends TCPDF {
    ...
    public function __construct($organizationName, $organizationAddress, $brgyname, $Zonenumname, $fulladdress , $officeofbrgy ) {
        parent::__construct();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $pdf = new PDF($organizationName, $organizationAddress ,$brgyname, $Zonenumname, $fulladdress, $officeofbrgy);
        ...
        while ($row = $result->fetch_assoc()) {
           ...
           // Set font to bold, size 16, and center alignment
$pdf->SetFont('times', 'B', 16);
$pdf->SetXY(0, 0); // Set the position to the top left corner
$pdf->Cell(210, 0, 'CERTIFICATE OF INDIGENCY', 0, 1, 'C'); // Cell width 210 to span the entire page

// Set font to regular, size 12
$pdf->SetFont('times', '', 12);

// Add the rest of the text to $letterContent
$dateOfReport = "Date Filed: " . $row['RequestID'];
$letterContent .= $dateOfReport . "\n\n";

// Continue with the rest of your letter content...
