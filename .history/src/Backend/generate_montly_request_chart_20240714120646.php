...
$sql = "SELECT RequestID, ServiceType, COUNT(*) as request_count FROM requestdocument WHERE YEAR(DateRequested) = ? AND MONTH(DateRequested) = ? GROUP BY RequestID, ServiceType";
