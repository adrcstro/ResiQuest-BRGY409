...
if (isset($_POST['AdminsID'])) {
    ...
    if (!empty($adminID) && !empty($AdminEditFirstName) && !empty($AdminEditMiddleName) && !empty($AdminEditLastName) && !empty($BrgyPositions) && !empty($AdminGender) && !empty($AdminEmail)) {
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>Swal.fire('Error', 'Error updating admin record: {$stmt->error}', 'error');</script>";
        }
    
        $stmt->close();
    } else {
        echo "<script>Swal.fire('Error', 'Please fill in all required fields', 'error');</script>";
    }
    
    // Additional debugging
    echo "AdminID: $adminID<br>";
    echo "AdminEditFirstName: $AdminEditFirstName<br>";
    echo "AdminEditMiddleName: $AdminEditMiddleName<br>";
    echo "AdminEditLastName: $AdminEditLastName<br>";
    echo "BrgyPositions: $BrgyPositions<br>";
    echo "AdminGender: $AdminGender<br>";
    echo "AdminEmail: $AdminEmail<br>";
    echo "AdminProfile: $AdminPRofiles<br>";
