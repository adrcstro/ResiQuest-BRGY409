...
if (isset($_POST['AdminaddresidentfirstName'], $_POST['AdminaddresidentlastName'], $_POST['AdminaddresidentphoneN'], $_POST['addAdminPosition'], $_POST['addAdminResidentGender'], $_POST['adminaddresiEmail'], $_POST['adminaddConfirmPAssword'], $_POST['adminaddresiPAssword'])) {
    $AdminaddresidentfirstName = $_POST['AdminaddresidentfirstName'];
    $AdminaddresidentlastName = $_POST['AdminaddresidentlastName'];
    $AdminaddresidentphoneN = $_POST['AdminaddresidentphoneN'];
    $addAdminResidentGender = $_POST['addAdminResidentGender'];
    $adminaddresiEmail = $_POST['adminaddresiEmail'];
    $adminaddConfirmPAssword = $_POST['adminaddConfirmPAssword'];
    $adminaddresiPAssword = $_POST['adminaddresiPAssword'];
   


    // Check if email is valid
    if (!filter_var($adminaddresiEmail, FILTER_VALIDATE_EMAIL)) {
        http_response_code(400); // Set HTTP response status code to 400
        echo 'Invalid email address';
        exit; // Stop further execution
    }
    ...
    // Check if passwords match
    if ($adminaddresiPAssword !== $adminaddConfirmPAssword) {
        http_response_code(400); // Set HTTP response status code to 400
        echo 'Passwords do not match';
        exit; // Stop further execution
    }

    $hashedPassword = password_hash($adminaddresiPAssword, PASSWORD_DEFAULT); // Hash the password
