<?php
set_include_path(get_include_path() . PATH_SEPARATOR . 'C:\xampp\htdocs\ResiQuest-BRGY409\src\Backend');

require_once('/xampp/htdocs/ResiQuest-BRGY409/src/Backend/tcpdf.php');
