...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $letterContent .= " with postal \naddress at  " . $row['Address'] . ", Sampaloc Manila is INDIGENT in this Barangay \n\n";
            ...
            $letterContent .= "              this Certification is being issued upon the request of the above mentioned person ";
            $letterContent .= "for";
