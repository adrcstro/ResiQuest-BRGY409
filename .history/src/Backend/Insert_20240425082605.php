...
//BRGY RESIDENCY PHP
if (isset($_POST['firstnamebrgyResidency'], $_POST['MnamebrgyResidency'], $_POST['lastnamebrgyResidency'], $_POST['ServicetypebrgyResidency'], $_POST['DaterequestedbrgyResidency'], $_POST['AddressdbrgyResidency'], $_POST['PurposebrgyResidency'], $_POST['DocumentStatbrgyResidency'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO requestdocument (RequestID, FirstName, Middlename, Lastname, ServiceType, DateRequested, Address, Status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("issssssss", $RequestID, $firstnamebrgyResidency, $MnamebrgyResidency, $lastnamebrgyResidency, $ServicetypebrgyResidency, $DaterequestedbrgyResidency, $AddressdbrgyResidency, $PurposebrgyResidency, $DocumentStatbrgyResidency);
...
if (isset($_POST['firstnamebrgyIndigency'], $_POST['MnamebrgyIndigency'], $_POST['lastnamebrgyIndigency'], $_POST['ServicetypebrgyIndigency'], $_POST['DaterequestedbrgyIndigency'], $_POST['AddressbrgyIndigency'], $_POST['PurposebrgyIndigency'], $_POST['DocStatusbrgyIndigency'])) {
    // Collect form data for insertion
    ...
    // Prepare and bind for insertion
    $stmt = $conn->prepare("INSERT INTO requestdocument (RequestID, FirstName, Middlename, Lastname, ServiceType, DateRequested, Address, Purpose , Status) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)");
    $stmt->bind_param("issssssss", $RequestIDIndigency , $firstnamebrgyIndigency, $MnamebrgyIndigency,  $lastnamebrgyIndigency,  $ServicetypebrgyIndigency, $DaterequestedbrgyIndigency,$AddressbrgyIndigency,  $PurposebrgyIndigency,$DocStatusbrgyIndigency);
...
if (isset($_POST['firstnamebrgyID'], $_POST['MnamebrgyID'], $_POST['lastnamebrgyID'], $_POST['DateofbirthbrgyID'], $_POST['PlaceofBirthbrgyID'], $_POST['CivilStatisbrgyID'], $_POST['SSSGSISbrgyID'], $_POST['DaterequestedbrgyID'], $_POST['AddressbrgyID'], $_POST['ContactpersonNamebrgyID'], $_POST['ContactpersonAddressbrgyID'], $_POST['ContactpersonnumberbrgyID'], $_POST['ServicetypebrgyID'] )) {
    ...
    // Prepare and bind for insertion
    $stmt = $conn->prepare("INSERT INTO requestdocument (RequestID, FirstName, Middlename, Lastname, ServiceType, DateRequested, Address, DateofBirth, PlaceofBirth, Civilstat, SSSGSIS, Contactname, Contactaddress ,Contactnum) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)");
    $stmt->bind_param("isssssssssssss", $RequestBRGYID ,$firstnamebrgyID , $MnamebrgyID,  $lastnamebrgyID , $ServicetypebrgyID ,  $DaterequestedbrgyID ,  $AddressbrgyID ,$DateofbirthbrgyID,   $PlaceofBirthbrgyID, $CivilStatisbrgyID,  $SSSGSISbrgyID ,   $ContactpersonNamebrgyID,   $ContactpersonAddressbrgyID, $ContactpersonnumberbrgyID);
...
if (isset($_POST['firstnamebrgyBClearance'], $_POST['MnameBClearance'], $_POST['lastnameBClearance'], $_POST['BusinessNameBClearance'], $_POST['BusinessLocBClearance'], $_POST['DateReqBClearance'], $_POST['HomeAddBClearance'], $_POST['ServicetyBClearance'], $_POST['DocStatusBClearance'])) {
    // Collect form data for insertion
    ...
    // Prepare and bind for insertion
    $stmt = $conn->prepare("INSERT INTO requestdocument (RequestID, FirstName, Middlename, Lastname, ServiceType, DateRequested, Address, BusinessAct, BusinessLoc ,Status ) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?, ?)");
    $stmt->bind_param("isssssssss",  $RequestBClearance , $firstnamebrgyBClearance,$MnameBClearance, $lastnameBClearance,  $ServicetyBClearance, $DateReqBClearance ,  $HomeAddBClearance,  $BusinessNameBClearance, $BusinessLocBClearance,  $DocStatusBClearance);
