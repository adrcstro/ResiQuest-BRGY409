...
$this->SetFont('times', 'B', 10); // Set font to bold and size 14
 ...
 $this->SetFont('courier', '', 10); // Set a monospaced font
 $text = str_replace('', ' ', $this->kagawad2); // Add spaces between characters
 $this->Cell(0, 10, $text, 0, 10, 'C');
 $this->SetFont('times', '', 10); // Reset font to default
