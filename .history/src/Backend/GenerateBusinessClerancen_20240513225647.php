...
$underlineY = $pdf->GetY(20);

// Move the cursor down
$pdf->SetY($underlineY + 2); // Adjust the value (2) as needed for the space between text and underline

// Set the line style to underline
$pdf->SetLineStyle(array('width' => 0.1, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(0, 0, 0)));

// Draw the underline
$pdf->Line($pdf->GetX(), $pdf->GetY(), $pdf->GetX() + $pdf->GetStringWidth($row['Lastname'] . ", " . $row['FirstName'] . "  " . $row['Middlename']), $pdf->GetY());
