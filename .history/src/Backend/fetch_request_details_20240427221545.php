...
if(mysqli_num_rows($result) > 0) {
  ...
  switch ($row["ServiceType"]) {
    ...
    case "Barangay Identification":
      $columns = ["FirstName" => "First Name", "Middlename" => "Middle Name", "Lastname" => "Last Name", "Contactname" => "Contact Name", "Contactaddress" => "Contact Address", "Contactnum" => "Contact Number"];
      break;
    default:
