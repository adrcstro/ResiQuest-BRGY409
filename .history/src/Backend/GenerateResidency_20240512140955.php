...
class PDF extends TCPDF {
    ...
    public function __construct($organizationName, $organizationAddress, $brgyname, $Zonenumname, $fulladdress ,$officeofbrgy , $tel) {
        parent::__construct();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $pdf = new PDF($organizationName, $organizationAddress ,$brgyname, $Zonenumname, $fulladdress, $officeofbrgy ,$tel);
