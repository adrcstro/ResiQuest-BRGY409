...
switch ($serviceType) {
    ...
    case "Certificate of Indigency":
        ...
        $updateQuery = "UPDATE requests SET firstname='$firstname', middlename='$middlename', lastname='$lastname', address='$address', purpose='$purpose' WHERE requestId='$requestId'";
        break;
    case "Business Clearance":
        ...
        $updateQuery = "UPDATE requests SET firstname='$firstname', middlename='$middlename', lastname='$lastname', address='$address', businessAct='$businessAct', businessLoc='$businessLoc' WHERE requestId='$requestId'";
        break;
    case "Barangay Identification":
        ...
        $updateQuery = "UPDATE requests SET firstname='$firstname', middlename='$middlename', lastname='$lastname', address='$address', dateOfBirth='$dateOfBirth', placeOfBirth='$placeOfBirth', sssgsis='$sssgsis', contactPersonName='$contactPersonName', contactPersonNumber='$contactPersonNumber', contactPersonAddress='$contactPersonAddress' WHERE requestId='$requestId'";
        break;
    default:
