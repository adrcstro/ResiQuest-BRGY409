...
$serviceType = "BLLOTER REPORT MONITORING CHART";
...
$sql = "SELECT COUNT(*) as request_count FROM complaintbl WHERE YEAR(DateofReport) = ? AND MONTH(DateofReport) = ?";
...
$html = '
<h4>Blotter & Complaint Report for the month of ' . $formattedDate . '</h4>
<table border="1" cellpadding="5">
    <tr>
        <th>Year-Month</th>
        <th>Total Complaint Report</th>
    </tr>
    <tr>
