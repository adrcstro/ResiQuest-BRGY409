...
if (isset($_POST['ResidentID'])) {
    ...
    if (!empty($ResidentID)) {
        ...
        $stmt->bind_param("sssssssssssssssssss", $firstname, $Middlename, $lastname, $ContactNumber, $Gender, $email, $Nickname, $PlaceofBirth, $Birthdate, $Age, $civilstatus, $purok, $voterstatus, $Occupation, $Address, $ZipCode, $Citizenship, $PRofile, $GovernmentID, $ResidentID);
        if ($stmt->execute()) {
