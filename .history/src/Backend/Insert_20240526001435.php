...
if (isset($_POST['AdminaddFirstName'], $_POST['AdminaddMiddleName'], $_POST['AdminaddLastName'], $_POST['addAdminPosition'], $_POST['addAdminGender'], $_POST['AdminaddEmail'], $_POST['AdminPassword'], $_POST['RenderedServicestartadd'], $_POST['AdminPassword'], $_POST['RenderedServiceendadd'])) {
