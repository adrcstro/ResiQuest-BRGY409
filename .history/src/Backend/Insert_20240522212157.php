...
if (isset($_POST['NewsTitle'], $_POST['NewsDate'], $_POST['NewsTime'], $_POST['NewsContent'], $_POST['addAdminGender'])) {
    ...
    $sql = "INSERT INTO newsandevents (NewsID, Fname, MName, Lname, BrgyPosition, AdGender, Email, Password, AdminProfile) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('ssssss', $Newsid, $NewsTitle,$NewsDate,  $NewsTime, $NewsContent, $addAdminGender);
