...
$purokSkchairman="Myckylla Sharee M. Pajeras";
...
class PDF extends TCPDF {
    ...
    $kagawadSKchairman, $purokSKchairman)
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $kagawadsunflower , $puroknSun, $kagawadRosal,$purokRosal,$kagawadDahlia,$purokDahlia ,$kagawadCamia,$purokCamia,$kagawadGumamela,$purokGumamela,$kagawadJasmin,$purokJasmin,$kagawadSampaguita,$purokSampaguita,$kagawadSKchairman,$purokSKchairman);
