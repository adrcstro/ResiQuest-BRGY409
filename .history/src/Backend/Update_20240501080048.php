...
// Assuming these are the only two possible outcomes after the user updates their information
if (isset($message)) {
    if ($message === "success") {
        echo "<script>Swal.fire('Success', 'Information Submitted Successfully', 'success');</script>";
