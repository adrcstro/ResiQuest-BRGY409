...
<div class="flex flex-col items-center justify-center w-full">
    ...
    <img for="Government-ID" class="flex flex-col items-center justify-center w-full h-64 p-2 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600" style="background-image: url("../Backend/uploads/' . $row['Profile'] . '"); background-size: cover; background-position: center;">
...
<div class="flex flex-col items-center justify-center w-full">
    ...
    <img for="Government-ID-back" class="flex flex-col items-center justify-center w-full h-64 p-2 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600" style="background-image: url("../Backend/uploads/' . $row['Profile'] . '"); background-size: cover; background-position: center;">
