...
if (isset($_POST['AdminsID'], $_POST['AdminEditFirstName'], $_POST['AdminEditMiddleName'], $_POST['AdminEditLastName'], $_POST['AdminPosition'], $_POST['AdminGender'], $_POST['AdminEmail'])) {
