...
if (mysqli_num_rows($result) > 0) {
        ...
        echo '<td class="p-1 border border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">
                <div class="dropdown dropdown-end">
                    ...
                    <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
                        ...
                        <li class="edit-residents-btn" data-Residents-id="' . $row["ID"] . '"><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <li class="delete-residents-btn" data-Residents-id="' . $row["ID"] . '"><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m-1.022.165L5.84 19.673A2.25 2.25 0 0 0 8.084 21h7.833a2.25 2.25 0 0 0 2.244-2.077L19.23 5.79m-14.456 0a48.123 48.123 0 0 1 3.478-.397m0 0L9.995 3.06a1.125 1.125 0 0 1 1.01-.56h2.989c.438 0 .832.224 1.01.56l1.744 2.333" />
    ...
    for ($i = 1; $i <= $total_pages; $i++) {
        echo '<button class="pagination-btn mx-1 px-3 py-1 bg-blue-500 text-white rounded" data-page="' . $i . '">' . $i . '</button>';
    }
    echo '</div>';
