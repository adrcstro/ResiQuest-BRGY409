  ...
  echo '<td class="p-3 border border-inherit text-center   whitespace-nowrap text-sm font-semibold text-gray-900">
    <div class="dropdown dropdown-end">
        ...
        <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52">
            ...
            <li class="Markasetteled" data-setscheduleblootter-id="' . $row["ComplainID"] . '" data-Complainant-Name="' . $row["ComplainantFName"] . '' . $row["ComplainantMName"] . '' . $row["ComplainantLName"] . '" >
            <a>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
openModalButtons.forEach(function (button) {
  button.addEventListener("click", function () {
    ...
    const Complaiantname = button.getAttribute("data-Complainant-Name");
    ...
    <p class="text-lg font-semibold text-center ">Schedule Setteled for Complainant</p>
    </div>
