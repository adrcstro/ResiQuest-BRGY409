...
if (mysqli_num_rows($result) > 0) {
    ...
    echo'<!-- component -->
    <div class="flex items-center justify-center py-10 lg:px-0 sm:px-6 px-4"> <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
    
            <div class="lg:w-3/5 w-full  flex items-center justify-between  border-gray-200">
