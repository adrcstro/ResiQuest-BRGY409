        ...
        echo '<td class="p-1 border flex items-center justify-center border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">
            <div class="dropdown dropdown-end">
                ...
                <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52">
                    <li class="Schedule-resident-pickup" data-request-id="' . htmlspecialchars($row["RequestID"]) . '" data-request-servietype="' . htmlspecialchars($row["ServiceType"]) . '" data-request-Fname="' . htmlspecialchars($row["FirstName"]) . '" data-request-Mname="' . htmlspecialchars($row["Middlename"]) . '" data-request-Lname="' . htmlspecialchars($row["Lastname"]) . '" data-adminid-logs="' . $row["AdminID"] . '" data-adminusername-logs="' . $row["Lname"] . ',' . $row["Fname"] . ' ' . $row["MName"] . ' " data-adminposition-logs="' . $row["BrgyPosition"] . '">
