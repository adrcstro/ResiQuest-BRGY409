...
if (mysqli_num_rows($result) > 0) {
    ...
    echo '</ul></nav>';
    echo'<div class="bg-white  rounded-lg p-6 mt-8">
                      
    <div class="mb-2 lg:mb-0 ">
        <h3 class="text-2xl font-bold text-black mb-2 text-center">Table Summary </h3>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:w-2/3">
            <div class="bg-blue-100 p-4 rounded-md">
                ...
                <ul class="list-disc ml-6 mb-4">
                    ...
                    <li>Cant Request Document & File Blotter Report</li>
                </ul>
            </div>
