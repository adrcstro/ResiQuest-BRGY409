...
WHERE admintbl.AdminID = $ID LIMIT 0,5;";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td class="p-3 text-center border-2 border-inherit rounded-md text-sm font-semibold text-gray-900">' . 
        '<span class="' . $statusBgColor . ' text-white px-2 py-1 rounded">' . $row["Status"] . '</span>' . 
        '</td>';
