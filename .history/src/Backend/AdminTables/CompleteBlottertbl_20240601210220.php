...
<div class="modal-box w-70 max-w-3xl rounded-lg">
    <div class="mb-2 lg:mb-0">
      ...
      <span class="flex text-base font-medium text-blue-500 justify-center text-center">Schedule Residents r Settlement</span>
    </div>
...
openModalButtons.forEach(function (button) {
  button.addEventListener("click", function () {
    ...
    <p class="text-lg font-semibold text-center ">Schedule Blotter Case for</p>
    </div>
...
<input value="Set Date for Case ${setscheduleblotterid}"  type="text" name="Adminactiondone" id="Adminactiondone" autocomplete="street-address" 
  class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mb-4">
</div>
<div class="flex">
