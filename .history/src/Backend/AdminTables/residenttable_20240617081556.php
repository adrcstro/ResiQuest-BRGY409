        ...
        while ($row = mysqli_fetch_assoc($result)) {
           ...
           <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52 ">
              ...
              View Details</a></li>
               ...
               <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75v-10.5A2.25 2.25 0 0 1 5.25 6H10" />
             </svg>
              Edit Details</a></li>
               
              <li class="delete-residents-btn" data-Residents-id="' . $row["ID"] . '" data-Residents-fname="' . $row["fname"] . '" data-Residents-mname="' . $row["Mname"] . '" data-Residents-Lname="' . $row["lname"] . '" data-adminid-logs="' . $row["AdminID"] . '" data-adminusername-logs="' . $row["Lname"] . ',' . $row["fname"] . ' ' . $row["MName"] . ' " data-adminposition-logs="' . $row["BrgyPosition"] . '">
              <a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 9 18.833 19.428A2.25 2.25 0 0 1 16.586 21H7.414a2.25 2.25 0 0 1-2.247-1.905L4.5 9m15 0a1.5 1.5 0 0 1-1.5 1.5h-12A1.5 1.5 0 0 1 4.5 9m15 0-.5-3.75A2.25 2.25 0 0 0 16.772 3H7.228a2.25 2.25 0 0 0-2.228 2.25L4.5 9m15 0h-15" />
            </svg>
              Delete</a></li>
           </ul>
       </div>
...
document.getElementById("Verifyresidentbutton").addEventListener("click", function() {
    ...
    <form method="POST" action="">
        <div class="pagination-buttons">
            <button type="submit" name="page" value="<?php echo max(0, $page - 1); ?>" <?php if ($page <= 0) echo 'disabled'; ?>>Previous</button>
            <button type="submit" name="page" value="<?php echo $page + 1; ?>">Next</button>
        </div>
    </form>
</body>
</html>
