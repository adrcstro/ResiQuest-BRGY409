...
$stmt = $conn->prepare("SELECT users.ID, users.fname, users.Mname, users.lname, users.Age, users.Gender, users.Status, admintbl.AdminProfile, admintbl.AdminID, admintbl.Lname, admintbl.Fname, admintbl.MName, admintbl.BrgyPosition 
                        FROM users 
