...
<div class="modal-box w-70 max-w-3xl rounded-lg">
    <div class="mb-2 lg:mb-0">
      ...
      <span class="flex text-base font-medium text-blue-500 justify-center text-center">Re Schedule Residents Blotter Settlement</span>
    </div>
    <form id="setscheduleBlotterform" action="../Backend/Update.php" method="post" enctype="multipart/form-data">
  <div id="RescheduleBlotterCaseContent"></div>
  </form>
...
<button" id="RescheduleBlotterCasebutton" class="inline-flex justify-center  rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-500 hover:bg-green-600 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto sm:text-sm"> 
...
const modalContent = document.getElementById("RescheduleBlotterCaseContent");
...
openModalButtons.forEach(function (button) {
  button.addEventListener("click", function () {
    ...
    <p class="text-lg font-semibold text-center ">Re Schedule Blotter Case</p>
    </div>
...
echo '<script>
$(function() {
  $("#RescheduleBlotterCasebutton").click(function(e) {
      e.preventDefault();
...
document.getElementById("RescheduleBlotterCasebutton").addEventListener("click", function() {
