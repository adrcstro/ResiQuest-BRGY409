        ...
        echo '<td class="p-1 border border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">
            <div class="dropdown dropdown-end">
                ...
                <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-2xl bg-base-100 rounded-box w-52">
                    ...
                    <li class="edit-residents-btn" data-residents-id="' . $row["ID"] . '" data-residents-profile="' . $row["Profile"] . '" data-residents-fname="' . $row["fname"] . '" data-residents-mname="' . $row["Mname"] . '" data-residents-lname="' . $row["lname"] . '" data-residents-nname="' . $row["Nickname"] . '" data-residents-placeofbirth="' . $row["PlaceofBirth"] . '" data-residents-dateofbirth="' . $row["Dateofbirth"] . '" data-residents-age="' . $row["Age"] . '" data-residents-gender="' . $row["Gender"] . '" data-residents-contact="' . $row["Contact"] . '" data-residents-email="' . $row["Email"] . '" data-residents-address="' . $row["Address"] . '" data-residents-status="' . $row["Status"] . '"><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 2.488a3.314 3.314 0 1 1 4.686 4.687L7.182 21.54a4.514 4.514 0 0 1-1.883 1.13l-3.328 1.046a.508.508 0 0 1-.638-.637l1.046-3.329a4.514 4.514 0 0 1 1.13-1.883L16.862 2.488z" />
                    ...
                    <li class="delete-residents-btn" data-residents-id="' . $row["ID"] . '"><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 6.75 6 19.424a2.25 2.25 0 0 0 2.244 2.076h7.512A2.25 2.25 0 0 0 18 19.424L18.75 6.75M9 10.5v6M15 10.5v6" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M10.5 6.75V4.875A1.125 1.125 0 0 1 11.625 3.75h.75A1.125 1.125 0 0 1 13.5 4.875V6.75" />
                    </svg> Delete</a></li>
                    <li class="delete-verify-btn" data-residents-id="' . $row["ID"] . '"><a><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m9 11.25 2.25 2.25L15 9" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 20.25h6A2.25 2.25 0 0 0 17.25 18V6A2.25 2.25 0 0 0 15 3.75H9A2.25 2.25 0 0 0 6.75 6v12A2.25 2.25 0 0 0 9 20.25z" />
                    </svg> Verify</a></li>
                </ul>
            </div>
        </td>';
