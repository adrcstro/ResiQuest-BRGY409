...
$rescertnum="Res. Cert. No __________________";
$Issued="Issued at __________________";
$on="On________________________";
...
class PDF extends TCPDF {
    ...
    public function __construct($organizationName, $organizationAddress, $brgyname, $Zonenumname, $fulladdress , $officeofbrgy, $serviceType,$tel, $nameofbrgycharman, $psotiontitle, $specimensig, $line, $rescertnum, $Issued, $on)
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $pdf = new PDF($organizationName, $organizationAddress ,$brgyname, $Zonenumname, $fulladdress, $officeofbrgy, $serviceType,$tel, $nameofbrgycharman, $psotiontitle,$specimensig,$line,$rescertnum,$Issued,$on );
