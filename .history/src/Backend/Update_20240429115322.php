...
if (isset($_POST['requestId']) && !empty($_POST['firstName']) && !empty($_POST['lastName'])) {
  ...
  // Prepare and execute the SQL query to update the request based on ServiceType
  if ($serviceType === "Certificate of Residency" || $serviceType === "Certificate of Indigency") {
    $purpose = $_POST['purpose'];
    $query = "UPDATE requestdocument SET FirstName = '$firstName', MiddleName = '$middleName', LastName = '$lastName', Address = '$address', Purpose = '$purpose' WHERE RequestID = $requestId";
  } else if ($serviceType === "Business Clearance") {
    $businessAct = $_POST['businessAct'];
    $businessLoc = $_POST['businessLoc'];
    $query = "UPDATE requestdocument SET FirstName = '$firstName', MiddleName = '$middleName', LastName = '$lastName', Address = '$address', BusinessAct = '$businessAct', BusinessLoc = '$businessLoc' WHERE RequestID = $requestId";
    ...
    $query = "UPDATE requestdocument SET FirstName = '$firstName', MiddleName = '$middleName', LastName = '$lastName', Address = '$address', DateOfBirth = '$dateOfBirth', PlaceOfBirth = '$placeOfBirth', ContactName = '$contactName', ContactAddress = '$contactAddress', ContactNum = '$contactNum' WHERE RequestID = $requestId";
  } else {
    echo "Invalid ServiceType";
    exit;
  }
