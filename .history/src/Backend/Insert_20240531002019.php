...
if (isset($_POST['complainuserid'], $_POST['ComplainfirstnamebrgyID'], $_POST['ComplainMnamebrgyID'], $_POST['ComplainlastnamebrgyID'], $_POST['Complaincontactnum'], $_POST['Complaindatefiled'], $_POST['Complainaddress'],
 $_POST['complainstatus'], $_POST['complaineename'], $_POST['Complaineeaddress'], $_POST['typeofcomplain'], $_POST['complainreportdetails'])) {
    ...
    $profevidenceFile = $_FILES['addAdminPRofile']['name'];
    $profevidenceTmp = $_FILES['addAdminPRofile']['tmp_name'];



    // Prepare and bind for insertion
    $stmt = $conn->prepare("INSERT INTO complaintbl (ComplainID, ComUserID, DateofReport, ComplainantFName, ComplainantMName, ComplainantLName, ContactNumber, Address, ComplainDescription	, TypeofComplaint ,	NameofComplainee, Complaineeaddress, ComplainStatus,ProfofEvidence) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    $Complainaddress , $complainreportdetails ,$typeofcomplain,    $complaineename,  $Complaineeaddress, $complainstatus,$profevidenceFile);
    if ($stmt->execute() === TRUE) {
...
if (isset($_POST['AdminaddFirstName'], $_POST['AdminaddMiddleName'], $_POST['AdminaddLastName'], $_POST['addAdminPosition'], $_POST['addAdminGender'], $_POST['AdminaddEmail'], $_POST['AdminPassword'], $_POST['ConfirmPAssword'], $_POST['RenderedServicestartadd'], $_POST['RenderedServiceendadd'])) {
    ...
    $ItemImageFile = $_FILES['profofevidence']['name'];
    $ItemImageTmp = $_FILES['profofevidence']['tmp_name'];
