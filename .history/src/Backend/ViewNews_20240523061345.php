...
if (mysqli_num_rows($result) > 0) {
    ...
    <div class="flex-1 flex flex-col justify-between">
        ...
        <div class="mt-3">
            ...
            <textarea value="' . $row["NewsContent"] . ' name="NewsContent" rows="6" class="rounded-lg border-gray-200 w-full h-64 pt-2 text-gray-900 border-1 bg-white input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500 resize-none" placeholder="Enter News Content....." required></textarea>
        </div>
    </div>
    </div>';
