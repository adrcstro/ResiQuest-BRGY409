...
$this->Ln(-5);
$this->SetFont('times', 'B', 10); // Set font to bold and size 14
 // Set X coordinate to 30 (adjust as needed)
 $this->SetFont('times', '', 10); // Set font to Times New Roman, regular, size 10
 $this->SetCharacterSpacing(-0.5); // Decrease character spacing by 0.5 units
 $this->Cell(0, 10, $this->kagawad2, 0, 10, 'C');
 $this->SetCharacterSpacing(0); // Reset character spacing to default
