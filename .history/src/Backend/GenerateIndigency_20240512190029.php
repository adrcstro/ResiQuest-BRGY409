...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // Output the name with underline
            $pdf->SetFont('times', 'BU', 12); // Set font to bold and underline
            $pdf->Cell(0, 10, $row['Lastname'] . ", " . $row['FirstName'] . "  " . $row['Middlename'], 0, 9, 'C');
            $pdf->SetFont('times', '', 12); // Reset font to normal
        
            $letterContent .= "\n\n";
            $letterContent .= "              This is to Certify that the bearer  ";
            ...
            // Output the rest of the content to the PDF
