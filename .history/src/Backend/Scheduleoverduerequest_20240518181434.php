    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td class="p-1 border flex items-center justify-center border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">
            <div class="dropdown dropdown-end">
                ...
                <li class="Schedule-resident-pickup" data-request-id="<?php echo $row["RequestID"]; ?>" data-request-servietype="<?php echo $row["ServiceType"]; ?>" data-request-Fname="<?php echo $row["FirstName"]; ?>" data-request-Mname="<?php echo $row["Middlename"]; ?>" data-request-Lname="<?php echo $row["Lastname"]; ?>">
    ...
    echo '</tbody></table></div>';
        ...
        <div class="modal-box w-70 max-w-3xl rounded-lg">
            ...
            <div class="mt-4 px-4 py-3 sm:px-6 flex align-items justify-center p-4 gap-4 flex-row">
                <button id="scheduleclose" class="btn btn-sm btn-circle btn-ghost absolute top-2 right-2">✕</button>
