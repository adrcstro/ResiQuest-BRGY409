...
$pdf->SetFont('times', '', 12); // Set font to regular Times, size 12
$last = "_____/ Recommend only the issuance of TEMPORARY PERMIT for not more than (3) months and within the period of the requirments under existing barangay ordinances rules and regulation on that matter should be totally compiled with otherwise this barangay would take the necessary action,within legal bounds to stop its continued operation:";
// Adjust the positioning for the paragraph
$pdf->SetX(30); // Set the X coordinate to 30 (adjust as needed)
$pdf->SetY($pdf->GetY() + 10); // Move down 10 units for spacing

// Output the paragraph text
$pdf->MultiCell(0, 10, $last, 0, 'J');
