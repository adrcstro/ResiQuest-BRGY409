...
if (isset($_POST['AdminaddFirstName'], $_POST['AdminaddMiddleName'], $_POST['AdminaddLastName'], $_POST['addAdminPosition'], $_POST['addAdminGender'], $_POST['AdminaddEmail'], $_POST['AdminPassword'], $_POST['ConfirmPAssword'])) {
    ...
    if (!$uppercase || !$lowercase || !$number || !$specialChars || strlen($password) < 8) {
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            $duplicate = mysqli_query($conn, "SELECT * FROM admintbl WHERE Email = '$email'");
            if (mysqli_num_rows($duplicate)) {
                ...
                if ($password == $ConfirmPAssword) {
                    ...
                    $query = "INSERT INTO admintbl (AdminID , MName, Fname, Lname, BrgyPosition, Gender, Email, Password) 
                              VALUES ('$uniqueID', '$AdminaddFirstName', '$AdminaddMiddleName', '$AdminaddLastName', '$addAdminPosition ', '$addAdminGender', '$AdminaddEmail', '$hashedPassword')";
