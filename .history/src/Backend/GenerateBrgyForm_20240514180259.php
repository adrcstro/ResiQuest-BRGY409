...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT RequestID, ServiceType, DateRequested, FirstName, Middlename, Lastname, Address FROM requestdocument WHERE RequestID = '$searchID' AND (ServiceType = 'Barangay Identification')";
