...
if(mysqli_num_rows($result) > 0) {
  ...
  switch ($row["ServiceType"]) {
    ...
    case "Certificate of Indigency":
      $columns = ["Request ID" => "Request ID", "ServiceType" => "Service Type", "DateRequested" => "Date Requested", "Status" => "Status", "FirstName" => "First Name", "Middlename" => "Middle Name", "Lastname" => "Last Name", "Address" => "Address", "Purpose" => "Purpose", "PickUpDate" => "Pick Up Date"];
      break;
    ...
    case "Barangay Identification":
      $columns = ["Contactname" => "Contact Name", "Contactaddress" => "Contact Address", "Contactnum" => "Contact Number"];
      break;
    default:
