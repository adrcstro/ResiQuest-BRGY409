    ...
    if ($stmt) {
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                if ($status == 'On-Schedule') {
                    echo '<td class="px-6 py-4 border border-inherit text-center whitespace-nowrap text-sm font-semibold text-gray-900">' . $row["Settlement-Date"] . ' | ' . $row["Settlement-Time"] . '</td>';
