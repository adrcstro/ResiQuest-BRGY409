...
switch ($serviceType) {
    ...
    case "Barangay Identification":
        ...
        $updateQuery = "UPDATE requestdocument SET FirstName='$firstname', Middlenamee='$middlename', Lastname='$lastname', Address='$address', DateofBirth='$dateOfBirth', PlaceofBirth='$placeOfBirth', SSSGSIS='$sssgsis', Contactname='$contactPersonName', Contactnum='$contactPersonNumber', Contactaddress='$contactPersonAddress' WHERE RequestID='$requestId'";
        break;
    default:
