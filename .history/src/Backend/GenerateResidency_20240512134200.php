...
class PDF extends TCPDF {
    ...
    public function __construct($organizationName, $organizationAddress, $brgyname, $Zonenumname, $fulladdress) {
        parent::__construct();
    ...
    public function Header() {
        ...
        $this->Image($logoPath,160, 7, 26); 
        $logoPath = '../../Images/barangaycetrlogo.jpg'; // Adjust the path based on your project structure
        $this->Image($logoPath, 20, 8, 23);// Adjust the coordinates and size as needed
        $this->Ln(9);
        // Organization details
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $pdf = new PDF($organizationName, $organizationAddress ,$brgyname, $Zonenumname, $fulladdress);
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $letterContent = str_pad("CERTIFICATE OF INDIGENCY", 80 + strlen("BLOTTER REPORT") / 2, " ", STR_PAD_LEFT) . "\n\n";
