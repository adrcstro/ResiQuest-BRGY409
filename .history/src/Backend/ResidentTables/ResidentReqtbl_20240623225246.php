...
if($current_page > 1) {
    echo '<a href="?page=' . ($current_page - 1) . '" class="p-2 bg-gray-300 text-black rounded">Previous</a> ';
}
for($i = 1; $i <= $total_pages; $i++) {
    if($i == $current_page) {
        echo '<span class="p-2 bg-blue-500 text-white rounded">' . $i . '</span> ';
    } else {
        echo '<a href="?page=' . $i . '" class="p-2 bg-gray-300 text-black rounded">' . $i . '</a> ';
    }
}
if($current_page < $total_pages) {
    echo '<a href="?page=' . ($current_page + 1) . '" class="p-2 bg-gray-300 text-black rounded">Next</a>';
}
echo '</div>';
