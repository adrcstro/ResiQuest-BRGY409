...
$paragraphText = "being applied for the NEW / RENEWAL of the corresponding Mayor's Permit has\nbeen found to be:
____________/ Complying with the provitions of existing Barangay ordinances, rules and regualtions being enforced in this barangay:   
____________/ Partially complying with the provision of existing Barangay ordinances rules and regulation being enforced in this barangay   
...
$pdf->MultiCell(0, 10, $paragraphText, 0, 'L');
