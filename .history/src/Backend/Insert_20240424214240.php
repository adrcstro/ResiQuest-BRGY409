...
if (isset($_POST['firstnamebrgyBClearance'], $_POST['MnameBClearance'], $_POST['lastnameBClearance'], $_POST['BusinessNameBClearance'], $_POST['BusinessLocBClearance'], $_POST['DateReqBClearance'], $_POST['HomeAddBClearance'], $_POST['ServicetyBClearance'])) {
    // Collect form data for insertion
    ...
    // Prepare and bind for insertion
    $stmt = $conn->prepare("INSERT INTO requestdocument (RequestID, FirstName, Middlename, Lastname, ServiceType, DateRequested, Address, BusinessAct, BusinessLoc ) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)");
    $stmt->bind_param("issssssss",  $RequestBClearance , $firstnamebrgyBClearance,$MnameBClearance, $lastnameBClearance,  $ServicetyBClearance, $DateReqBClearance ,  $HomeAddBClearance,  $BusinessNameBClearance, $BusinessLocBClearance );
