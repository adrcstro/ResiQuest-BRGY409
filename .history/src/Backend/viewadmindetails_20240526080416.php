...
if (mysqli_num_rows($result) > 0) {
    ...
    <div class="relative">
    <img  src="../Backend/uploads/' . $row["AdminProfile"] . '" alt="News Image" class="w-32 h-32 bg-gray-300 rounded-full border border-gray-400 border-4 mb-4" alt="Default Profile Picture">
