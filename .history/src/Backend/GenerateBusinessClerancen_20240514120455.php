...
_____/ Recommend only the issuance of TEMPORARY PERMIT for not more than (3) months and within the period of the requirments under existing barangay ordinances rules and regulation on that matter should be totally compiled with otherwise this barangay would take the necessary action,within legal bounds to stop its continued operation:";
