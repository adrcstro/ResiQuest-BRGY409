...
class PDF extends TCPDF {
    ...
    $kagawadsunflower, $puroknSun ,$kagawadRosal, $purokRosal,$kagawadDahlia,$purokDahlia ,$kagawadCamia,$purokCamia,$kagawadGumamela,$purokGumamela ,$kagawadJasmin,$purokJasmin) {
        parent::__construct();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $kagawadsunflower , $puroknSun, $kagawadRosal,$purokRosal,$kagawadDahlia,$purokDahlia ,$kagawadCamia,$purokCamia,$kagawadGumamela,$purokGumamela);
