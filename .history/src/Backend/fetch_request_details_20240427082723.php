...
if(mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo '<div>';
    echo '<label for="first_name" class="block text-sm font-semibold leading-6 text-gray-900">Middle Name</label>';
    echo '<input type="text" id="first_name" name="first_name" value="' . $row["Middlename"] . '" readonly class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mt-1">';
    echo '</div>';


    echo '<div>';
    echo '<label for="first_name" class="block text-sm font-semibold leading-6 text-gray-900">Last Name</label>';
    echo '<input type="text" id="first_name" name="first_name" value="' . $row["Lastname"] . '" readonly class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mt-1">';
    echo '</div>';

    echo '<div>';
    echo '<label for="first_name" class="block text-sm font-semibold leading-6 text-gray-900">Address</label>';
    echo '<input type="text" id="first_name" name="first_name" value="' . $row["Address"] . '" readonly class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mt-1">';
    echo '</div>';


    echo '<div>';
    echo '<label for="first_name" class="block text-sm font-semibold leading-6 text-gray-900">Purpose</label>';
    echo '<input type="text" id="first_name" name="first_name" value="' . $row["Purpose"] . '" readonly class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 mt-1">';
    echo '</div>';
