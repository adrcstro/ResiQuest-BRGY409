...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $dateOfReport = "Date Filed: " . $row['DateRequested'];
            ...
            $letterContent .= "        I am writing to formally bring to your attention a matter that requires your immediate Action. Complaint ID: " . $row['RequestID'] . ". This report pertains to a  that transpired on . The incident involves ";
            $letterContent .= "a complainant identified as " . $row['FirstName'] . ". The complainant, residing at " . $row['Address'] . " and reachable at , reported an incident involving the complainee, .\n\n";
