...
class PDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Ln(100); // Adjust the line spacing as needed
        $this->SetFont('times', 'B', 14); // Set font to bold and size 14
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT RequestID, ServiceType, DateRequested, FirstName, Middlename, Lastname, Address,DateofBirth,	PlaceofBirth,Civilstat,SSSGSIS,RequestorContactNum FROM requestdocument WHERE RequestID = '$searchID' AND (ServiceType = 'Barangay Identification')";
