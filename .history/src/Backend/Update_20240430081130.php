...
switch ($serviceType) {
    ...
    case "Barangay Identification":
        ...
        $updateQuery = "UPDATE requestdocument SET FirstName='$firstname', Middlenamee='$middlename', Lastname='$lastname', address='$address', dateOfBirth='$dateOfBirth', placeOfBirth='$placeOfBirth', sssgsis='$sssgsis', contactPersonName='$contactPersonName', contactPersonNumber='$contactPersonNumber', contactPersonAddress='$contactPersonAddress' WHERE requestId='$requestId'";
        break;
    default:
