...
if (mysqli_num_rows($result) > 0) {
        ...
        <div class="flex flex-col items-center justify-center w-full h-full">
            ...
            <div class="flex flex-col items-center justify-center w-full h-full p-2 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                <div class="w-full h-64 overflow-hidden">
                    <img src="../Backend/uploads/<?php echo $row['NewsImages']; ?>" alt="News Image" class="w-full h-full object-cover border-2 border-gray-400 rounded-md p-2">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex-1 flex flex-col justify-between">
        <div>
            ...
            <input value="<?php echo $row['NewsTittle']; ?>" type="text" name="NewsTitle" placeholder="Enter News Title" class="input input-bordered focus:outline-none focus:ring-1 focus:border-blue-500 input-white w-full bg-white text-slate-900" readonly />
        </div>
